...
void main() {
  group('AuthTokenServiceTest -', () {
    ...
    test('loadToken migrates from SharedPreferences if secure storage is empty', () async {
    ...
    test('clearToken removes from secure storage and SharedPreferences', () async {
      secureStorageValues['auth_token'] = 'token_to_delete';
      SharedPreferences.setMockInitialValues({'auth_token': 'legacy_token_to_delete'});
