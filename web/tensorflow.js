...
class xi {
  ...
  numDataIds() {
    return ke("numDataIds");
  }
  disposeData(e, t) {
    return ke("disposeData");
  }
  write(e, t, r) {
    return ke("write");
  }
  ...
  createTensorFromGPUData(e, t, r) {
    return ke("createTensorFromGPUData");
  }
  memory() {
    return ke("memory");
  }
  ...
  floatPrecision() {
    return ke("floatPrecision");
  }
  /** Returns the smallest representable number.  */
  epsilon() {
    return this.floatPrecision() === 32 ? sl : ol;
  }
  dispose() {
    return ke("dispose");
  }
...
function wi(n, e, t = "") {
  _(me(n, e), () => t + ` Shapes ${n} and ${e} must match`);
}
function P(n) {
  if (n.length === 0)
    return 1;
...
function Re(n, e) {
  const t = e.length;
  return n = n == null ? e.map((r, s) => s) : [].concat(n), _(n.every((r) => r >= -t && r < t), () => `All values in axis param must be in range [-${t}, ${t}) but got axis ${n}`), _(n.every((r) => Ci(r)), () => `All values in axis param must be integers but got axis ${n}`), n.map((r) => r < 0 ? t + r : r);
}
function qt(n, e) {
  const t = [], r = [];
...
function Kn(n) {
  return Array.isArray(n) ? Kn(n[0]) : n instanceof Float32Array ? "float32" : n instanceof Int32Array || n instanceof Uint8Array || n instanceof Uint8ClampedArray ? "int32" : pl(n) ? "float32" : Nr(n) ? "string" : fl(n) ? "bool" : "float32";
}
function ss(n) {
...
function Yn(n) {
  n.forEach((e) => {
    _(Number.isInteger(e) && e >= 0, () => `Tensor must have a shape comprised of positive integers but got shape [${n}].`);
  });
}
function is(n, e, t) {
  if (e === 0)
...
class gl {
  ...
  constructor(e) {
    this.global = e, this.flags = {}, this.flagRegistry = {}, this.urlFlags = {}, this.getQueryParams = xl, this.populateURLFlags();
  }
  setPlatform(e, t) {
  ...
  populateURLFlags() {
    ...
    mo in e && e[mo].split(",").forEach((r) => {
      const [s, o] = r.split(":");
      this.urlFlags[s] = Cl(s, o);
    });
  }
}
function xl(n) {
  const e = {};
  return n.replace(/[?&]([^=?&]+)(?:=([^&]*))?/g, (t, ...r) => (wl(e, r[0], r[1]), r.join("="))), e;
}
function wl(n, e, t) {
...
const go = globalThis || void 0 || self;
function yl(n) {
  return n && n.__esModule && Object.prototype.hasOwnProperty.call(n, "default") ? n.default : n;
}
var $i = { exports: {} }, se = $i.exports = {}, st, ot;
function as() {
...
(function() {
  try {
    typeof setTimeout == "function" ? st = setTimeout : st = as;
  } catch {
    st = as;
  }
  try {
    typeof clearTimeout == "function" ? ot = clearTimeout : ot = cs;
  } catch {
    ot = cs;
  }
})();
...
var pt = [], hn = !1, Pt, pr = -1;
function vl() {
  !hn || !Pt || (hn = !1, Pt.length ? pt = Pt.concat(pt) : pr = -1, pt.length && Ii());
}
function Ii() {
  if (!hn) {
    var n = vi(vl);
...
se.nextTick = function(n) {
  ...
  if (arguments.length > 1)
    for (var t = 1; t < arguments.length; t++)
      e[t - 1] = arguments[t];
  pt.push(new Si(n, e)), pt.length === 1 && !hn && vi(Ii);
};
function Si(n, e) {
...
se.once = mt;
se.off = mt;
se.removeListener = mt;
se.removeAllListeners = mt;
se.emit = mt;
se.prependListener = mt;
se.prependOnceListener = mt;
se.listeners = function(n) {
  return [];
};
se.binding = function(n) {
...
const Ri = "Abs", El = "Acos", Rl = "Acosh", Ds = "Add", Tl = "AddN", Nl = "All", kl = "Any", Al = "ArgMax", Fl = "ArgMin", Dl = "Asin", Ol = "Asinh", Pl = "Atan", _l = "Atanh", Bl = "Atan2", Ll = "AvgPool", Ml = "AvgPoolGrad", Ul = "AvgPool3D", Vl = "AvgPool3DGrad", Wl = "BatchMatMul", Gl = "BatchToSpaceND", zl = "Bincount", Hl = "BitwiseAnd", Xl = "BroadcastArgs", Os = "Cast", ql = "Ceil", jl = "ClipByValue", Ti = "Complex", Ni = "ComplexAbs", Kl = "Concat", Yl = "Conv2D", Ql = "Conv2DBackpropFilter", Zl = "Conv2DBackpropInput", Jl = "Conv3D", eu = "Conv3DBackpropFilterV2", tu = "Conv3DBackpropInputV2", nu = "Cos", ru = "Cosh", su = "Cumprod", ou = "Cumsum", iu = "CropAndResize", au = "DenseBincount", cu = "DepthToSpace", lu = "DepthwiseConv2dNative", uu = "DepthwiseConv2dNativeBackpropFilter", du = "DepthwiseConv2dNativeBackpropInput", hu = "Diag", fu = "Dilation2D", ki = "RealDiv", pu = "Einsum", mu = "Elu", gu = "EluGrad", xu = "Erf", wu = "Equal", Cu = "Exp", bu = "ExpandDims", yu = "Expm1", $u = "FFT", Ai = "Fill", vu = "FlipLeftRight", Iu = "Floor", Fi = "FloorDiv", Su = "FusedBatchNorm", Eu = "GatherV2", Ru = "GatherNd", Tu = "Greater", Nu = "GreaterEqual", Ps = "Identity", ku = "IFFT", Au = "Imag", Fu = "IsFinite", Du = "IsInf", Ou = "IsNan", Pu = "LeakyRelu", _u = "Less", Bu = "LessEqual", Lu = "LinSpace", Mu = "Log", Uu = "Log1p", Vu = "LogicalAnd", Wu = "LogicalNot", Gu = "LogicalOr", zu = "LRN", Hu = "LRNGrad", Xu = "Max", Di = "Maximum", qu = "MaxPool", ju = "MaxPoolGrad", Ku = "MaxPool3D", Yu = "MaxPool3DGrad", Qu = "MaxPoolWithArgmax", Zu = "Mean", Ju = "Min", ed = "Minimum", td = "MirrorPad", nd = "Mod", rd = "Multinomial", Oi = "Multiply", sd = "Neg", od = "NotEqual", id = "NonMaxSuppressionV3", ad = "NonMaxSuppressionV4", cd = "NonMaxSuppressionV5", ld = "OnesLike", ud = "OneHot", dd = "Pack", hd = "PadV2", Pi = "Pow", fd = "Prelu", pd = "Prod", md = "RaggedGather", gd = "RaggedRange", xd = "RaggedTensorToTensor", wd = "Range", Cd = "Real", bd = "Reciprocal", yd = "Relu", _i = "Reshape", $d = "ResizeNearestNeighbor", vd = "ResizeNearestNeighborGrad", Id = "ResizeBilinear", Sd = "ResizeBilinearGrad", Ed = "Relu6", Rd = "Reverse", Td = "Round", Nd = "Rsqrt", kd = "ScatterNd", Ad = "TensorScatterUpdate", Fd = "SearchSorted", Dd = "Select", Od = "Selu", Pd = "Slice", _d = "Sin", Bd = "Sinh", Ld = "Sign", Md = "Sigmoid", Ud = "Softplus", Bi = "Sqrt", Vd = "Sum", Wd = "SpaceToBatchND", Gd = "SplitV", zd = "Softmax", Hd = "SparseFillEmptyRows", Xd = "SparseReshape", qd = "SparseSegmentMean", jd = "SparseSegmentSum", Kd = "SparseToDense", Yd = "SquaredDifference", Qd = "Square", Zd = "StaticRegexReplace", Jd = "StridedSlice", eh = "StringNGrams", th = "StringSplit", nh = "StringToHashBucketFast", Li = "Sub", rh = "Tan", sh = "Tanh", Mi = "Tile", oh = "TopK", ih = "Transform", ah = "Transpose", ch = "Unique", lh = "Unpack", uh = "UnsortedSegmentSum", Ui = "ZerosLike", dh = "Step", hh = "FromPixels", fh = "RotateWithOffset", ph = "_FusedMatMul", mh = "FusedConv2D", gh = "FusedDepthwiseConv2D";
/**
 * @license
 ...
 * =============================================================================
 */
const wr = Fs("kernelRegistry", () => /* @__PURE__ */ new Map()), xh = Fs("gradRegistry", () => /* @__PURE__ */ new Map());
function xo(n, e) {
  const t = Vi(n, e);
  return wr.get(t);
}
...
function wh(n) {
  const { kernelName: e, backendName: t } = n, r = Vi(e, t);
  wr.has(r) && Qe(`The kernel '${e}' for backend '${t}' is already registered`), wr.set(r, n);
}
function Vi(n, e) {
  return `${e}_${n}`;
}
...
function jt(n, e) {
  var t, r, s;
  return e ? (n >>>= 0, (s = 0 <= n && n < 256) && (r = yo[n], r) ? r : (t = Z(n, (n | 0) < 0 ? -1 : 0, !0), s && (yo[n] = t), t)) : (n |= 0, (s = -128 <= n && n < 128) && (r = bo[n], r) ? r : (t = Z(n, n < 0 ? -1 : 0, !1), s && (bo[n] = t), t));
}
Q.fromInt = jt;
function Ve(n, e) {
  if (isNaN(n))
  ...
  return n < 0 ? Ve(-n, e).neg() : Z(n % gn | 0, n / gn | 0, e);
}
Q.fromNumber = Ve;
function Z(n, e, t) {
  return new Q(n, e, t);
...
function _s(n, e, t) {
  ...
  if (r === 0)
    return _s(n.substring(1), e, t).neg();
  for (var s = Ve(Cr(t, 8)), o = We, i = 0; i < n.length; i += 8) {
...
Q.fromString = _s;
function Je(n, e) {
  return typeof n == "number" ? Ve(n, e) : typeof n == "string" ? _s(n, e) : Z(n.low, n.high, typeof e == "boolean" ? e : n.unsigned);
}
Q.fromValue = Je;
var $o = 65536, bh = 1 << 24, gn = $o * $o, zi = gn * gn, vo = zi / 2, Io = jt(bh), We = jt(0);
Q.ZERO = We;
var _t = jt(0, !0);
Q.UZERO = _t;
var un = jt(1);
...
var ls = jt(-1);
Q.NEG_ONE = ls;
var Xi = Z(-1, 2147483647, !1);
Q.MAX_VALUE = Xi;
var qi = Z(-1, -1, !0);
Q.MAX_UNSIGNED_VALUE = qi;
var Ae = Z(0, -2147483648, !1);
Q.MIN_VALUE = Ae;
var O = Q.prototype;
O.toInt = function() {
...
O.toString = function(e) {
  ...
  for (var o = Ve(Cr(e, 6), this.unsigned), i = this, a = ""; ; ) {
...
O.getNumBitsAbs = function() {
  if (this.isNegative())
    return this.eq(Ae) ? 64 : this.neg().getNumBitsAbs();
...
O.equals = function(e) {
  return De(e) || (e = Je(e)), this.unsigned !== e.unsigned && this.high >>> 31 === 1 && e.high >>> 31 === 1 ? !1 : this.high === e.high && this.low === e.low;
};
O.eq = O.equals;
...
O.comp = O.compare;
O.negate = function() {
  return !this.unsigned && this.eq(Ae) ? Ae : this.not().add(un);
};
O.neg = O.negate;
O.add = function(e) {
  De(e) || (e = Je(e));
  var t = this.high >>> 16, r = this.high & 65535, s = this.low >>> 16, o = this.low & 65535, i = e.high >>> 16, a = e.high & 65535, c = e.low >>> 16, l = e.low & 65535, u = 0, d = 0, h = 0, p = 0;
  return p += o + l, h += p >>> 16, p &= 65535, h += s + c, d += h >>> 16, h &= 65535, d += r + a, u += d >>> 16, d &= 65535, u += t + i, u &= 65535, Z(h << 16 | p, u << 16 | d, this.unsigned);
};
O.subtract = function(e) {
  return De(e) || (e = Je(e)), this.add(e.neg());
};
O.sub = O.subtract;
O.multiply = function(e) {
  ...
  if (De(e) || (e = Je(e)), Ue) {
    ...
    return Z(t, Ue.get_high(), this.unsigned);
  }
  if (e.isZero())
    return We;
  if (this.eq(Ae))
    return e.isOdd() ? Ae : We;
  if (e.eq(Ae))
    return this.isOdd() ? Ae : We;
  if (this.isNegative())
    return e.isNegative() ? this.neg().mul(e.neg()) : this.neg().mul(e).neg();
  if (e.isNegative())
    return this.mul(e.neg()).neg();
  if (this.lt(Io) && e.lt(Io))
    return Ve(this.toNumber() * e.toNumber(), this.unsigned);
  var r = this.high >>> 16, s = this.high & 65535, o = this.low >>> 16, i = this.low & 65535, a = e.high >>> 16, c = e.high & 65535, l = e.low >>> 16, u = e.low & 65535, d = 0, h = 0, p = 0, m = 0;
  return m += i * u, p += m >>> 16, m &= 65535, p += o * u, h += p >>> 16, p &= 65535, p += i * l, h += p >>> 16, p &= 65535, h += s * u, d += h >>> 16, h &= 65535, h += o * l, d += h >>> 16, h &= 65535, h += i * c, d += h >>> 16, h &= 65535, d += r * u + s * l + o * c + i * a, d &= 65535, Z(p << 16 | m, d << 16 | h, this.unsigned);
};
O.mul = O.multiply;
O.divide = function(e) {
  if (De(e) || (e = Je(e)), e.isZero())
  ...
  if (this.unsigned) {
    ...
    if (this.eq(Ae)) {
      ...
      if (e.eq(Ae))
        return un;
      var i = this.shr(1);
      return r = i.div(e).shl(1), r.eq(We) ? e.isNegative() ? un : ls : (s = this.sub(e.mul(r)), o = r.add(s.div(e)), o);
    } else if (e.eq(Ae))
      return this.unsigned ? _t : We;
    if (this.isNegative())
  ...
  for (s = this; s.gte(e); ) {
    ...
    for (var a = Math.ceil(Math.log(r) / Math.LN2), c = a <= 48 ? 1 : Cr(2, a - 48), l = Ve(r), u = l.mul(e); u.isNegative() || u.gt(s); )
...
O.and = function(e) {
  return De(e) || (e = Je(e)), Z(this.low & e.low, this.high & e.high, this.unsigned);
};
O.or = function(e) {
  return De(e) || (e = Je(e)), Z(this.low | e.low, this.high | e.high, this.unsigned);
};
...
O.shiftLeft = function(e) {
  return De(e) && (e = e.toInt()), (e &= 63) === 0 ? this : e < 32 ? Z(this.low << e, this.high << e | this.low >>> 32 - e, this.unsigned) : Z(0, this.low << e - 32, this.unsigned);
};
O.shl = O.shiftLeft;
O.shiftRight = function(e) {
  return De(e) && (e = e.toInt()), (e &= 63) === 0 ? this : e < 32 ? Z(this.low >>> e | this.high << 32 - e, this.high >> e, this.unsigned) : Z(this.high >> e - 32, this.high >= 0 ? 0 : -1, this.unsigned);
};
O.shr = O.shiftRight;
O.shiftRightUnsigned = function(e) {
  if (De(e) && (e = e.toInt()), e &= 63, e === 0)
    return this;
  var t = this.high;
  if (e < 32) {
    var r = this.low;
    return Z(r >>> e | t << 32 - e, t >>> e, this.unsigned);
  } else return e === 32 ? Z(t, 0, this.unsigned) : Z(t >>> e - 32, 0, this.unsigned);
};
...
Q.fromBytes = function(e, t, r) {
  return r ? Q.fromBytesLE(e, t) : Q.fromBytesBE(e, t);
};
Q.fromBytesLE = function(e, t) {
  return new Q(
...
const ji = /* @__PURE__ */ Ch(Gi), yh = /* @__PURE__ */ rl({
  __proto__: null,
  default: ji
}, [Gi]);
/**
...
const Ki = kr("c3a5c85c97cb3127"), At = kr("b492b66fbe98f273"), be = kr("9ae16a3b2f90404f");
function us(n) {
...
function Et(n, e, t = kr("9ddfea08eb382d69")) {
  let r = n.xor(e).mul(t);
  r = r.xor(r.shru(47));
  let s = e.xor(r).mul(t);
  return s = s.xor(s.shru(47)), s = s.mul(t), s;
}
function $h(n, e, t, r, s, o) {
  s = s.add(n), o = le(o.add(s).add(r), 21);
  const i = s;
  return s = s.add(e), s = s.add(t), o = o.add(le(s, 44)), [s.add(r), o.add(i)];
}
function or(n, e, t, r) {
  return $h(Y(n, e), Y(n, e + 8), Y(n, e + 16), Y(n, e + 24), t, r);
}
function vh(n, e = n.length) {
  if (e >= 8) {
    const t = be.add(e * 2), r = Y(n, 0).add(be), s = Y(n, e - 8), o = le(s, 37).mul(t).add(r), i = le(r, 25).add(s).mul(t);
    return Et(o, i, t);
  }
  if (e >= 4) {
    const t = be.add(e * 2), r = So(n, 0);
    return Et(r.shl(3).add(e), So(n, e - 4), t);
  }
  if (e > 0) {
    const t = n[0], r = n[e >> 1], s = n[e - 1], o = t + (r << 8), i = e + (s << 2);
    return us(be.mul(o).xor(Ki.mul(i))).mul(be);
  }
  return be;
}
function Ih(n, e = n.length) {
  const t = be.add(e * 2), r = Y(n, 0).mul(At), s = Y(n, 8), o = Y(n, e - 8).mul(t), i = Y(n, e - 16).mul(be);
  return Et(le(r.add(s), 43).add(le(o, 30)).add(i), r.add(le(s.add(be), 18)).add(o), t);
}
function Sh(n, e = n.length) {
  const t = be.add(e * 2), r = Y(n, 0).mul(be), s = Y(n, 8), o = Y(n, e - 8).mul(t), i = Y(n, e - 16).mul(be), a = le(r.add(s), 43).add(le(o, 30)).add(i), c = Et(a, r.add(le(s.add(be), 18)).add(o), t), l = Y(n, 16).mul(t), u = Y(n, 24), d = a.add(Y(n, e - 32)).mul(t), h = c.add(Y(n, e - 24)).mul(t);
  return Et(le(l.add(u), 43).add(le(d, 30)).add(h), l.add(le(u.add(r), 18)).add(d), t);
}
function Eh(n, e = n.length) {
  const t = Ft.fromNumber(81, !0);
  if (e <= 32)
    return e <= 16 ? vh(n, e) : Ih(n, e);
  if (e <= 64)
    return Sh(n, e);
  let r = t, s = t.mul(At).add(113), o = us(s.mul(be).add(113)).mul(be), i = [Ft.UZERO, Ft.UZERO], a = [Ft.UZERO, Ft.UZERO];
  r = r.mul(be).add(Y(n, 0));
  let c = 0;
  const l = (e - 1 >> 6) * 64, u = l + (e - 1 & 63) - 63;
  do
    r = le(r.add(s).add(i[0]).add(Y(n, c + 8)), 37).mul(At), s = le(s.add(i[1]).add(Y(n, c + 48)), 42).mul(At), r = r.xor(a[1]), s = s.add(i[0]).add(Y(n, c + 40)), o = le(o.add(a[0]), 33).mul(At), i = or(n, c, i[1].mul(At), r.add(a[0])), a = or(n, c + 32, o.add(a[1]), s.add(Y(n, c + 16))), [o, r] = [r, o], c += 64;
  while (c !== l);
  const d = At.add(o.and(255).shl(1));
  return c = u, a[0] = a[0].add(e - 1 & 63), i[0] = i[0].add(a[0]), a[0] = a[0].add(i[0]), r = le(r.add(s).add(i[0]).add(Y(n, c + 8)), 37).mul(d), s = le(s.add(i[1]).add(Y(n, c + 48)), 42).mul(d), r = r.xor(a[1].mul(9)), s = s.add(i[0].mul(9).add(Y(n, c + 40))), o = le(o.add(a[0]), 33).mul(d), i = or(n, c, i[1].mul(d), r.add(a[0])), a = or(n, c + 32, o.add(a[1]), s.add(Y(n, c + 16))), [o, r] = [r, o], Et(Et(i[0], a[0], d).add(us(s).mul(Ki)).add(o), Et(i[1], a[1], d).add(r), d);
}
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
...
function Ar(n, e) {
  ...
  if (Array.isArray(n) && (n = Vt(n)), E().getBool("DEBUG") && ll(n, e), Rh(n, e))
    return n;
  if (e == null || e === "float32" || e === "complex64")
    return new Float32Array(n);
  if (e === "int32")
...
function ze(n) {
  return E().platform.isTypedArray != null ? E().platform.isTypedArray(n) : Wi(n);
}
function Vt(n, e = [], t = !1) {
  if (e == null && (e = []), typeof n == "boolean" || typeof n == "number" || typeof n == "string" || As(n) || n == null || ze(n) && t)
    e.push(n);
...
class Th {
  ...
  profileKernel(e, t, r) {
    ...
    if (this.backendTimer.timerAvailable())
      ...
      for (const l of s)
        l.dataSync();
      i = Promise.resolve({ kernelMs: je() - a });
    }
  ...
  for (let c = 0; c < n.length; c++) {
    ...
    for (const d in u) {
      ...
      for (let m = 0; m < e.length; m++)
        if (r[h.id]) {
          l.outputs.forEach((C) => r[C.id] = !0), p = !0, s[l.id] = !0;
          break;
        }
      if (p)
        break;
 ...
 * =============================================================================
 */
const Eo = 20, Mn = 3, Xr = 7;
function Dh(n, e, t, r) {
  const s = pe(e), o = Oh(n, e, t, s), i = e.length, a = mr(n, e, t, s, o), c = ["Tensor"];
  return r && (c.push(`  dtype: ${t}`), c.push(`  rank: ${i}`), c.push(`  shape: [${e}]`), c.push("  values:")), c.push(a.map((l) => "    " + l).join(`
`)), c.join(`
`);
}
function Oh(n, e, t, r) {
  const s = P(e), o = r[r.length - 1], i = new Array(o).fill(0), a = e.length, c = t === "complex64" ? Vn(n) : n;
  if (a > 1)
    for (let l = 0; l < s / o; l++) {
      const u = l * o;
      for (let d = 0; d < o; d++)
...
function Un(n, e, t) {
  let r;
  return Array.isArray(n) ? r = `${parseFloat(n[0].toFixed(Xr))} + ${parseFloat(n[1].toFixed(Xr))}j` : Nr(n) ? r = `'${n}'` : t === "bool" ? r = Qi(n) : r = parseFloat(n.toFixed(Xr)).toString(), dn(r, e);
}
function Qi(n) {
  return n === 0 ? "false" : "true";
}
function mr(n, e, t, r, s, o = !0) {
  ...
  if (c === 0) {
    ...
    return t === "bool" ? [Qi(n[0])] : [n[0].toString()];
  }
  if (c === 1) {
    if (a > Eo) {
      const w = Mn * i;
...
class br {
  constructor(e, t, r) {
    if (this.dtype = t, this.shape = e.slice(), this.size = P(e), r != null) {
      const s = r.length;
      _(s === this.size, () => `Length of values '${s}' does not match the size inferred by the shape '${this.size}'.`);
    }
    if (t === "complex64")
      throw new Error("complex64 dtype TensorBuffers are not supported. Please create a TensorBuffer for the real and imaginary parts separately and call tf.complex(real, imag).");
    this.values = r || ue(t, this.size), this.strides = pe(e);
  }
  /**
   ...
   */
  set(e, ...t) {
    t.length === 0 && (t = [0]), _(t.length === this.rank, () => `The number of provided coordinates (${t.length}) must match the rank (${this.rank})`);
...
class Me {
  constructor(e, t, r, s) {
    this.kept = !1, this.isDisposedInternal = !1, this.shape = e.slice(), this.dtype = t || "float32", this.size = P(e), this.strides = pe(e), this.dataId = r, this.id = s, this.rankType = this.rank < 5 ? this.rank.toString() : "higher";
  }
  get rank() {
    return this.shape.length;
  }
  ...
  async array() {
    const e = await this.data();
    return po(this.shape, e, this.dtype === "complex64");
  }
  /**
   * Returns the tensor data as a nested array. The transfer of data is done
   * synchronously.
   ...
   */
  arraySync() {
    return po(this.shape, this.dataSync(), this.dtype === "complex64");
  }
  /**
  ...
  toString(e = !1) {
    ...
    return Dh(t, this.shape, this.dtype, e);
  }
  cast(e) {
...
Object.defineProperty(yr, Symbol.hasInstance, {
...
function ea(n) {
  const e = [];
  return ta(n, e, /* @__PURE__ */ new Set()), e;
}
function ta(n, e, t) {
  if (n == null)
    return;
...
class wn {
  constructor(e) {
    this.ENV = e, this.registry = {}, this.registryFactory = {}, this.pendingBackendInitId = 0, this.state = new To();
  }
  async ready() {
  ...
  async setBackend(e) {
    ...
    return this.backendInstance = this.registry[e], this.setupRegisteredKernels(), this.profiler = new Th(this.backendInstance), !0;
  }
  setupRegisteredKernels() {
    Co(this.backendName).forEach((t) => {
  ...
  initializeBackend(e) {
    ...
    try {
      const r = t.factory();
      if (r && !(r instanceof xi) && typeof r.then == "function") {
   ...
   */
  clone(e) {
    const t = V.runKernel(Ps, { x: e }), r = { x: e }, s = (i) => ({
      x: () => {
   ...
   */
  runKernel(e, t, r) {
    if (this.backendName == null && this.backend, !(xo(e, this.backendName) != null))
  ...
  runKernelFunc(e) {
    ...
    let c;
    const l = qr(e) ? e.kernelName : this.state.activeScope != null ? this.state.activeScope.name : "";
    if (qr(e)) {
      const { kernelName: m, inputs: C, attrs: w } = e;
      this.backendName == null && this.backend;
      const x = xo(m, this.backendName);
      _(x != null, () => `Cannot find registered kernel '${m}' for backend '${this.backendName}'`), a = () => {
    ...
    const { inputs: u, attrs: d } = e, h = qr(e) ? null : e.backwardsFunc;
    let p;
    return this.scopedRun(
      ...
      () => this.state.kernelDepth--,
      () => {
        !this.ENV.getBool("DEBUG") && !this.state.profiling ? t = a() : (p = this.profiler.profileKernel(l, u, () => a()), this.ENV.getBool("DEBUG") && this.profiler.logKernelProfile(p), t = p.outputs);
      }
  ...
  getTensorsForGradient(e, t, r) {
    ...
    if (s != null) {
      ...
      let a;
      s.saveAllInputs ? (_(Array.isArray(t), () => "saveAllInputs is true, expected inputs to be an array."), a = Object.keys(t).map((l) => t[l])) : a = o.map((l) => t[l]);
  ...
  makeVariable(e, t = !0, r, s) {
    ...
    const o = new yr(e, t, r, this.nextTensorId());
  ...
  trackTensor(e, t) {
    ...
    let r = 0;
    e.dtype !== "complex64" && e.dtype !== "string" && (r = e.size * xr(e.dtype)), this.state.numBytes += r, this.state.tensorInfo.has(e.dataId) || (this.state.numDataBuffers++, this.state.tensorInfo.set(e.dataId, {
      backend: t || this.backend,
      dtype: e.dtype,
      shape: e.shape,
      bytes: r
    })), e instanceof yr || this.track(e);
  }
  ...
  addTapeNode(e, t, r, s, o, i) {
    const a = { id: this.state.nextTapeNodeId++, kernelName: e, inputs: t, outputs: r, saved: o }, c = wo(e);
    c != null && (s = c.gradFunc), s != null && (a.gradient = (l) => (l = l.map((u, d) => {
      if (u == null) {
        const h = r[d], p = Rt(h.size, h.dtype);
   ...
   */
  endScope(e) {
    const t = ea(e), r = new Set(t.map((o) => o.id));
   ...
   */
  gradients(e, t, r, s = !1) {
    if (_(t.length > 0, () => "gradients() received an empty list of xs."), r != null && r.dtype !== "float32")
    ...
    _(o instanceof Me, () => "The result y returned by f() must be a tensor.");
    const i = Ah(this.state.activeTape, t, o);
    if (!s && i.length === 0 && t.length > 0)
      throw new Error("Cannot compute gradient of y=f(x) with respect to x. Make sure that the f you passed encloses all operations that lead from x to y.");
    return this.tidy("backward", () => {
      const a = {};
      a[o.id] = r ?? Uh(o.shape), Fh(
        a,
        i,
  ...
  customGrad(e) {
    return _(ss(e), () => "The f passed in customGrad(f) must be a function."), (...t) => {
      _(t.every((a) => a instanceof Me), () => "The args passed in customGrad(f)(x1, x2,...) must all be tensors");
      let r;
      const s = {};
      t.forEach((a, c) => {
        s[c] = a;
      });
      const o = (a, c) => (r = e(...t, c), _(r.value instanceof Me, () => "The function f passed in customGrad(f) must return an object where `obj.value` is a tensor"), _(ss(r.gradFunc), () => "The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function."), r.value), i = (a, c) => {
        const l = r.gradFunc(a, c), u = Array.isArray(l) ? l : [l];
        _(u.length === t.length, () => "The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function that returns the same number of tensors as inputs passed to f(...)."), _(u.every((h) => h instanceof Me), () => "The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function that returns a list of only tensors.");
        const d = {};
  ...
  async time(e) {
    const t = je(), r = await this.backend.time(e);
    return r.wallMs = je() - t, r;
  }
  /**
   ...
   */
  reset() {
    this.pendingBackendInitId++, this.state.dispose(), this.ENV.reset(), this.state = new To();
...
wn.nextVariableId = 0;
function Uh(n) {
  const e = ml(P(n), "float32");
  return V.makeTensor(e, n, "float32");
}
function na() {
  const n = Ei();
  if (n._tfengine == null) {
  ...
  return bl(n._tfengine.ENV), Ph(() => n._tfengine), n._tfengine;
}
const V = na();
function Vh(n, e) {
  const t = { a: n, b: e };
  return V.runKernel(Ds, t);
}
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
...
Fr.toByteArray = qh;
Fr.fromByteArray = Yh;
var at = [], Le = [], Gh = typeof Uint8Array < "u" ? Uint8Array : Array, jr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (var on = 0, zh = jr.length; on < zh; ++on)
  at[on] = jr[on], Le[jr.charCodeAt(on)] = on;
Le[45] = 62;
Le[95] = 63;
function oa(n) {
  var e = n.length;
...
function qh(n) {
  var e, t = oa(n), r = t[0], s = t[1], o = new Gh(Xh(n, r, s)), i = 0, a = s > 0 ? r - 4 : r, c;
  for (c = 0; c < a; c += 4)
...
function Kh(n, e, t) {
  for (var r, s = [], o = e; o < t; o += 3)
    r = (n[o] << 16 & 16711680) + (n[o + 1] << 8 & 65280) + (n[o + 2] & 255), s.push(jh(r));
  return s.join("");
}
function Yh(n) {
  for (var e, t = n.length, r = t % 3, s = [], o = 16383, i = 0, a = t - r; i < a; i += o)
    s.push(Kh(n, i, i + o > a ? a : i + o));
...
Ms.read = function(n, e, t, r, s) {
  var o, i, a = s * 8 - r - 1, c = (1 << a) - 1, l = c >> 1, u = -7, d = t ? s - 1 : 0, h = t ? -1 : 1, p = n[e + d];
  for (d += h, o = p & (1 << -u) - 1, p >>= -u, u += a; u > 0; o = o * 256 + n[e + d], d += h, u -= 8)
    ;
...
Ms.write = function(n, e, t, r, s, o) {
  var i, a, c, l = o * 8 - s - 1, u = (1 << l) - 1, d = u >> 1, h = s === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = r ? 0 : o - 1, m = r ? 1 : -1, C = e < 0 || e === 0 && 1 / e < 0 ? 1 : 0;
  for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (a = isNaN(e) ? 1 : 0, i = u) : (i = Math.floor(Math.log(e) / Math.LN2), e * (c = Math.pow(2, -i)) < 1 && (i--, c *= 2), i + d >= 1 ? e += h / c : e += h * Math.pow(2, 1 - d), e * c >= 2 && (i++, c /= 2), i + d >= u ? (a = 0, i = u) : i + d >= 1 ? (a = (e * c - 1) * Math.pow(2, s), i = i + d) : (a = e * Math.pow(2, d - 1) * Math.pow(2, s), i = 0)); s >= 8; n[t + p] = a & 255, p += m, a /= 256, s -= 8)
    ;
  for (i = i << s | a, l += s; l > 0; n[t + p] = i & 255, p += m, i /= 256, l -= 8)
    ;
  n[t + p - m] |= C * 128;
};
/*!
 ...
 */
(function(n) {
  const e = Fr, t = Ms, r = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
  ...
  function c() {
    try {
      const b = new o(1), f = { foo: function() {
        return 42;
      } };
      return Object.setPrototypeOf(f, o.prototype), Object.setPrototypeOf(b, f), b.foo() === 42;
    } catch {
      return !1;
    }
  }
  ...
  function d(b, f, g) {
    ...
    if (typeof Symbol < "u" && Symbol.toPrimitive != null && typeof b[Symbol.toPrimitive] == "function")
      return u.from(b[Symbol.toPrimitive]("string"), f, g);
    throw new TypeError(
      "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " + typeof b
    );
  }
  u.from = function(b, f, g) {
    return d(b, f, g);
  ...
  function p(b, f, g) {
    return h(b), b <= 0 ? l(b) : f !== void 0 ? typeof g == "string" ? l(b).fill(f, g) : l(b).fill(f) : l(b);
  }
  u.alloc = function(b, f, g) {
    return p(b, f, g);
  };
  function m(b) {
  ...
  function w(b) {
    const f = b.length < 0 ? 0 : I(b.length) | 0, g = l(f);
    for (let $ = 0; $ < f; $ += 1)
      g[$] = b[$] & 255;
    return g;
  }
  ...
  function y(b, f, g) {
    ...
    if (b.byteLength < f + (g || 0))
      throw new RangeError('"length" is outside of buffer bounds');
    let $;
    return f === void 0 && g === void 0 ? $ = new o(b) : g === void 0 ? $ = new o(b, f) : $ = new o(b, f, g), Object.setPrototypeOf($, u.prototype), $;
  }
  function v(b) {
    if (u.isBuffer(b)) {
      const f = I(b.length) | 0, g = l(f);
      return g.length === 0 || b.copy(g, 0, 0, f), g;
    }
    if (b.length !== void 0)
      return typeof b.length != "number" || zr(b.length) ? l(0) : w(b);
  ...
  }, u.compare = function(f, g) {
    if (rt(f, o) && (f = u.from(f, f.offset, f.byteLength)), rt(g, o) && (g = u.from(g, g.offset, g.byteLength)), !u.isBuffer(f) || !u.isBuffer(g))
      throw new TypeError(
        'The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array'
      );
    if (f === g) return 0;
    let $ = f.length, S = g.length;
  ...
  u.prototype.swap16 = function() {
    ...
    const f = this.length;
    return f === 0 ? "" : arguments.length === 0 ? Ne(this, 0, f) : F.apply(this, arguments);
  ...
  }, r && (u.prototype[r] = u.prototype.inspect), u.prototype.compare = function(f, g, $, S, R) {
    if (rt(f, o) && (f = u.from(f, f.offset, f.byteLength)), !u.isBuffer(f))
      throw new TypeError(
        'The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof f
      );
    if (g === void 0 && (g = 0), $ === void 0 && ($ = f ? f.length : 0), S === void 0 && (S = 0), R === void 0 && (R = this.length), g < 0 || $ > f.length || S < 0 || R > this.length)
    ...
    if (g >= $)
      return 1;
    if (g >>>= 0, $ >>>= 0, S >>>= 0, R >>>= 0, this === f) return 0;
    let N = R - S, W = $ - g;
    const te = Math.min(N, W), J = this.slice(S, R), ne = f.slice(g, $);
    for (let K = 0; K < te; ++K)
      if (J[K] !== ne[K]) {
        N = J[K], W = ne[K];
        break;
  ...
  function M(b, f, g, $, S) {
    ...
    if (typeof g == "string" ? ($ = g, g = 0) : g > 2147483647 ? g = 2147483647 : g < -2147483648 && (g = -2147483648), g = +g, zr(g) && (g = S ? 0 : b.length - 1), g < 0 && (g = b.length + g), g >= b.length) {
      if (S) return -1;
      g = b.length - 1;
    } else if (g < 0)
      if (S) g = 0;
      else return -1;
    if (typeof f == "string" && (f = u.from(f, $)), u.isBuffer(f))
      return f.length === 0 ? -1 : U(b, f, g, $, S);
    if (typeof f == "number")
      return f = f & 255, typeof o.prototype.indexOf == "function" ? S ? o.prototype.indexOf.call(b, f, g) : o.prototype.lastIndexOf.call(b, f, g) : U(b, [f], g, $, S);
    throw new TypeError("val must be string, number or Buffer");
  }
  function U(b, f, g, $, S) {
    let R = 1, N = b.length, W = f.length;
    ...
    function te(ne, K) {
      return R === 1 ? ne[K] : ne.readUInt16BE(K * R);
    }
    let J;
    if (S) {
      let ne = -1;
      for (J = g; J < N; J++)
        if (te(b, J) === te(f, ne === -1 ? 0 : J - ne)) {
          if (ne === -1 && (ne = J), J - ne + 1 === W) return ne * R;
        } else
          ne !== -1 && (J -= J - ne), ne = -1;
    } else
      for (g + W > N && (g = N - W), J = g; J >= 0; J--) {
        let ne = !0;
        for (let K = 0; K < W; K++)
          if (te(b, J + K) !== te(f, K)) {
            ne = !1;
  ...
  u.prototype.includes = function(f, g, $) {
    return this.indexOf(f, g, $) !== -1;
  }, u.prototype.indexOf = function(f, g, $) {
    return M(this, f, g, $, !0);
  }, u.prototype.lastIndexOf = function(f, g, $) {
    return M(this, f, g, $, !1);
  };
  function G(b, f, g, $) {
    g = Number(g) || 0;
    ...
    let N;
    for (N = 0; N < $; ++N) {
      const W = parseInt(f.substr(N * 2, 2), 16);
      if (zr(W)) return N;
      b[g + N] = W;
    }
    return N;
  ...
  function ae(b, f, g, $) {
    return sr(el(f, b.length - g), b, g, $);
  }
  u.prototype.write = function(f, g, $, S) {
    if (g === void 0)
    ...
    if (($ === void 0 || $ > R) && ($ = R), f.length > 0 && ($ < 0 || g < 0) || g > this.length)
  ...
  function Te(b, f, g) {
    return f === 0 && g === b.length ? e.fromByteArray(b) : e.fromByteArray(b.slice(f, g));
  }
  function Ne(b, f, g) {
      ...
      if (S + W <= g) {
        ...
        switch (W) {
          case 1:
            ...
            break;
          case 2:
            te = b[S + 1], (te & 192) === 128 && (K = (R & 31) << 6 | te & 63, K > 127 && (N = K));
            break;
          case 3:
            te = b[S + 1], J = b[S + 2], (te & 192) === 128 && (J & 192) === 128 && (K = (R & 15) << 12 | (te & 63) << 6 | J & 63, K > 2047 && (K < 55296 || K > 57343) && (N = K));
            break;
          case 4:
            te = b[S + 1], J = b[S + 2], ne = b[S + 3], (te & 192) === 128 && (J & 192) === 128 && (ne & 192) === 128 && (K = (R & 15) << 18 | (te & 63) << 12 | (J & 63) << 6 | ne & 63, K > 65535 && K < 1114112 && (N = K));
        }
      }
  ...
  u.prototype.slice = function(f, g) {
    const $ = this.length;
    f = ~~f, g = g === void 0 ? $ : ~~g, f < 0 ? (f += $, f < 0 && (f = 0)) : f > $ && (f = $), g < 0 ? (g += $, g < 0 && (g = 0)) : g > $ && (g = $), g < f && (g = f);
  ...
  function ie(b, f, g) {
    ...
    if (b + f > g) throw new RangeError("Trying to access beyond buffer length");
  }
  u.prototype.readUintLE = u.prototype.readUIntLE = function(f, g, $) {
    f = f >>> 0, g = g >>> 0, $ || ie(f, g, this.length);
    let S = this[f], R = 1, N = 0;
    for (; ++N < g && (R *= 256); )
      S += this[f + N] * R;
    return S;
  }, u.prototype.readUintBE = u.prototype.readUIntBE = function(f, g, $) {
    f = f >>> 0, g = g >>> 0, $ || ie(f, g, this.length);
    let S = this[f + --g], R = 1;
    for (; g > 0 && (R *= 256); )
      S += this[f + --g] * R;
    return S;
  }, u.prototype.readUint8 = u.prototype.readUInt8 = function(f, g) {
    return f = f >>> 0, g || ie(f, 1, this.length), this[f];
  }, u.prototype.readUint16LE = u.prototype.readUInt16LE = function(f, g) {
    return f = f >>> 0, g || ie(f, 2, this.length), this[f] | this[f + 1] << 8;
  }, u.prototype.readUint16BE = u.prototype.readUInt16BE = function(f, g) {
    return f = f >>> 0, g || ie(f, 2, this.length), this[f] << 8 | this[f + 1];
  }, u.prototype.readUint32LE = u.prototype.readUInt32LE = function(f, g) {
    return f = f >>> 0, g || ie(f, 4, this.length), (this[f] | this[f + 1] << 8 | this[f + 2] << 16) + this[f + 3] * 16777216;
  }, u.prototype.readUint32BE = u.prototype.readUInt32BE = function(f, g) {
    return f = f >>> 0, g || ie(f, 4, this.length), this[f] * 16777216 + (this[f + 1] << 16 | this[f + 2] << 8 | this[f + 3]);
  }, u.prototype.readBigUInt64LE = yt(function(f) {
    f = f >>> 0, sn(f, "offset");
    const g = this[f], $ = this[f + 7];
    (g === void 0 || $ === void 0) && Bn(f, this.length - 8);
    const S = g + this[++f] * 2 ** 8 + this[++f] * 2 ** 16 + this[++f] * 2 ** 24, R = this[++f] + this[++f] * 2 ** 8 + this[++f] * 2 ** 16 + $ * 2 ** 24;
    return BigInt(S) + (BigInt(R) << BigInt(32));
  }), u.prototype.readBigUInt64BE = yt(function(f) {
    f = f >>> 0, sn(f, "offset");
    const g = this[f], $ = this[f + 7];
    (g === void 0 || $ === void 0) && Bn(f, this.length - 8);
    const S = g * 2 ** 24 + this[++f] * 2 ** 16 + this[++f] * 2 ** 8 + this[++f], R = this[++f] * 2 ** 24 + this[++f] * 2 ** 16 + this[++f] * 2 ** 8 + $;
    return (BigInt(S) << BigInt(32)) + BigInt(R);
  }), u.prototype.readIntLE = function(f, g, $) {
    f = f >>> 0, g = g >>> 0, $ || ie(f, g, this.length);
    let S = this[f], R = 1, N = 0;
    for (; ++N < g && (R *= 256); )
      S += this[f + N] * R;
    return R *= 128, S >= R && (S -= Math.pow(2, 8 * g)), S;
  }, u.prototype.readIntBE = function(f, g, $) {
    f = f >>> 0, g = g >>> 0, $ || ie(f, g, this.length);
    let S = g, R = 1, N = this[f + --S];
    for (; S > 0 && (R *= 256); )
      N += this[f + --S] * R;
    return R *= 128, N >= R && (N -= Math.pow(2, 8 * g)), N;
  }, u.prototype.readInt8 = function(f, g) {
    return f = f >>> 0, g || ie(f, 1, this.length), this[f] & 128 ? (255 - this[f] + 1) * -1 : this[f];
  }, u.prototype.readInt16LE = function(f, g) {
    f = f >>> 0, g || ie(f, 2, this.length);
    const $ = this[f] | this[f + 1] << 8;
    return $ & 32768 ? $ | 4294901760 : $;
  }, u.prototype.readInt16BE = function(f, g) {
    f = f >>> 0, g || ie(f, 2, this.length);
    const $ = this[f + 1] | this[f] << 8;
    return $ & 32768 ? $ | 4294901760 : $;
  }, u.prototype.readInt32LE = function(f, g) {
    return f = f >>> 0, g || ie(f, 4, this.length), this[f] | this[f + 1] << 8 | this[f + 2] << 16 | this[f + 3] << 24;
  }, u.prototype.readInt32BE = function(f, g) {
    return f = f >>> 0, g || ie(f, 4, this.length), this[f] << 24 | this[f + 1] << 16 | this[f + 2] << 8 | this[f + 3];
  }, u.prototype.readBigInt64LE = yt(function(f) {
    f = f >>> 0, sn(f, "offset");
    const g = this[f], $ = this[f + 7];
    (g === void 0 || $ === void 0) && Bn(f, this.length - 8);
    const S = this[f + 4] + this[f + 5] * 2 ** 8 + this[f + 6] * 2 ** 16 + ($ << 24);
    return (BigInt(S) << BigInt(32)) + BigInt(g + this[++f] * 2 ** 8 + this[++f] * 2 ** 16 + this[++f] * 2 ** 24);
  }), u.prototype.readBigInt64BE = yt(function(f) {
    f = f >>> 0, sn(f, "offset");
    const g = this[f], $ = this[f + 7];
    (g === void 0 || $ === void 0) && Bn(f, this.length - 8);
    const S = (g << 24) + // Overflow
    this[++f] * 2 ** 16 + this[++f] * 2 ** 8 + this[++f];
    return (BigInt(S) << BigInt(32)) + BigInt(this[++f] * 2 ** 24 + this[++f] * 2 ** 16 + this[++f] * 2 ** 8 + $);
  }), u.prototype.readFloatLE = function(f, g) {
    return f = f >>> 0, g || ie(f, 4, this.length), t.read(this, f, !0, 23, 4);
  }, u.prototype.readFloatBE = function(f, g) {
    return f = f >>> 0, g || ie(f, 4, this.length), t.read(this, f, !1, 23, 4);
  }, u.prototype.readDoubleLE = function(f, g) {
    return f = f >>> 0, g || ie(f, 8, this.length), t.read(this, f, !0, 52, 8);
  }, u.prototype.readDoubleBE = function(f, g) {
    return f = f >>> 0, g || ie(f, 8, this.length), t.read(this, f, !1, 52, 8);
  };
  function de(b, f, g, $, S, R) {
    if (!u.isBuffer(b)) throw new TypeError('"buffer" argument must be a Buffer instance');
    if (f > S || f < R) throw new RangeError('"value" argument is out of bounds');
    if (g + $ > b.length) throw new RangeError("Index out of range");
  }
  u.prototype.writeUintLE = u.prototype.writeUIntLE = function(f, g, $, S) {
    if (f = +f, g = g >>> 0, $ = $ >>> 0, !S) {
      const W = Math.pow(2, 8 * $) - 1;
      de(this, f, g, $, W, 0);
    }
    let R = 1, N = 0;
    for (this[g] = f & 255; ++N < $ && (R *= 256); )
      this[g + N] = f / R & 255;
    return g + $;
  }, u.prototype.writeUintBE = u.prototype.writeUIntBE = function(f, g, $, S) {
    if (f = +f, g = g >>> 0, $ = $ >>> 0, !S) {
      const W = Math.pow(2, 8 * $) - 1;
      de(this, f, g, $, W, 0);
    }
    let R = $ - 1, N = 1;
    for (this[g + R] = f & 255; --R >= 0 && (N *= 256); )
      this[g + R] = f / N & 255;
    return g + $;
  }, u.prototype.writeUint8 = u.prototype.writeUInt8 = function(f, g, $) {
    return f = +f, g = g >>> 0, $ || de(this, f, g, 1, 255, 0), this[g] = f & 255, g + 1;
  }, u.prototype.writeUint16LE = u.prototype.writeUInt16LE = function(f, g, $) {
    return f = +f, g = g >>> 0, $ || de(this, f, g, 2, 65535, 0), this[g] = f & 255, this[g + 1] = f >>> 8, g + 2;
  }, u.prototype.writeUint16BE = u.prototype.writeUInt16BE = function(f, g, $) {
    return f = +f, g = g >>> 0, $ || de(this, f, g, 2, 65535, 0), this[g] = f >>> 8, this[g + 1] = f & 255, g + 2;
  }, u.prototype.writeUint32LE = u.prototype.writeUInt32LE = function(f, g, $) {
    return f = +f, g = g >>> 0, $ || de(this, f, g, 4, 4294967295, 0), this[g + 3] = f >>> 24, this[g + 2] = f >>> 16, this[g + 1] = f >>> 8, this[g] = f & 255, g + 4;
  }, u.prototype.writeUint32BE = u.prototype.writeUInt32BE = function(f, g, $) {
    return f = +f, g = g >>> 0, $ || de(this, f, g, 4, 4294967295, 0), this[g] = f >>> 24, this[g + 1] = f >>> 16, this[g + 2] = f >>> 8, this[g + 3] = f & 255, g + 4;
  };
  function _n(b, f, g, $, S) {
    uo(f, $, S, b, g, 7);
    let R = Number(f & BigInt(4294967295));
    b[g++] = R, R = R >> 8, b[g++] = R, R = R >> 8, b[g++] = R, R = R >> 8, b[g++] = R;
    let N = Number(f >> BigInt(32) & BigInt(4294967295));
  ...
  u.prototype.writeBigUInt64LE = yt(function(f, g = 0) {
    return _n(this, f, g, BigInt(0), BigInt("0xffffffffffffffff"));
  }), u.prototype.writeBigUInt64BE = yt(function(f, g = 0) {
    return oo(this, f, g, BigInt(0), BigInt("0xffffffffffffffff"));
  }), u.prototype.writeIntLE = function(f, g, $, S) {
    if (f = +f, g = g >>> 0, !S) {
      const te = Math.pow(2, 8 * $ - 1);
      de(this, f, g, $, te - 1, -te);
    }
    let R = 0, N = 1, W = 0;
    for (this[g] = f & 255; ++R < $ && (N *= 256); )
      f < 0 && W === 0 && this[g + R - 1] !== 0 && (W = 1), this[g + R] = (f / N >> 0) - W & 255;
    return g + $;
  }, u.prototype.writeIntBE = function(f, g, $, S) {
    if (f = +f, g = g >>> 0, !S) {
      const te = Math.pow(2, 8 * $ - 1);
      de(this, f, g, $, te - 1, -te);
    }
    ...
    for (this[g + R] = f & 255; --R >= 0 && (N *= 256); )
      f < 0 && W === 0 && this[g + R + 1] !== 0 && (W = 1), this[g + R] = (f / N >> 0) - W & 255;
    return g + $;
  }, u.prototype.writeInt8 = function(f, g, $) {
    return f = +f, g = g >>> 0, $ || de(this, f, g, 1, 127, -128), f < 0 && (f = 255 + f + 1), this[g] = f & 255, g + 1;
  }, u.prototype.writeInt16LE = function(f, g, $) {
    return f = +f, g = g >>> 0, $ || de(this, f, g, 2, 32767, -32768), this[g] = f & 255, this[g + 1] = f >>> 8, g + 2;
  }, u.prototype.writeInt16BE = function(f, g, $) {
    return f = +f, g = g >>> 0, $ || de(this, f, g, 2, 32767, -32768), this[g] = f >>> 8, this[g + 1] = f & 255, g + 2;
  }, u.prototype.writeInt32LE = function(f, g, $) {
    return f = +f, g = g >>> 0, $ || de(this, f, g, 4, 2147483647, -2147483648), this[g] = f & 255, this[g + 1] = f >>> 8, this[g + 2] = f >>> 16, this[g + 3] = f >>> 24, g + 4;
  }, u.prototype.writeInt32BE = function(f, g, $) {
    return f = +f, g = g >>> 0, $ || de(this, f, g, 4, 2147483647, -2147483648), f < 0 && (f = 4294967295 + f + 1), this[g] = f >>> 24, this[g + 1] = f >>> 16, this[g + 2] = f >>> 8, this[g + 3] = f & 255, g + 4;
  }, u.prototype.writeBigInt64LE = yt(function(f, g = 0) {
    return _n(this, f, g, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
  }), u.prototype.writeBigInt64BE = yt(function(f, g = 0) {
    return oo(this, f, g, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
  });
  function io(b, f, g, $, S, R) {
    if (g + $ > b.length) throw new RangeError("Index out of range");
    if (g < 0) throw new RangeError("Index out of range");
  }
  function ao(b, f, g, $, S) {
    return f = +f, g = g >>> 0, S || io(b, f, g, 4), t.write(b, f, g, $, 23, 4), g + 4;
  }
  u.prototype.writeFloatLE = function(f, g, $) {
    return ao(this, f, g, !0, $);
  }, u.prototype.writeFloatBE = function(f, g, $) {
    return ao(this, f, g, !1, $);
  };
  function co(b, f, g, $, S) {
    return f = +f, g = g >>> 0, S || io(b, f, g, 8), t.write(b, f, g, $, 52, 8), g + 8;
  }
  u.prototype.writeDoubleLE = function(f, g, $) {
    return co(this, f, g, !0, $);
  }, u.prototype.writeDoubleBE = function(f, g, $) {
    return co(this, f, g, !1, $);
  }, u.prototype.copy = function(f, g, $, S) {
    if (!u.isBuffer(f)) throw new TypeError("argument should be a Buffer");
    if ($ || ($ = 0), !S && S !== 0 && (S = this.length), g >= f.length && (g = f.length), g || (g = 0), S > 0 && S < $ && (S = $), S === $ || f.length === 0 || this.length === 0) return 0;
    if (g < 0)
      throw new RangeError("targetStart out of bounds");
    if ($ < 0 || $ >= this.length) throw new RangeError("Index out of range");
    if (S < 0) throw new RangeError("sourceEnd out of bounds");
    S > this.length && (S = this.length), f.length - g < S - $ && (S = f.length - g + $);
    const R = S - $;
    return this === f && typeof o.prototype.copyWithin == "function" ? this.copyWithin(g, $, S) : o.prototype.set.call(
      f,
      this.subarray($, S),
      g
    ), R;
  }, u.prototype.fill = function(f, g, $, S) {
    if (typeof f == "string") {
    ...
    if ($ <= g)
      return this;
    g = g >>> 0, $ = $ === void 0 ? this.length : $ >>> 0, f || (f = 0);
    let R;
    if (typeof f == "number")
      for (R = g; R < $; ++R)
        this[R] = f;
    else {
      const N = u.isBuffer(f) ? f : u.from(f, S), W = N.length;
      if (W === 0)
  ...
  Wr(
    ...
    function(b, f, g) {
      ...
      return Number.isInteger(g) && Math.abs(g) > 2 ** 32 ? S = lo(String(g)) : typeof g == "bigint" && (S = String(g), (g > BigInt(2) ** BigInt(32) || g < -(BigInt(2) ** BigInt(32))) && (S = lo(S)), S += "n"), $ += ` It must be ${f}. Received ${S}`, $;
    },
    RangeError
  );
  function lo(b) {
    ...
    for (; g >= $ + 4; g -= 3)
      f = `_${b.slice(g - 3, g)}${f}`;
    return `${b.slice(0, g)}${f}`;
  }
  function Yc(b, f, g) {
    sn(f, "offset"), (b[f] === void 0 || b[f + g] === void 0) && Bn(f, b.length - (g + 1));
  }
  function uo(b, f, g, $, S, R) {
    if (b > g || b < f) {
      const N = typeof f == "bigint" ? "n" : "";
      let W;
      throw f === 0 || f === BigInt(0) ? W = `>= 0${N} and < 2${N} ** ${(R + 1) * 8}${N}` : W = `>= -(2${N} ** ${(R + 1) * 8 - 1}${N}) and < 2 ** ${(R + 1) * 8 - 1}${N}`, new rn.ERR_OUT_OF_RANGE("value", W, b);
    }
    Yc($, S, R);
  }
  function sn(b, f) {
    if (typeof b != "number")
      throw new rn.ERR_INVALID_ARG_TYPE(f, "number", b);
  }
  function Bn(b, f, g) {
    throw Math.floor(b) !== b ? (sn(b, g), new rn.ERR_OUT_OF_RANGE("offset", "an integer", b)) : f < 0 ? new rn.ERR_BUFFER_OUT_OF_BOUNDS() : new rn.ERR_OUT_OF_RANGE(
      "offset",
      `>= 0 and <= ${f}`,
      b
    );
  }
  const Qc = /[^+/0-9A-Za-z-_]/g;
  function Zc(b) {
    if (b = b.split("=")[0], b = b.trim().replace(Qc, ""), b.length < 2) return "";
    for (; b.length % 4 !== 0; )
      b = b + "=";
    return b;
  }
  function Gr(b, f) {
    ...
    for (let N = 0; N < $; ++N) {
      if (g = b.charCodeAt(N), g > 55295 && g < 57344) {
        ...
        if (g < 56320) {
          (f -= 3) > -1 && R.push(239, 191, 189), S = g;
          continue;
        }
        g = (S - 55296 << 10 | g - 56320) + 65536;
      } else S && (f -= 3) > -1 && R.push(239, 191, 189);
      if (S = null, g < 128) {
        if ((f -= 1) < 0) break;
        R.push(g);
      } else if (g < 2048) {
  ...
  function Jc(b) {
    ...
    for (let g = 0; g < b.length; ++g)
      f.push(b.charCodeAt(g) & 255);
    return f;
  }
  function el(b, f) {
    let g, $, S;
    const R = [];
    for (let N = 0; N < b.length && !((f -= 2) < 0); ++N)
      g = b.charCodeAt(N), $ = g >> 8, S = g % 256, R.push(S), R.push($);
    return R;
  }
  function ho(b) {
    return e.toByteArray(Zc(b));
  }
  function sr(b, f, g, $) {
    let S;
    for (S = 0; S < $ && !(S + g >= f.length || S >= b.length); ++S)
      f[S + g] = b[S];
    return S;
  }
  function rt(b, f) {
  ...
  function yt(b) {
    return typeof BigInt > "u" ? nl : b;
  }
  function nl() {
    throw new Error("BigInt not supported");
  }
})(Ls);
const Dr = Ls.Buffer, BS = Ls.Buffer;
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
...
function Qh(n, e) {
  ...
  if (Zi(n)) {
    ...
    return [n.buffer.size / (e == null ? 4 : xr(e))];
  if (!Array.isArray(n))
    return [];
  const r = [];
  for (; Array.isArray(t) || ze(t) && e !== "string"; )
    r.push(t.length), t = t[0];
  return Array.isArray(n) && E().getBool("TENSORLIKE_CHECK_SHAPE_CONSISTENCY") && ia(n, r, []), r;
}
function ia(n, e, t) {
  if (t = t || [], !Array.isArray(n) && !ze(n)) {
    _(e.length === 0, () => `Element arr[${t.join("][")}] is a primitive, but should be an array/TypedArray of ${e[0]} elements`);
    return;
  }
  _(e.length > 0, () => `Element arr[${t.join("][")}] should be a primitive, but is an array of ${n.length} elements`), _(n.length === e[0], () => `Element arr[${t.join("][")}] should have ${e[0]} elements, but has ${n.length} elements`);
  const r = e.slice(1);
  for (let s = 0; s < n.length; ++s)
    ia(n[s], r, t.concat(s));
}
...
function ee(n, e, t, r = "numeric") {
  if (n instanceof Me)
    return No(r, n.dtype, e, t), n;
  let s = Kn(n);
  if (s !== "string" && ["bool", "int32", "float32"].indexOf(r) >= 0 && (s = r), No(r, s, e, t), n == null || !ze(n) && !Array.isArray(n) && typeof n != "number" && typeof n != "boolean" && typeof n != "string") {
  ...
  const a = s !== "string" ? Ar(n, s) : Vt(n, [], !0);
  return V.makeTensor(a, o, s);
}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
...
function Ie(n) {
  ...
  let t = e[0];
  const r = n[t];
  t.endsWith("_") && (t = t.substring(0, t.length - 1)), t = t + Zh;
  const s = (...o) => {
    V.startScope(t);
    try {
      const i = r(...o);
      return As(i) && console.error("Cannot return a Promise inside of tidy."), V.endScope(i), i;
    } catch (i) {
 ...
 */
function Jh(n, e) {
  const t = ee(n, "real", "complex"), r = ee(e, "imag", "complex");
  wi(t.shape, r.shape, `real and imag shapes, ${t.shape} and ${r.shape}, must match in call to tf.complex().`);
  const s = { real: t, imag: r };
  return V.runKernel(Ti, s);
}
const ef = /* @__PURE__ */ Ie({ complex_: Jh });
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
...
function tf(n, e, t, r) {
  ...
  if (Ji(n) || Zi(n)) {
    ...
    return V.backend.createTensorFromGPUData(n, e || t, r);
  }
  ...
  if (e != null) {
    Yn(e);
    const s = P(e), o = P(t);
    _(s === o, () => `Based on the provided shape, [${e}], the tensor should have ${s} values but has ${o}`);
    for (let i = 0; i < t.length; ++i) {
      const a = t[i], c = i === t.length - 1 ? a !== P(e.slice(i)) : !0;
      _(t[i] === e[i] || !c, () => `Error creating a new Tensor. Inferred shape (${t}) does not match the provided shape (${e}). `);
    }
  }
  return !ze(n) && !Array.isArray(n) && (n = [n]), e = e || t, n = r !== "string" ? Ar(n, r) : Vt(n, [], !0), V.makeTensor(n, e, r);
}
class Yt {
  /**
...
const Us = typeof Dr < "u" && (typeof Blob > "u" || typeof atob > "u" || typeof btoa > "u");
function ko(n) {
  return Us ? Dr.byteLength(n, "utf8") : new Blob([n]).size;
}
function rf(n) {
  if (Us)
    return Dr.from(n).toString("base64");
...
async function af(n, e) {
  let t, r;
  return n.weightsManifest != null && ([t, r] = await e(n.weightsManifest)), of(n, t, r);
}
function Or(n) {
  ...
  return {
    ...
    modelTopologyBytes: n.modelTopology == null ? 0 : ko(JSON.stringify(n.modelTopology)),
    weightSpecsBytes: n.weightSpecs == null ? 0 : ko(JSON.stringify(n.weightSpecs)),
...
class he {
  ...
  static registerSaveRouter(e) {
    he.getInstance().saveRouters.push(e);
  }
  /**
  ...
  static registerLoadRouter(e) {
    he.getInstance().loadRouters.push(e);
  }
  /**
  ...
  static getLoadHandlers(e, t) {
    return he.getHandlers(e, "load", t);
  }
  static getHandlers(e, t, r) {
    const s = [];
    return (t === "load" ? he.getInstance().loadRouters : he.getInstance().saveRouters).forEach((i) => {
      const a = i(e, r);
      a !== null && s.push(a);
    }), s;
  }
 ...
 * =============================================================================
 */
const ms = "tensorflowjs", gs = 1, Bt = "models_store", It = "model_info_store";
function ca() {
...
class Wt {
  ...
  databaseAction(e, t) {
    return new Promise((r, s) => {
      const o = this.indexedDB.open(ms, gs);
      o.onupgradeneeded = () => xs(o), o.onsuccess = () => {
        const i = o.result;
        if (t == null) {
          ...
          const a = Or(t), c = i.transaction(It, "readwrite");
          ...
          u.onsuccess = () => {
            ...
            p.onsuccess = () => r({ modelArtifactsInfo: a }), p.onerror = (m) => {
              l = c.objectStore(It);
              const C = l.delete(this.modelPath);
              C.onsuccess = () => (i.close(), s(p.error)), C.onerror = (w) => (i.close(), s(p.error));
            };
...
const la = (n) => E().getBool("IS_BROWSER") && !Array.isArray(n) && n.startsWith(Wt.URL_SCHEME) ? lf(n.slice(Wt.URL_SCHEME.length)) : null;
he.registerSaveRouter(la);
he.registerLoadRouter(la);
function lf(n) {
  return new Wt(n);
}
function uf(n) {
...
class df {
  ...
  async listModels() {
    return new Promise((e, t) => {
      const r = this.indexedDB.open(ms, gs);
      r.onupgradeneeded = () => xs(r), r.onsuccess = () => {
  ...
  async removeModel(e) {
    return e = uf(e), new Promise((t, r) => {
      const s = this.indexedDB.open(ms, gs);
      s.onupgradeneeded = () => xs(s), s.onsuccess = () => {
        ...
        c.onsuccess = () => {
            ...
            return o.close(), r(new Error(`Cannot find model with path '${e}' in IndexedDB.`));
          {
            const u = a.delete(e), d = () => {
              ...
              const p = l.objectStore(Bt).delete(e);
              p.onsuccess = () => t(c.result.modelArtifactsInfo), p.onerror = (m) => r(c.error);
            };
 ...
 * =============================================================================
 */
const ft = "/", ln = "tensorflowjs_models", ua = "info", hf = "model_topology", ff = "weight_specs", pf = "weight_data", mf = "model_metadata";
function da(n) {
  return {
    info: [ln, n, ua].join(ft),
    topology: [ln, n, hf].join(ft),
    weightSpecs: [ln, n, ff].join(ft),
    weightData: [ln, n, pf].join(ft),
    modelMetadata: [ln, n, mf].join(ft)
  };
}
function ha(n) {
...
class Gt {
  constructor(e) {
    ...
    this.modelPath = e, this.keys = da(this.modelPath);
  }
  /**
  ...
  async save(e) {
    if (e.modelTopology instanceof ArrayBuffer)
      throw new Error("BrowserLocalStorage.save() does not support saving model topology in binary formats yet.");
    {
      const t = JSON.stringify(e.modelTopology), r = JSON.stringify(e.weightSpecs), s = Or(e), o = Yt.join(e.weightData);
      try {
        this.LS.setItem(this.keys.info, JSON.stringify(s)), this.LS.setItem(this.keys.topology, t), this.LS.setItem(this.keys.weightSpecs, r), this.LS.setItem(this.keys.weightData, rf(o));
        const i = {
          format: e.format,
        ...
        throw ha(this.keys), new Error(`Failed to save model '${this.modelPath}' to local storage: size quota being exceeded is a possible cause of this failure: modelTopologyBytes=${s.modelTopologyBytes}, weightSpecsBytes=${s.weightSpecsBytes}, weightDataBytes=${s.weightDataBytes}.`);
      }
    }
  }
  /**
  ...
  async load() {
    ...
    return t.weightData = sf(i), t;
  }
}
Gt.URL_SCHEME = "localstorage://";
const fa = (n) => E().getBool("IS_BROWSER") && !Array.isArray(n) && n.startsWith(Gt.URL_SCHEME) ? wf(n.slice(Gt.URL_SCHEME.length)) : null;
he.registerSaveRouter(fa);
he.registerLoadRouter(fa);
function wf(n) {
  return new Gt(n);
}
class Cf {
  constructor() {
    _(E().getBool("IS_BROWSER"), () => "Current environment is not a web browser"), _(typeof window > "u" || typeof window.localStorage < "u", () => "Current browser does not appear to support localStorage"), this.LS = window.localStorage;
  }
  async listModels() {
    const e = {}, t = ln + ft, r = ft + ua;
...
class it {
  ...
  static registerManager(e, t) {
    _(e != null, () => "scheme must not be undefined or null."), e.endsWith(Ao) && (e = e.slice(0, e.indexOf(Ao))), _(e.length > 0, () => "scheme must not be an empty string.");
    const r = it.getInstance();
    _(r.managers[e] == null, () => `A model store manager is already registered for scheme '${e}'.`), r.managers[e] = t;
  }
  static getManager(e) {
...
if (E().get("IS_BROWSER")) {
  E().setPlatform("browser", new bf());
  try {
    it.registerManager(Gt.URL_SCHEME, new Cf());
  } catch {
  }
  try {
    it.registerManager(Wt.URL_SCHEME, new df());
  } catch {
  }
}
const yf = {
...
class $f {
  ...
  fetch(e, t) {
    return E().global.fetch != null ? E().global.fetch(e, t) : (Kr == null && (Kr = yf.importFetch()), Kr(e, t));
  }
  now() {
    const e = fn.hrtime();
...
E().get("IS_NODE") && !E().get("IS_BROWSER") && E().setPlatform("node", new $f());
/**
 * @license
 ...
 * =============================================================================
 */
function ge(n, e = "float32", t) {
  return e = e || "float32", Yn(n), new br(n, e, t);
}
/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
...
function vf(n, e) {
  ...
  return V.runKernel(Os, r, s);
}
const ws = /* @__PURE__ */ Ie({ cast_: vf });
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */
function If(n) {
  const t = { x: ee(n, "x", "clone", "string_or_numeric") };
  return V.runKernel(Ps, t);
}
const pa = /* @__PURE__ */ Ie({ clone_: If });
/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
...
function Pe(n) {
  ea(n).forEach((t) => t.dispose());
}
function Rf(n) {
  return V.keep(n);
}
function US(n) {
  return V.setBackend(n);
}
function VS() {
  return V.ready();
}
function Tf(n, e, t = 1) {
  return V.registerBackend(n, e, t);
}
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 ...
 */
function Nf(n, e) {
  let t = ee(n, "a", "add"), r = ee(e, "b", "add");
  [t, r] = Kt(t, r);
  const s = { a: t, b: r };
  return V.runKernel(Ds, s);
}
const q = /* @__PURE__ */ Ie({ add_: Nf });
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */
function kf(n, e) {
  let t = ee(n, "a", "floorDiv"), r = ee(e, "b", "floorDiv");
  [t, r] = Kt(t, r);
  const s = { a: t, b: r };
  return V.runKernel(Fi, s);
}
const Af = /* @__PURE__ */ Ie({ floorDiv_: kf });
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */
function Ff(n, e) {
  let t = ee(n, "a", "div"), r = ee(e, "b", "div");
  if ([t, r] = Kt(t, r), t.dtype === "int32" && r.dtype === "int32")
    return Af(t, r);
  const s = { a: t, b: r }, o = {};
  return V.runKernel(ki, s, o);
}
const lt = /* @__PURE__ */ Ie({ div_: Ff });
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */
function Df(n, e) {
  let t = ee(n, "a", "mul"), r = ee(e, "b", "mul");
  [t, r] = Kt(t, r);
  const s = { a: t, b: r };
  return V.runKernel(Oi, s);
}
const z = /* @__PURE__ */ Ie({ mul_: Df });
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
...
function Of(n) {
  ...
  if (e.dtype === "complex64") {
    const t = { x: e };
    return V.runKernel(Ni, t);
  } else {
    const t = { x: e };
    return V.runKernel(Ri, t);
  }
}
const Pf = /* @__PURE__ */ Ie({ abs_: Of });
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
...
function Qn(n, e, t, r, s, o, i = "NDHWC") {
  const [a, c, l] = Cs(e);
  let u, d;
  if (i === "NDHWC")
...
function et(n, e, t, r, s, o, i = !1, a = "channelsLast") {
  ...
  const [h, p, , m] = e, [C, w] = $r(t), [x, y] = $r(r), v = pn(h, x), I = pn(p, y), { padInfo: T, outHeight: A, outWidth: F } = Lf(s, l, u, C, w, v, I, o, a), k = i ? m * d : m;
  let M;
  return a === "channelsFirst" ? M = [c, k, A, F] : a === "channelsLast" && (M = [c, A, F, k]), {
    batchSize: c,
    dataFormat: a,
    inHeight: l,
    inWidth: u,
...
function Zn(n, e, t, r, s, o = !1, i = "channelsLast", a) {
  ...
  if (i === "channelsLast")
    ...
    throw new Error(`Unknown dataFormat ${i}`);
  const [p, m, C, , w] = e, [x, y, v] = Cs(t), [I, T, A] = Cs(r), F = pn(p, I), k = pn(m, T), M = pn(C, A), { padInfo: U, outDepth: G, outHeight: X, outWidth: Ce } = Mf(s, l, u, d, x, y, v, F, k, M, a), oe = o ? w * h : w;
  let ae;
  return i === "channelsFirst" ? ae = [c, oe, G, X, Ce] : i === "channelsLast" && (ae = [c, G, X, Ce, oe]), {
    batchSize: c,
    dataFormat: i,
    inDepth: l,
    inHeight: u,
...
function _f(n, e, t, r, s) {
  r == null && (r = Vs(n, e, t));
  const o = n[0], i = n[1], a = zn((o - e + 2 * r) / t + 1, s), c = zn((i - e + 2 * r) / t + 1, s);
  return [a, c];
}
function Bf(n, e, t, r, s, o) {
  s == null && (s = Vs(n, e[0], r[0]));
  const i = [0, 0, 0, t];
  for (let a = 0; a < 3; a++)
    n[a] + 2 * s >= e[a] && (i[a] = zn((n[a] - e[a] + 2 * s) / r[a] + 1, o));
  return i;
}
function Vs(n, e, t, r = 1) {
  const s = pn(e, r);
...
function Lf(n, e, t, r, s, o, i, a, c) {
  let l, u, d;
  if (typeof n == "number") {
    l = { top: n, bottom: n, left: n, right: n, type: n === 0 ? "VALID" : "NUMBER" };
    const p = _f([e, t], o, r, n, a);
    u = p[0], d = p[1];
  } else if (n === "same") {
    u = Math.ceil(e / r), d = Math.ceil(t / s);
    const h = Math.max(0, (u - 1) * r + o - e), p = Math.max(0, (d - 1) * s + i - t), m = Math.floor(h / 2), C = h - m, w = Math.floor(p / 2), x = p - w;
    ...
    const h = c === "channelsLast" ? n[1][0] : n[2][0], p = c === "channelsLast" ? n[1][1] : n[2][1], m = c === "channelsLast" ? n[2][0] : n[3][0], C = c === "channelsLast" ? n[2][1] : n[3][1];
    l = { top: h, bottom: p, left: m, right: C, type: h === 0 && p === 0 && m === 0 && C === 0 ? "VALID" : "EXPLICIT" }, u = zn((e - o + h + p) / r + 1, a), d = zn((t - i + m + C) / s + 1, a);
  } else
    throw Error(`Unknown padding parameter: ${n}`);
  return { padInfo: l, outHeight: u, outWidth: d };
}
function Mf(n, e, t, r, s, o, i, a, c, l, u) {
  let d, h, p, m;
  if (n === "valid" && (n = 0), typeof n == "number") {
    ...
    const w = Bf([e, t, r, 1], [a, c, l], 1, [s, o, i], n, u);
    h = w[0], p = w[1], m = w[2];
  } else if (n === "same") {
    h = Math.ceil(e / s), p = Math.ceil(t / o), m = Math.ceil(r / i);
    const C = (h - 1) * s + a - e, w = (p - 1) * o + c - t, x = (m - 1) * i + l - r, y = Math.floor(C / 2), v = C - y, I = Math.floor(w / 2), T = w - I, A = Math.floor(x / 2), F = x - A;
    d = { top: I, bottom: T, left: A, right: F, front: y, back: v, type: "SAME" };
  } else
    throw Error(`Unknown padding parameter: ${n}`);
  return { padInfo: d, outDepth: h, outHeight: p, outWidth: m };
}
function zn(n, e) {
  if (!e)
    return Math.trunc(n);
 ...
 */
function Uf(n, e) {
  const r = { x: ee(n, "x", "reshape", "string_or_numeric") }, s = { shape: e };
  return V.runKernel(_i, r, s);
}
const ga = /* @__PURE__ */ Ie({ reshape_: Uf });
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */
function Vf(n, e) {
  let t = ee(n, "broadcastTo", "x");
  const r = t.shape;
  if (Yn(e), e.length < t.rank)
  ...
  return V.runKernel(Mi, a, c);
}
const Wf = /* @__PURE__ */ Ie({ broadcastTo_: Vf });
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */
function zf(n) {
  const t = { x: ee(n, "x", "zerosLike") };
  return V.runKernel(Ui, t);
}
const ut = /* @__PURE__ */ Ie({ zerosLike_: zf });
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
...
function tt(n, e, t) {
  _(Ws(e, t), () => `${n} supports only inner-most axes for now. Got axes ${e} and rank-${t} input.`);
}
function He(n, e) {
  if (Ws(n, e))
    return null;
 ...
 */
function Hf(n, e) {
  let t = ee(n, "base", "pow"), r = ee(e, "exp", "pow");
  [t, r] = Kt(t, r);
  const s = { a: t, b: r };
  return V.runKernel(Pi, s);
}
const Fo = /* @__PURE__ */ Ie({ pow_: Hf });
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */
function Xf(n) {
  const t = { x: ee(n, "x", "sqrt", "float32") };
  return V.runKernel(Bi, t);
}
const Cn = /* @__PURE__ */ Ie({ sqrt_: Xf });
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */
function qf(n) {
  const e = ee(n, "x", "square"), t = {};
  return V.runKernel("Square", { x: e }, t);
}
const Mt = /* @__PURE__ */ Ie({ square_: qf });
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */
function jf(n, e) {
  _(ss(n), () => "The f passed in variableGrads(f) must be a function"), _(e == null || Array.isArray(e) && e.every((l) => l instanceof yr), () => "The varList passed in variableGrads(f, varList) must be an array of variables");
  const t = e != null;
  if (!t) {
    e = [];
    for (const l in V.registeredVariables)
      e.push(V.registeredVariables[l]);
  }
  const r = t ? e.filter((l) => !l.trainable) : null, s = e.length;
  e = e.filter((l) => l.trainable), _(e.length > 0, () => `variableGrads() expects at least one of the input variables to be trainable, but none of the ${s} variables is trainable.`);
  const o = !0, { value: i, grads: a } = V.gradients(n, e, null, o);
  _(a.some((l) => l != null), () => "Cannot find a connection between any variable and the result of the loss function y=f(x). Please make sure the operations that use variables are inside the function f passed to minimize()."), _(i.rank === 0, () => `The f passed in variableGrads(f) must return a scalar, but it returned a rank-${i.rank} tensor`);
  const c = {};
 ...
 */
function Kf(n, e) {
  let t = ee(n, "a", "sub"), r = ee(e, "b", "sub");
  [t, r] = Kt(t, r);
  const s = { a: t, b: r };
  return V.runKernel(Li, s);
}
const mn = /* @__PURE__ */ Ie({ sub_: Kf });
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */
function Yf(n, e) {
  let t = ee(n, "a", "maximum"), r = ee(e, "b", "maximum");
  [t, r] = Kt(t, r), t.dtype === "bool" && (t = ws(t, "int32"), r = ws(r, "int32")), $e(t.shape, r.shape);
  const s = { a: t, b: r };
  return V.runKernel(Di, s);
}
const Qf = /* @__PURE__ */ Ie({ maximum_: Yf });
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function ys(n, e = "float32") {
  if (Yn(n), e === "complex64") {
    const r = ys(n, "float32"), s = ys(n, "float32");
    return ef(r, s);
  }
  const t = Rt(P(n), e);
  return V.makeTensor(t, n, e);
}
function Pr(n, e, t) {
  ...
  for (let d = s; d < o; ++d)
    i *= t[d];
  const a = s < 1 ? 1 : s, c = P(e.shape) / a, l = [...pe(t.slice(0, s)), 1], u = P(t);
...
function Zf(n, e) {
  ...
  for (let o = 0; o < e.length; o++)
    e[o] && t.push(o);
  const r = ge(n, "int32"), s = ge([t.length, n.length], "int32");
...
function zs(n, e, t, r, s, o, i = !1, a = !1, c = !1) {
  const l = [];
  ...
  for (; d.length < t && l.length > 0; ) {
    ...
    for (let T = d.length - 1; T >= v; --T) {
      ...
      if (w.score = w.score * ap(r, u, A), w.score <= s)
        break;
    }
    w.suppressBeginIndex = d.length, I || (w.score === x ? (d.push(y), h.push(w.score)) : w.score > s && Jf(l, w, Do));
  }
  const p = d.length, m = t - p;
  a && m > 0 && (d.push(...new Array(m).fill(0)), h.push(...new Array(m).fill(0)));
  const C = { selectedIndices: d };
  return i && (C.selectedScores = h), c && (C.validOutputs = p), C;
}
function ip(n, e, t) {
  const r = n.subarray(e * 4, e * 4 + 4), s = n.subarray(t * 4, t * 4 + 4), o = Math.min(r[0], r[2]), i = Math.min(r[1], r[3]), a = Math.max(r[0], r[2]), c = Math.max(r[1], r[3]), l = Math.min(s[0], s[2]), u = Math.min(s[1], s[3]), d = Math.max(s[0], s[2]), h = Math.max(s[1], s[3]), p = (a - o) * (c - i), m = (d - l) * (h - u);
  if (p <= 0 || m <= 0)
    return 0;
 ...
 * =============================================================================
 */
const cp = /* @__PURE__ */ new Map(), lp = /* @__PURE__ */ new Map();
class up {
  /**
...
function dp(n, e, t) {
  _(n.className != null, () => "Class being registered does not have the static className property defined."), _(typeof n.className == "string", () => "className is required to be a string, but got type " + typeof n.className), _(n.className.length > 0, () => "Class being registered has an empty-string as its className, which is disallowed."), typeof e > "u" && (e = "Custom"), typeof t > "u" && (t = n.className);
  const r = t, s = e + ">" + r;
  return Dt.register(n), cp.set(s, n), lp.set(n, s), n;
}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
...
class Qt extends up {
  ...
  minimize(e, t = !1, r) {
    ...
    return Pe(o), t ? s : (s.dispose(), null);
  }
  /**
   ...
   */
  dispose() {
    this.iterations_ != null && Pe(this.iterations_);
  }
...
class hp extends Qt {
  ...
  constructor(e, t, r = null) {
    super(), this.learningRate = e, this.rho = t, this.epsilon = r, this.accumulatedGrads = [], this.accumulatedUpdates = [], r == null && (this.epsilon = V.backend.epsilon());
  }
  applyGradients(e) {
    (Array.isArray(e) ? e.map((r) => r.name) : Object.keys(e)).forEach((r, s) => {
      const o = V.registeredVariables[r], i = !1;
      this.accumulatedGrads[s] == null && (this.accumulatedGrads[s] = {
        originalName: `${r}/accum_grad`,
        variable: re(() => ut(o).variable(i))
      ...
      re(() => {
        ...
        const p = q(z(d, -this.learningRate), o);
        o.assign(p);
      });
    }), this.incrementIterations();
  }
  dispose() {
    this.accumulatedUpdates != null && (Pe(this.accumulatedGrads.map((e) => e.variable)), Pe(this.accumulatedUpdates.map((e) => e.variable)));
  }
  async getWeights() {
...
class fp extends Qt {
  ...
  applyGradients(e) {
    (Array.isArray(e) ? e.map((r) => r.name) : Object.keys(e)).forEach((r, s) => {
      const o = V.registeredVariables[r];
      this.accumulatedGrads[s] == null && (this.accumulatedGrads[s] = {
        originalName: `${r}/accumulator`,
        variable: re(() => Gf(o.shape, this.initialAccumulatorValue).variable(!1))
      });
      ...
      re(() => {
        const c = q(a, Mt(i));
        a.assign(c);
        const l = q(z(lt(i, Cn(q(c, V.backend.epsilon()))), -this.learningRate), o);
        o.assign(l);
      });
    }), this.incrementIterations();
  }
  dispose() {
    this.accumulatedGrads != null && Pe(this.accumulatedGrads.map((e) => e.variable));
  }
  async getWeights() {
...
class pp extends Qt {
  ...
  constructor(e, t, r, s = null) {
    super(), this.learningRate = e, this.beta1 = t, this.beta2 = r, this.epsilon = s, this.accumulatedFirstMoment = [], this.accumulatedSecondMoment = [], re(() => {
  ...
  applyGradients(e) {
    ...
    re(() => {
      ...
      t.forEach((o, i) => {
        ...
        if (l == null)
          return;
        const u = this.accumulatedFirstMoment[i].variable, d = this.accumulatedSecondMoment[i].variable, h = q(z(u, this.beta1), z(l, 1 - this.beta1)), p = q(z(d, this.beta2), z(Mt(l), 1 - this.beta2)), m = lt(h, r), C = lt(p, s);
  ...
  dispose() {
    this.accBeta1.dispose(), this.accBeta2.dispose(), this.accumulatedFirstMoment != null && Pe(this.accumulatedFirstMoment.map((e) => e.variable)), this.accumulatedSecondMoment != null && Pe(this.accumulatedSecondMoment.map((e) => e.variable));
  }
  async getWeights() {
  ...
  async setWeights(e) {
    e = await this.extractIterations(e), re(() => {
      this.accBeta1.assign(Fo(this.beta1, this.iterations_ + 1)), this.accBeta2.assign(Fo(this.beta2, this.iterations_ + 1));
    });
    const t = e.length / 2, r = !1;
...
class mp extends Qt {
  ...
  constructor(e, t, r, s = null, o = 0) {
    super(), this.learningRate = e, this.beta1 = t, this.beta2 = r, this.epsilon = s, this.decay = o, this.accumulatedFirstMoment = [], this.accumulatedWeightedInfNorm = [], re(() => {
  ...
  applyGradients(e) {
    ...
    re(() => {
      ...
      t.forEach((o, i) => {
        ...
        if (l == null)
          return;
        const u = this.accumulatedFirstMoment[i].variable, d = this.accumulatedWeightedInfNorm[i].variable, h = q(z(u, this.beta1), z(l, 1 - this.beta1)), p = z(d, this.beta2), m = Pf(l), C = Qf(p, m);
  ...
  dispose() {
    this.accBeta1.dispose(), this.iteration.dispose(), this.accumulatedFirstMoment != null && Pe(this.accumulatedFirstMoment.map((e) => e.variable)), this.accumulatedWeightedInfNorm != null && Pe(this.accumulatedWeightedInfNorm.map((e) => e.variable));
  }
  async getWeights() {
...
class wa extends Qt {
  ...
  applyGradients(e) {
    (Array.isArray(e) ? e.map((r) => r.name) : Object.keys(e)).forEach((r, s) => {
      ...
      if (o == null)
        return;
      const i = V.registeredVariables[r];
      re(() => {
   ...
   */
  setLearningRate(e) {
    this.learningRate = e, this.c != null && this.c.dispose(), this.c = Rf(Tt(-e));
  }
  dispose() {
    this.c.dispose();
  }
...
class gp extends wa {
  ...
  dispose() {
    this.m.dispose(), this.accumulations != null && Pe(this.accumulations.map((e) => e.variable));
  }
  /**
...
class xp extends Qt {
  ...
  constructor(e, t = 0.9, r = 0, s = null, o = !1) {
    if (super(), this.learningRate = e, this.decay = t, this.momentum = r, this.epsilon = s, this.accumulatedMeanSquares = [], this.accumulatedMoments = [], this.accumulatedMeanGrads = [], this.centered = o, s == null && (this.epsilon = V.backend.epsilon()), e == null)
  ...
  applyGradients(e) {
    (Array.isArray(e) ? e.map((r) => r.name) : Object.keys(e)).forEach((r, s) => {
      ...
      re(() => {
        ...
        if (this.centered) {
          const d = this.accumulatedMeanGrads[s].variable, h = q(z(d, this.decay), z(a, 1 - this.decay)), p = lt(z(a, this.learningRate), Cn(mn(u, q(Mt(h), this.epsilon)))), m = q(z(l, this.momentum), p);
  ...
  dispose() {
    this.accumulatedMeanSquares != null && Pe(this.accumulatedMeanSquares.map((e) => e.variable)), this.accumulatedMeanGrads != null && this.centered && Pe(this.accumulatedMeanGrads.map((e) => e.variable)), this.accumulatedMoments != null && Pe(this.accumulatedMoments.map((e) => e.variable));
  }
  async getWeights() {
 ...
 * =============================================================================
 */
const bp = "model", yp = ".json", $p = ".weights.bin";
function Oo(n) {
...
class zt {
  constructor(e) {
    ...
    e.startsWith(zt.URL_SCHEME) && (e = e.slice(zt.URL_SCHEME.length)), (e == null || e.length === 0) && (e = bp), this.modelJsonFileName = e + yp, this.weightDataFileName = e + $p;
  }
  async save(e) {
      ...
      throw new Error("BrowserDownloads.save() does not support saving model topology in binary formats yet.");
    {
      ...
      }], o = aa(e, s), i = window.URL.createObjectURL(new Blob([JSON.stringify(o)], { type: "application/json" })), a = this.modelJsonAnchor == null ? document.createElement("a") : this.modelJsonAnchor;
      if (a.download = this.modelJsonFileName, a.href = i, await Oo(() => a.dispatchEvent(new MouseEvent("click"))), e.weightData != null) {
        const c = this.weightDataAnchor == null ? document.createElement("a") : this.weightDataAnchor;
        c.download = this.weightDataFileName, c.href = r, await Oo(() => c.dispatchEvent(new MouseEvent("click")));
      }
      return { modelArtifactsInfo: Or(e) };
    }
  }
}
zt.URL_SCHEME = "downloads://";
const vp = (n) => E().getBool("IS_BROWSER") && !Array.isArray(n) && n.startsWith(zt.URL_SCHEME) ? Ip(n.slice(zt.URL_SCHEME.length)) : null;
he.registerSaveRouter(vp);
function Ip(n = "model") {
  return new zt(n);
}
/**
...
function Po(n, e, t, r) {
  ...
  function i(c) {
    _(c != null && Array.isArray(c) && c.length > 0, () => "promises must be a none empty array");
  }
  function a(c, l) {
    _(c >= 0 && c <= 1, () => `Progress fraction must be in range [0, 1], but got startFraction ${c}`), _(l >= 0 && l <= 1, () => `Progress fraction must be in range [0, 1], but got endFraction ${l}`), _(l >= c, () => `startFraction must be no more than endFraction, but got startFraction ${c} and endFraction ${l}`);
  }
...
async function Sp(n, e) {
  e == null && (e = {});
  const t = e.fetchFunc == null ? E().platform.fetch : e.fetchFunc, r = n.map((d) => t(d, e.requestInit, { isBinary: !0 })), a = (e.onProgress == null ? await Promise.all(r) : await Po(r, e.onProgress, 0, 0.5)).map((d) => d.arrayBuffer());
  return e.onProgress == null ? await Promise.all(a) : await Po(a, e.onProgress, 0.5, 1);
}
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 ...
 * =============================================================================
 */
const Ep = "application/octet-stream", Rp = "application/json";
class Hs {
  constructor(e, t) {
    if (this.DEFAULT_METHOD = "POST", t == null && (t = {}), this.weightPathPrefix = t.weightPathPrefix, this.onProgress = t.onProgress, this.weightUrlConverter = t.weightUrlConverter, t.fetchFunc != null ? (_(typeof t.fetchFunc == "function", () => "Must pass a function that matches the signature of `fetch` (see https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)"), this.fetch = t.fetchFunc) : this.fetch = E().platform.fetch, _(e != null && e.length > 0, () => "URL path for http must not be null, undefined or empty."), Array.isArray(e) && _(e.length === 2, () => `URL paths for http must have a length of 2, (actual length is ${e.length}).`), this.path = e, t.requestInit != null && t.requestInit.body != null)
  ...
  async save(e) {
    ...
    if (t.body.append("model.json", new Blob([JSON.stringify(s)], { type: Rp }), "model.json"), e.weightData != null) {
      const i = Yt.join(e.weightData);
      t.body.append("model.weights.bin", new Blob([i], { type: Ep }), "model.weights.bin");
    }
    const o = await this.fetch(this.path, t);
    if (o.ok)
      return {
        modelArtifactsInfo: Or(e),
        responses: [o]
      };
  ...
  async load() {
    ...
    return af(t, (o) => this.loadWeights(o));
  }
  async loadWeights(e) {
    const t = Array.isArray(this.path) ? this.path[1] : this.path, [r, s] = Tp(t), o = this.weightPathPrefix || r, i = cf(e), a = [], c = [];
    for (const u of e)
...
const Ca = (n, e) => {
  ...
  {
    let t = !0;
    if (Array.isArray(n) ? t = n.every((r) => _o(r)) : t = _o(n), t)
      return Np(n, e);
  }
  return null;
};
he.registerSaveRouter(Ca);
he.registerLoadRouter(Ca);
function Np(n, e) {
  return new Hs(n, e);
}
function ba(n, e) {
...
function Ap(n, e, t) {
  ...
  _(r === e.length, () => `Error in slice${r}D: Length of begin ${e} must match the rank of the array (${r}).`), _(r === t.length, () => `Error in slice${r}D: Length of size ${t} must match the rank of the array (${r}).`);
  for (let s = 0; s < r; ++s)
    _(e[s] + t[s] <= n.shape[s], () => `Error in slice${r}D: begin[${s}] + size[${s}] (${e[s] + t[s]}) would overflow input.shape[${s}] (${n.shape[s]})`);
}
function Fp(n, e, t) {
  const r = [];
  for (let s = 0; s < n.length; s++)
...
function Dp(n, e, t) {
  ...
  typeof e == "number" ? r = [e, ...new Array(s - 1).fill(0)] : e.length < s ? r = e.concat(new Array(s - e.length).fill(0)) : r = e.slice(), r.forEach((i) => {
    _(i !== -1, () => "slice() does not support negative begin indexing.");
  });
  let o;
  return t == null ? o = new Array(s).fill(-1) : typeof t == "number" ? o = [t, ...new Array(s - 1).fill(-1)] : t.length < s ? o = t.concat(new Array(s - t.length).fill(-1)) : o = t, o = o.map((i, a) => i >= 0 ? i : (_(i === -1, () => `Negative size values should be exactly -1 but got ${i} for the slice() size at index ${a}.`), n.shape[a] - r[a])), [r, o];
}
function Op(n, e, t, r, s, o, i, a, c) {
  let l;
  ...
  for (let v = 0; v < n.length; ++v) {
    ...
    if (h.beginValid && h.endValid) {
      if (I) {
        const X = h.begin[v] < 0 ? T + h.begin[v] : h.begin[v];
        if (h.begin[v] = X, h.end[v] = h.begin[v] + 1, X < 0 || X >= T)
          throw Error(`slice index ${h.begin[v]} of dimension ${v} out of bounds.`);
      } else
        h.begin[v] = Bo(h.begin[v], 0, h.strides[v], T, A, F), h.end[v] = Bo(h.end[v], 1, h.strides[v], T, A, F);
      const G = h.strides[v] === 1 && h.begin[v] === 0 && h.end[v] === T;
      p = p && G, m = m && (v === 0 && h.strides[v] === 1 || G);
    } else
      p = p && h.strides[v] === 1 && k, m = m && (v === 0 && h.strides[v] === 1 || k);
    let M, U = !1;
    if (h.beginValid && h.endValid ? (M = h.end[v] - h.begin[v], U = !0) : I ? (M = 1, U = !0) : k && T >= 0 && (h.strides[v] < 0 ? M = -T : M = T, U = !0), U) {
      let G;
      M === 0 || M < 0 != h.strides[v] < 0 ? G = 0 : G = Math.trunc(M / h.strides[v]) + (M % h.strides[v] !== 0 ? 1 : 0), w.push(G);
    } else
      w.push(-1);
  }
  for (let v = 0; v < h.finalShapeGatherIndices.length; ++v) {
    const I = h.finalShapeGatherIndices[v];
    I >= 0 ? x.push(w[I]) : I === $s && x.push(1);
  }
  return {
    finalShapeSparse: x.filter((v, I) => h.finalShapeGatherIndices[I] !== $s),
    finalShape: x,
    isIdentity: p,
    sliceDim0: m,
    isSimpleSlice: C,
 ...
 * =============================================================================
 */
const _p = typeof requestAnimationFrame < "u" ? requestAnimationFrame : typeof setImmediate < "u" ? setImmediate : (n) => n();
function Bp() {
  return new Promise((n) => _p(() => n()));
}
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
...
function va(n, e) {
  const t = n[0].length;
  n.forEach((s, o) => {
    _(s.length === t, () => `Error in concat${t}D: rank of tensors[${o}] must be the same as the rank of the rest (${t})`);
  }), _(e >= 0 && e < t, () => `Error in concat${t}D: axis must be between 0 and ${t - 1}.`);
  const r = n[0];
  n.forEach((s, o) => {
    for (let i = 0; i < t; i++)
      _(i === e || s[i] === r[i], () => `Error in concat${t}D: Shape of tensors[${o}] (${s}) does not match the shape of the rest (${r}) along the non-concatenated axis ${o}.`);
  });
}
function Ht(n, e) {
  const t = n[0].slice();
...
const Xs = 30;
function _r(n) {
  return n <= Xs ? n : os(n, Math.floor(Math.sqrt(n)));
}
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 ...
 * =============================================================================
 */
const Aa = 1.7580993408473768, Fa = 1.0507009873554805;
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
const Da = 0.3275911, Oa = 0.254829592, Pa = -0.284496736, _a = 1.421413741, Ba = -1.453152027, La = 1.061405429;
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
...
function Ma(n, e) {
  n = n.replace(/\s/g, "");
  const t = (n.length - n.replace(Lp, "").length) / Yr.length;
  if (t < 1)
    throw new Error("Equations without an arrow are not supported.");
  if (t > 1)
    throw new Error(`Equation must contain exactly one arrow ("${Yr}").`);
  const [r, s] = n.split(Yr);
  _(r.indexOf(Mo) === -1, () => `The ellipsis notation ("${Mo}") is not supported yet.`);
  const o = r.split(Lo), i = o.length;
  if (e !== i)
...
function Va(n, e, t) {
  ...
  for (let s = 0; s < t.length; ++s) {
    ...
    for (let i = 0; i < e[s].length; ++i)
      r[e[s][i]] === void 0 ? r[e[s][i]] = o[i] : _(r[e[s][i]] === o[i], () => `Expected dimension ${r[e[s][i]]} at axis ${i} of input shaped ${JSON.stringify(o)}, but got dimension ${o[i]}`);
  }
}
function Wa(n, e) {
  const t = n, r = [];
...
function za(n, e, t = 0) {
  let r = [];
  if (typeof e == "number")
    _(n.shape[t] % e === 0, () => "Number of splits must evenly divide the axis."), r = new Array(e).fill(n.shape[t] / e);
  else {
    const s = e.reduce((i, a) => (a === -1 && (i += 1), i), 0);
    _(s <= 1, () => "There should be only one negative value in split array.");
    const o = e.indexOf(-1);
    if (o !== -1) {
      const i = e.reduce((a, c) => c > 0 ? a + c : a);
      e[o] = n.shape[t] - i;
    }
    _(n.shape[t] === e.reduce((i, a) => i + a), () => "The sum of sizes must match the size of the axis dimension."), r = e;
  }
  return r;
}
/**
...
function Up(n, e) {
  let t = !1, r;
  for (n <= Xs ? (r = n, t = !0) : r = os(n, Math.floor(Math.sqrt(n))); !t; )
    r > e || r === n ? t = !0 : r = os(n, r + 1);
  return r;
}
function Vp(n, e, t) {
  const r = [], s = n.length;
...
const Gp = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ERF_A5: La,
  ERF_P: Da,
  PARALLELIZE_THRESHOLD: Xs,
  get RowPartitionType() {
    return Ye;
  },
  SELU_SCALE: Fa,
  SELU_SCALEALPHA: Aa,
  assertAndGetBroadcastShape: $e,
  assertAxesAreInnerMostDims: tt,
  assertParamsConsistent: va,
  axesAreInnerMostDims: Ws,
  calculateShapes: Pr,
  checkEinsumDimSizes: Va,
  combineLocations: xa,
  combineRaggedTensorToTensorShapes: Ia,
  computeConv2DInfo: et,
  computeConv3DInfo: Zn,
  computeDefaultPad: Vs,
  computeDilation2DInfo: ma,
  computeOptimalWindowSize: _r,
  computeOutAndReduceShapes: ht,
  computeOutShape: Ht,
  computePool2DInfo: In,
  computePool3DInfo: Qn,
  convertConv2DDataFormat: En,
  decodeEinsumEquation: Ma,
  eitherStridesOrDilationsAreOne: Sn,
  expandShapeToKeepDim: gt,
  fromStringArrayToUint8: nc,
  fromUint8ToStringArray: bn,
  getAxesPermutation: He,
  getBroadcastDims: vr,
  getEinsumComputePath: Wa,
  getEinsumPermutation: Ua,
  getImageCenter: Ta,
  getInnerMostAxes: Xe,
  getPermuted: js,
  getRaggedRank: Ea,
  getReshaped: qs,
  getReshapedPermuted: Ks,
  getRowPartitionTypesHelper: Sa,
  getSliceBeginCoords: Na,
  getSliceSize: ka,
  getSparseFillEmptyRowsIndicesDenseShapeMismatch: Ha,
  getSparseFillEmptyRowsNegativeIndexErrorMessage: Xa,
  getSparseFillEmptyRowsOutOfRangeIndexErrorMessage: qa,
  getSparseReshapeEmptyTensorZeroOutputDimErrorMessage: Ya,
  getSparseReshapeInputOutputMismatchErrorMessage: Za,
  getSparseReshapeInputOutputMultipleErrorMessage: Qa,
  getSparseReshapeMultipleNegativeOneOutputDimErrorMessage: ja,
  getSparseReshapeNegativeOutputDimErrorMessage: Ka,
  getSparseSegmentReductionIndicesOutOfRangeErrorMessage: tc,
  getSparseSegmentReductionNegativeSegmentIdsErrorMessage: Is,
  getSparseSegmentReductionNonIncreasingSegmentIdsErrorMessage: Ja,
  getSparseSegmentReductionSegmentIdOutOfRangeErrorMessage: ec,
  getUndoAxesPermutation: Gs,
  isIdentityPermutation: Ga,
  mergeRealAndImagArrays: vs,
  prepareAndValidate: ba,
  prepareSplitSize: za,
  tupleValuesAreOne: bs,
  upcastType: dt,
  validateDefaultValueShape: Ra,
  warn: Qe
...
function Xp(n, e) {
  ...
  }, !1), E().getBool("SOFTWARE_WEBGL_ENABLED") && (ir.failIfMajorPerformanceCaveat = !1), n === 1 ? t.getContext("webgl", ir) || t.getContext("experimental-webgl", ir) : t.getContext("webgl2", ir);
}
/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
...
function B(n, e) {
  const t = e();
  return E().getBool("DEBUG") && Kp(n), t;
}
function Kp(n) {
  const e = n.getError();
  if (e !== n.NO_ERROR)
    throw new Error("WebGL Error: " + Jp(n, e));
}
const Yp = 596e-10, Qp = 65504;
function Zp(n) {
  return !!(E().getBool("WEBGL_RENDER_FLOAT32_ENABLED") || n === 0 || Yp < Math.abs(n) && Math.abs(n) < Qp);
}
function Jp(n, e) {
  switch (e) {
    case n.NO_ERROR:
...
function tm(n, e) {
  ...
  if (n.getShaderParameter(t, n.COMPILE_STATUS) === !1)
    throw rc(e, n.getShaderInfoLog(t)), new Error("Failed to compile fragment shader.");
  return t;
}
const nm = /ERROR: [0-9]+:([0-9]+):/g;
function rc(n, e) {
  const t = nm.exec(e);
  if (t == null) {
...
function um(n, e, t) {
  mm(n, t), B(n, () => n.activeTexture(n.TEXTURE0 + t)), B(n, () => n.bindTexture(n.TEXTURE_2D, e));
}
function dm(n, e, t) {
...
function fm(n, e, t, r) {
  B(n, () => um(n, e, r)), B(n, () => n.uniform1i(t, r));
}
function Zr(n, e, t) {
...
function lr(n) {
  ...
  if (e !== n.FRAMEBUFFER_COMPLETE)
    throw new Error("Error binding framebuffer: " + pm(n, e));
}
function pm(n, e) {
  switch (e) {
...
function gm(n, e = !1) {
  ...
  r === 1 / 0 && E().getBool("WEBGL_AUTO_SQUARIFY_NARROW_TEXTURE_SHAPE") && (r = t / 2), e && (t = t * 2, r = r * 2, n = n.map((a, c) => c >= n.length - 2 ? Ns(n[c]) : n[c]), n.length === 1 && (n = [2, n[0]])), n.length !== 2 && (n = qt(n).newShape);
  let s = P(n), o = null;
  ...
  if (o == null || i)
    if (e) {
      const a = yn(n);
      let c = 2, l = 2;
      n.length && ([c, l] = $n(n)), s = a * (c / 2) * (l / 2), o = rs(s).map((u) => u * 2);
    } else
      o = rs(s);
  return o;
}
...
function Ir(n, e) {
  if (n = n.slice(-2), e = e.slice(-2), me(n, e) || !n.length || !e.length || n[0] === 0 || n[1] === 0 || e[0] === 0 || e[1] === 0)
    return !0;
  if (n.length !== e.length) {
    const t = n[n.length - 1], r = e[e.length - 1];
    if (t === r || dr(t) && dr(r) && (n[0] === 1 || e[0] === 1))
      return !0;
  }
  return n[1] === e[1] && dr(n[0]) && dr(e[0]);
}
let Jr, es;
function xm(n) {
  if (Jr == null) {
    const e = Ze(n);
    Jr = e.getParameter(e.MAX_TEXTURE_SIZE);
  }
  return Jr;
}
function wm(n) {
  if (es == null) {
    const e = Ze(n);
    es = e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS);
  }
  return Math.min(16, es);
}
function Cm(n) {
  if (n === 0)
    return 0;
...
function Ss(n) {
  const e = Ys(n), t = n.createTexture();
...
function $m(n, e) {
  const t = Ys(n, e), r = n.createTexture();
...
function er(n, e) {
  Array.isArray(n) || (n = [n]), n.forEach((t) => {
    t != null && _(t.dtype !== "complex64", () => `${e} does not support complex64 tensors in the WebGL backend.`);
  });
}
/**
 * @license
...
L.registerFlag("WEBGL_VERSION", () => Wo(2) ? 2 : Wo(1) ? 1 : 0);
...
L.registerFlag("WEBGL_MAX_TEXTURE_SIZE", () => xm(L.getNumber("WEBGL_VERSION")));
L.registerFlag("WEBGL_MAX_TEXTURES_IN_SHADER", () => wm(L.getNumber("WEBGL_VERSION")));
L.registerFlag("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION", () => {
  const n = L.getNumber("WEBGL_VERSION");
  return n === 0 ? 0 : Cm(n);
});
L.registerFlag("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE", () => L.getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION") > 0 && !ra());
L.registerFlag("WEBGL_RENDER_FLOAT32_CAPABLE", () => bm(L.getNumber("WEBGL_VERSION")));
L.registerFlag("WEBGL_RENDER_FLOAT32_ENABLED", () => L.getBool("WEBGL_FORCE_F16_TEXTURES") ? !1 : L.getBool("WEBGL_RENDER_FLOAT32_CAPABLE"));
L.registerFlag("WEBGL_DOWNLOAD_FLOAT_ENABLED", () => ym(L.getNumber("WEBGL_VERSION")));
L.registerFlag("WEBGL_FENCE_API_ENABLED", () => vm(L.getNumber("WEBGL_VERSION")));
...
L.registerFlag("WEBGL_FLUSH_THRESHOLD", () => ra() ? 1 : -1, (n) => {
  if (n < 0 && n !== -1)
...
function Sm(n, e, t = "index") {
  const r = n.map((o, i) => i), s = Im(r, e);
  return s.map((o, i) => {
 ...
 * =============================================================================
 */
const { getBroadcastDims: oc } = Gp;
function Em(n, e, t) {
  const r = [];
  if (n.forEach((p) => {
    const m = P(p.shapeInfo.logicalShape);
    if (p.shapeInfo.isUniform ? r.push(`uniform float ${p.name}${m > 1 ? `[${m}]` : ""};`) : (r.push(`uniform sampler2D ${p.name};`), r.push(`uniform int offset${p.name};`)), t.enableShapeUniforms) {
      const { uniformShape: C } = Js(t.packedInputs, p.shapeInfo.logicalShape, p.shapeInfo.texShape);
      switch (C.length) {
        case 1:
          r.push(`uniform int ${p.name}Shape;`);
          break;
        case 2:
          r.push(`uniform ivec2 ${p.name}Shape;`);
          break;
        case 3:
          r.push(`uniform ivec3 ${p.name}Shape;`);
          break;
        case 4:
          r.push(`uniform ivec4 ${p.name}Shape;`);
          break;
      }
      r.push(`uniform ivec2 ${p.name}TexShape;`);
    }
  ...
  t.customUniforms && t.customUniforms.forEach((p) => {
    r.push(`uniform ${p.type} ${p.name}${p.arrayIndex ? `[${p.arrayIndex}]` : ""};`);
  });
  const s = r.join(`
`), o = n.map((p) => Rm(p, e, t.packedInputs, t.enableShapeUniforms)).join(`
`), i = e.texShape, a = Se(), c = km(a);
  let l, u, d = Dm(a);
  return e.isPacked ? (l = Tm(e.logicalShape, i, t.enableShapeUniforms), u = Fm(a)) : (l = Nm(e.logicalShape, i, t.enableShapeUniforms), u = Am(a)), t.packedInputs && (d += Bm), [
    d,
    c,
    u,
    s,
...
function Rm(n, e, t = !1, r) {
  let s = "";
  t ? s += ic(n, r) : s += Tn(n, r);
  const o = n.shapeInfo.logicalShape, i = e.logicalShape;
  return o.length <= i.length && (t ? s += ig(n, e) : s += ag(n, e)), s;
}
function Tm(n, e, t) {
  switch (n.length) {
    case 0:
...
function Jm(n, e) {
  ...
  const { newShape: i, keptDims: a } = qt(t), c = i;
  if (c.length < t.length) {
    const h = kn(n, c), p = ["row", "col"];
    return `
      ${Tn(h, e)}
      float ${s}(int row, int col) {
        return ${s}(${An(p, a)});
...
function eg(n, e) {
  ...
  if (t[0] === 1) {
    const h = t.slice(1), p = [1, 2], m = kn(n, h), C = ["b", "row", "col"];
    return `
        ${ic(m, e)}
...
function tg(n, e) {
  const t = n.shapeInfo.logicalShape, r = n.name, s = "get" + r.charAt(0).toUpperCase() + r.slice(1), o = t[1] * t[2], i = t[2], { newShape: a, keptDims: c } = qt(t), l = a;
...
function ng(n, e) {
  ...
  let h = d * Math.ceil(o[i - 2] / 2), p = "int b, int row, int col", m = `b * ${h} + (row / 2) * ${d} + (col / 2)`;
  for (let C = 2; C < i - 1; C++)
    p = `int b${C}, ` + p, h *= o[i - C - 1], m = `b${C} * ${h} + ` + m;
  return `
    vec4 ${r}(${p}) {
      int index = ${m};
      int texR = index / ${u};
...
function rg(n, e) {
  const t = n.shapeInfo.logicalShape, r = n.name, s = "get" + r.charAt(0).toUpperCase() + r.slice(1), o = t[3], i = t[2] * o, a = t[1] * i, { newShape: c, keptDims: l } = qt(t);
  if (c.length < t.length) {
  ...
  if (n.shapeInfo.isUniform)
    ...
    `;
  const u = n.shapeInfo.flatOffset, d = n.shapeInfo.texShape, h = d[0], p = d[1], m = `int stride2 = ${r}Shape[3];`, C = `int stride1 = ${r}Shape[2] * stride2;`, w = `int stride0 = ${r}Shape[1] * stride1;`;
  if (p === a && u == null)
    return e ? `
      float ${s}(int row, int col, int depth, int depth2) {
        ${m}
...
function sg(n) {
  const e = n.shapeInfo.logicalShape, t = n.name, r = "get" + t.charAt(0).toUpperCase() + t.slice(1), s = e[4], o = e[3] * s, i = e[2] * o, a = e[1] * i, { newShape: c, keptDims: l } = qt(e);
...
function og(n) {
  const e = n.shapeInfo.logicalShape, t = n.name, r = "get" + t.charAt(0).toUpperCase() + t.slice(1), { newShape: s, keptDims: o } = qt(e);
  ...
  if (n.shapeInfo.isUniform)
    ...
    `;
  const d = n.shapeInfo.flatOffset, h = n.shapeInfo.texShape, p = h[0], m = h[1];
  if (m === u && d == null)
    return `
      float ${r}(int row, int col, int depth,
                    int depth2, int depth3, int depth4) {
...
function Nn(n) {
  const e = n.name, t = P(n.shapeInfo.logicalShape);
  return t < 2 ? `return ${e};` : `
    for (int i = 0; i < ${t}; i++) {
      if (i == index) {
        return ${e}[i];
...
function ig(n, e) {
  const t = n.name, r = t.charAt(0).toUpperCase() + t.slice(1), s = "get" + r + "AtOutCoords", o = n.shapeInfo.logicalShape.length, i = e.logicalShape.length, a = oc(n.shapeInfo.logicalShape, e.logicalShape), c = j(i), l = i - o;
  let u;
  const d = ["x", "y", "z", "w", "u", "v"];
...
`);
  ...
  const C = P(n.shapeInfo.logicalShape) === 1, x = P(e.logicalShape) === 1;
  if (o === 1 && !C && !x)
    p = `
    ...
    const y = o - 2, v = o - 1;
    a.indexOf(y) > -1 && a.indexOf(v) > -1 ? p = "return vec4(outputValue.x);" : a.indexOf(y) > -1 ? p = "return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);" : a.indexOf(v) > -1 && (p = "return vec4(outputValue.xx, outputValue.zz);");
  }
  return `
    vec4 ${s}() {
...
function ag(n, e) {
  ...
  if (!n.shapeInfo.isUniform && a === c && n.shapeInfo.flatOffset == null && me(i, o))
    return `
      float ${s}() {
        return sampleTexture(${t}, resultUV);
      }
    `;
  const l = j(c), u = oc(n.shapeInfo.logicalShape, e.logicalShape), d = c - a;
  let h;
  const p = ["x", "y", "z", "w", "u", "v"];
  a === 0 ? h = "" : c < 2 && u.length >= 1 ? h = "coords = 0;" : h = u.map((C) => `coords.${p[C + d]} = 0;`).join(`
`);
  let m = "";
  return c < 2 && a > 0 ? m = "coords" : m = n.shapeInfo.logicalShape.map((C, w) => `coords.${p[w + d]}`).join(", "), `
    float ${s}() {
...
function Js(n, e, t) {
  const { newShape: r, keptDims: s } = qt(e), o = e.length, i = n && o === 3 && e[0] === 1, a = i ? e.slice(1) : r, c = !n && o > 1 && !me(e, t) && r.length < o || i;
...
function cg(n, e, t, r) {
  const s = t.map((u, d) => {
    ...
    flatOffset: null
  }, a = Em(s, i, e), c = tm(n.gl, a), l = n.createProgram(c);
...
function lg(n, e, t, r, s) {
  e.program.enableShapeUniforms || (Go(e.inShapeInfos, t), Go([e.outShapeInfo], [r]));
  ...
  for (let c = 0; c < t.length; ++c) {
    const l = t[c], { uniform: u, offset: d, shape: h, texShape: p } = e.variablesLocations[c];
    if (h) {
      const { uniformShape: m } = Js(e.program.packedInputs, l.shape, l.texData.texShape);
      switch (m.length) {
        case 1:
    ...
    if (p && n.gl.uniform2i(p, l.texData.texShape[0], l.texData.texShape[1]), u != null) {
      if (l.isUniform) {
        if (P(l.shape) < 2)
...
function ug(n, e, t) {
  ...
  e.concat(t).forEach((i) => {
    ...
    if (n.enableShapeUniforms && !i.isUniform) {
      const c = i.texData.texShape, { useSqueezeShape: l, uniformShape: u, keptDims: d } = Js(n.packedInputs, i.shape, c);
      let h = "", p = "", m = "";
      ...
      const C = i.shape.length, w = u.length === 2 && me(i.shape, c), x = P(i.shape) === 1, y = vr(i.shape, t.shape), v = !n.packedInputs && C === t.shape.length && me(c, t.texData.texShape), I = n.packedInputs || u.length > 2 ? "" : `${c[0] > 1}_${c[1] > 1}`;
      r += `${C}_${v}_${l ? d : ""}_${u.length}_${x}_${y}_${w}_${h}_${p}_${m}_${I}_${a}`;
    } else {
...
class dg {
  constructor(e) {
    ...
    const t = Se();
    this.outputShape = e, this.enableShapeUniforms = we(this.outputShape.length), this.userCode = `
      ivec3 outCoordsFromFlatIndex(int index) {
        ${this.enableShapeUniforms ? Br(["r", "c", "d"], e) : Zt(["r", "c", "d"], e)}
        return ivec3(r, c, d);
      }
...
class fg {
  constructor(e) {
    this.variableNames = ["A"], this.outTexUsage = Oe.DOWNLOAD;
    const t = Se();
...
class pg {
  constructor(e) {
    this.variableNames = ["A"], this.packedInputs = !0, this.packedOutput = !1, this.outTexUsage = Oe.DOWNLOAD;
    const t = Se();
    this.outputShape = e, this.userCode = `
      ${sc}
...
class zo {
  constructor(e, t = !1, r = "RGBA") {
    ...
    const s = Se();
    this.outputShape = e, this.enableShapeUniforms = we(this.outputShape.length);
    let o = "result";
    ...
    this.userCode = `
      ${this.enableShapeUniforms ? Zs() : Qs(e)}
...
function bg(n, e, t, r) {
  const [s, o] = Jn(e, t);
  return tr(n, s, o, lc(r), r.textureFormatFloat, n.FLOAT);
}
function uc(n) {
...
function yg(n, e, t, r) {
  const [s, o] = Jn(e, t);
  return tr(n, s, o, uc(r), r.textureFormatFloat, r.textureTypeHalfFloat);
}
function dc(n) {
...
function $g(n, e, t, r) {
  const [s, o] = Jn(e, t);
  return tr(n, s, o, dc(r), n.RGBA, n.UNSIGNED_BYTE);
}
function hc(n) {
...
function vg(n, e, t, r) {
  const [s, o] = Rn(e, t);
  return tr(n, s, o, hc(r), n.RGBA, n.FLOAT);
}
function fc(n) {
...
function Ig(n, e, t, r) {
  const [s, o] = Rn(e, t);
  return tr(n, s, o, fc(r), n.RGBA, r.textureTypeHalfFloat);
}
function Sg(n, e, t) {
  return B(n, () => n.bindBuffer(n.ARRAY_BUFFER, t)), Uo(n, e, "clipSpacePos", t, 3, 20, 0) && Uo(n, e, "uv", t, 2, 20, 12);
}
...
function kg(n, e, t, r) {
  const [s, o] = Jn(e, t), i = 4, a = new Uint8Array(qp(e * t, i));
  return B(n, () => n.readPixels(0, 0, s, o, r.downloadTextureFormat, n.UNSIGNED_BYTE, a)), new Float32Array(a.buffer);
}
function Ag(n, e, t, r, s, o, i, a) {
  const c = n, l = new Float32Array(jp(o, i));
...
class ts {
  constructor(e) {
    ...
    if (e != null ? (this.gl = e, zp(t, e)) : this.gl = Ze(t), e = this.gl, E().getNumber("WEBGL_VERSION") === 2) {
      const o = e;
    ...
    if (this.parallelCompilationExtension = this.gl.getExtension("KHR_parallel_shader_compile"), E().getNumber("WEBGL_VERSION") === 1) {
      ...
      if (this.textureFloatExtension = cr(this.gl, o), Ge(this.gl, i))
        this.textureHalfFloatExtension = cr(this.gl, i);
      ...
      if (this.colorBufferFloatExtension = this.gl.getExtension(r), Ge(this.gl, s))
        this.colorBufferHalfFloatExtension = cr(this.gl, s);
      else if (E().get("WEBGL_FORCE_F16_TEXTURES"))
    ...
    this.vertexBuffer = wg(this.gl), this.indexBuffer = Cg(this.gl), this.framebuffer = lm(this.gl), this.textureConfig = Ys(this.gl, this.textureHalfFloatExtension);
  }
  get debug() {
  ...
  createFloat32MatrixTexture(e, t) {
    return this.throwIfDisposed(), bg(this.gl, e, t, this.textureConfig);
  }
  createFloat16MatrixTexture(e, t) {
    return this.throwIfDisposed(), yg(this.gl, e, t, this.textureConfig);
  }
  createUnsignedBytesMatrixTexture(e, t) {
    return this.throwIfDisposed(), $g(this.gl, e, t, this.textureConfig);
  }
  uploadPixelDataToTexture(e, t) {
    this.throwIfDisposed(), Rg(this.gl, e, t);
  }
  uploadDenseMatrixToTexture(e, t, r, s) {
    this.throwIfDisposed(), Eg(this.gl, e, t, r, s, this.textureConfig);
  }
  createFloat16PackedMatrixTexture(e, t) {
    return this.throwIfDisposed(), Ig(this.gl, e, t, this.textureConfig);
  }
  createPackedMatrixTexture(e, t) {
    return this.throwIfDisposed(), vg(this.gl, e, t, this.textureConfig);
  }
  deleteMatrixTexture(e) {
    this.throwIfDisposed(), this.outputTexture === e && (Vo(this.gl, this.framebuffer), this.outputTexture = null), B(this.gl, () => this.gl.deleteTexture(e));
  }
  downloadByteEncodedFloatMatrixFromOutputTexture(e, t, r) {
    return this.downloadMatrixDriver(e, () => kg(this.gl, t, r, this.textureConfig));
  }
  downloadPackedMatrixFromBuffer(e, t, r, s, o, i) {
    return Ag(this.gl, e, t, r, s, o, i, this.textureConfig);
  }
  downloadFloat32MatrixFromBuffer(e, t) {
    return Ng(this.gl, e, t);
  }
  createBufferFromTexture(e, t, r) {
    this.bindTextureToFrameBuffer(e);
    const s = Tg(this.gl, t, r, this.textureConfig);
  ...
  downloadMatrixFromPackedTexture(e, t, r) {
    return this.downloadMatrixDriver(e, () => Fg(this.gl, t, r));
  }
  createProgram(e) {
    this.throwIfDisposed();
    const t = this.gl;
    this.vertexShader == null && (this.vertexShader = xg(t));
    const r = rm(t);
    B(t, () => t.attachShader(r, this.vertexShader)), B(t, () => t.attachShader(r, e)), sm(t, r);
    const s = Object.assign(r, { vao: this.createVertexArray() });
    return this.debug && Qr(t, s), s;
  }
  buildVao(e) {
    this.setProgram(e), this.bindVertexArray(e.vao);
    const t = this.gl;
    B(t, () => t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, this.indexBuffer)), Sg(t, e, this.vertexBuffer);
  }
  deleteProgram(e) {
  ...
  setProgram(e) {
    this.throwIfDisposed(), this.program = e, this.program != null && this.debug && Qr(this.gl, this.program), B(this.gl, () => this.gl.useProgram(e));
  }
  getUniformLocation(e, t, r = !0) {
    return this.throwIfDisposed(), r ? dm(this.gl, e, t) : hm(this.gl, e, t);
  }
  ...
  setInputMatrixTexture(e, t, r) {
    this.throwIfDisposed(), this.throwIfNoProgram(), fm(this.gl, e, t, r);
  }
  ...
  debugValidate() {
    this.program != null && Qr(this.gl, this.program), lr(this.gl);
  }
  executeProgram() {
  ...
  getQueryTimerExtension() {
    return this.disjointQueryTimerExtension == null && (this.disjointQueryTimerExtension = cr(this.gl, E().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION") === 2 ? "EXT_disjoint_timer_query_webgl2" : "EXT_disjoint_timer_query")), this.disjointQueryTimerExtension;
  }
  ...
  async waitForQueryAndGetTime(e) {
    return await fo(() => this.disposed || // while testing contexts are created / disposed
  ...
  pollItems() {
    const e = Dg(this.itemsToPoll.map((t) => t.isDoneFn));
    for (let t = 0; t <= e; ++t) {
  ...
  addItemToPoll(e, t) {
    if (this.itemsToPoll.push({ isDoneFn: e, resolveFn: t }), this.itemsToPoll.length > 1)
      return;
    let r;
    "setTimeoutCustom" in E().platform && (r = E().platform.setTimeoutCustom.bind(E().platform)), fo(() => (this.pollItems(), this.itemsToPoll.length === 0), () => 0, null, r);
  }
  bindTextureToFrameBuffer(e) {
    this.throwIfDisposed(), Zr(this.gl, e, this.framebuffer), this.debug && lr(this.gl);
  }
  unbindTextureToFrameBuffer() {
    this.outputTexture != null ? (Zr(this.gl, this.outputTexture, this.framebuffer), this.debug && lr(this.gl)) : Vo(this.gl, this.framebuffer);
  }
  ...
  setOutputMatrixTextureDriver(e, t, r) {
    this.throwIfDisposed();
    const s = this.gl;
    Zr(s, e, this.framebuffer), this.debug && lr(s), this.outputTexture = e, B(s, () => s.viewport(0, 0, t, r)), B(s, () => s.scissor(0, 0, t, r));
  }
...
function _e(n) {
  return (e, t, r, s, o) => {
    const i = $e(e, t), a = i.length, c = pe(i), l = P(i), u = Ut(o, l), d = e.length, h = t.length, p = pe(e), m = pe(t), C = vr(e, i), w = vr(t, i);
    if (C.length + w.length === 0)
      for (let x = 0; x < u.length; ++x)
        u[x] = n(r[x % r.length], s[x % s.length]);
    else
      for (let x = 0; x < u.length; ++x) {
        const y = ks(x, a, c), v = y.slice(-d);
        C.forEach((F) => v[F] = 0);
        const I = is(v, d, p), T = y.slice(-h);
        w.forEach((F) => T[F] = 0);
        const A = is(T, h, m);
        u[x] = n(r[I], s[A]);
      }
...
function Pg(n, e, t, r) {
  ...
  if (r === "bool") {
    const s = Ar([0], t), [o, i] = _e((a, c) => a !== c ? 1 : 0)(e, [], n, s, "bool");
    return [i, "bool", o];
  }
 ...
 * =============================================================================
 */
function Bg(n, e, t, r, s) {
  const o = P(r), i = Rt(s, t);
...
function Lg(n, e, t, r = !1) {
  const s = n.shape[0], o = n.shape[1], i = ge([s, t], e.dtype);
  for (let a = 0; a < s; a++)
    for (let c = 0; c < o; c++) {
      const l = n.get(a, c);
      if (l < 0)
...
function Xg(n, e, t, r, s, o, i, a, c) {
  ...
  for (let u = 0; u < r; u++) {
    ...
    for (let p = 0; p < o; p++)
      l.values[u * o + p] = e.get(...e.indexToLoc(h * o + p));
  }
  return l;
}
/**
 ...
 * =============================================================================
 */
function ox(n, e, t, r, s) {
  const o = e.length, i = P(e), a = pe(e), c = pe(s), l = Ut(t, P(s));
  for (let u = 0; u < i; ++u) {
    const d = ks(u, o, a), h = new Array(d.length);
 ...
 */
function ix(n, e, t, r) {
  const [s, o] = ht(n, r), i = dt(e, "int32"), a = Rt(P(s), i), c = P(o);
...
function ax(n, e, t) {
  n.forEach((r, s) => {
    if (r < 0 || r >= t) {
      const o = ks(s, e.length, pe(e)).join(",");
...
function lx(n, e, t, r) {
  ...
  for (let l = 0; l < n.length; ++l) {
    ...
    for (let h = 0; h < t.length; ++h) {
      const p = t[h], m = h + e.length - 1;
      if (m >= 0) {
        const C = a[m], w = C[C.length - 1] - p[u];
        for (let x = u; x < d; ++x)
          a[m].push(p[x + 1] + w);
      }
      u = p[u], d = p[d];
...
function ux(n) {
  const e = [];
  for (let t = 0; t < n.length; ++t) {
    const r = n[t].length, s = ue("int32", r);
...
function dx(n, e, t, r, s, o) {
  const i = Ho(e, 2)[1], a = Ho(o, 2)[1];
  let c = 0;
  for (const l of t)
...
function hx(n, e, t, r, s) {
  const o = e.slice();
  o[0] = s;
  const i = ue(t, P(o)), a = n.length, c = a === 0 ? 0 : a / e[0];
  return dx(n, e, r, c, i, o), [i, o];
}
function fx(n, e, t, r, s, o, i, a) {
  if (n.length === 0)
    throw new Error("paramsNestedSplits must be non empty");
  if (e[0].length === 0)
    throw new Error("Split tensors must not be scalars");
  const c = e[0][0] - 1;
  if (ax(o, i, c), r.length === 0)
    throw new Error("params.rank must be nonzero");
  const l = r[0], { outSplits: u, valueSlices: d, numValues: h } = lx(o, i, n, l), p = ux(u), m = hx(t, r, s, d, h);
  return [p, m[0], m[1]];
}
/**
 * @license
...
function px(n, e, t, r, s, o, i) {
  ...
  const d = u.length === 0 ? 1 : u[0], h = ue("int32", d + 1);
  h[0] = 0;
  for (let w = 0; w < d; ++w) {
    ...
    if (v > 0 && y < x || v < 0 && y > x)
      I = 0;
    else if (I = Math.ceil(Math.abs((y - x) / v)), I > Xo)
      throw new Error(`Requires ((limit - start) / delta) <= ${Xo}`);
    h[w + 1] = h[w] + I;
  }
  const p = h[d], m = ue(t, p);
  let C = 0;
  for (let w = 0; w < d; ++w) {
    const x = h[w + 1] - h[w];
    let y = a ? n[0] : n[w];
...
class Sr {
  constructor(e, t, r, s, o, i, a, c, l, u) {
    this.shape = e, this.shapeShape = t, this.values = r, this.valuesShape = s, this.valuesDType = o, this.defaultValue = i, this.defaultValueShape = a, this.rowPartitionValues = c, this.rowPartitionValuesShapes = l, this.rowPartitionTypes = Sa(u), this.raggedRank = Ea(this.rowPartitionTypes);
  }
  ...
  getMaxWidth(e) {
    ...
    switch (this.getRowPartitionTypeByDimension(e - 1)) {
      case Be.VALUE_ROWIDS:
        return Sr.getMaxWidthValueRowID(t);
      case Be.ROW_SPLITS:
        return Sr.getMaxWidthRowSplit(t);
      default:
  ...
  calculateOutputSize(e) {
    ...
    Ra(r, t);
    const s = this.tensorShapeFromTensor(this.shape, this.shapeShape), i = Ia(this.raggedRank, s, t);
    i[0] < 0 && (i[0] = e);
  ...
  calculateFirstParentOutputIndex(e, t, r) {
    ...
    for (let a = s; a < e; ++a)
      o.push(-1);
    return _(o.length === e, () => "Final length of result must be equal to firstDimension."), o;
  }
  ...
  compute() {
    ...
    for (let c = s.length - 2; c >= 0; --c)
      s[c] = s[c + 1] * r[c + 1];
    const o = jo(r, !1), i = ue(this.valuesDType, P(o));
    if (s[0] * r[0] > 0) {
  ...
  setOutput(e, t, r, s) {
    ...
    for (let m = 0; m <= l; ++m) {
      ...
      if (h < p) {
        const w = o.subarray(d * c), x = i.subarray(h * c), y = (p - h) * c;
        qo(x, w, y);
      }
      if (m >= l) {
        const w = r.length;
      ...
      if (C > p)
        if (this.defaultValue.length === 1)
          i.subarray(p * c, C * c).fill(this.defaultValue[0]), p = C;
        else
          for (; C > p; ) {
            const w = i.slice(p * c);
            qo(w, u, c), ++p;
          }
      C < 0 ? (d = m + 1, h = p) : (d = m, h = p, p = h + 1);
    }
  }
}
function qo(n, e, t) {
...
function mx(n, e, t, r, s, o, i, a, c, l) {
  return new Sr(n, e, t, r, s, o, i, a, c, l).compute();
}
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 ...
 * =============================================================================
 */
function wx(n, e, t, r, s, o, i, a, c, l) {
  const u = [r / s, s], d = n.values, h = e.values;
  if (r === 0)
    return ge(t, e.dtype);
  const p = c instanceof br ? c : ge(u, e.dtype);
  ...
  for (let m = 0; m < o; m++) {
    ...
    for (let x = 0; x < s; x++)
      p.values[w * s + x] = e.rank === 0 ? h[0] : h[m * s + x];
  }
  return p;
}
/**
 ...
 * =============================================================================
 */
function bx(n, e, t, r, s) {
  const o = ya(r, e, t), i = P(t), a = pe(r);
  if (o) {
    const d = $a(e, a);
    return s === "string" ? n.slice(d, d + i) : n.subarray(d, d + i);
  }
  const c = s === "string" ? bn(n) : n, l = ge(r, s, c), u = ge(t, s);
  for (let d = 0; d < u.size; ++d) {
    const h = u.indexToLoc(d), p = h.map((m, C) => m + e[C]);
    u.set(l.get(...p), ...h);
  }
  return s === "string" ? nc(u.values) : u.values;
}
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
...
function yx(n, e, t, r, s, o, i) {
  ...
  for (let w = 0; w < a; ++w) {
    const x = n[w * d];
    if (x < 0)
      throw new Error(Xa(w, x));
    if (x >= c)
      throw new Error(qa(w, x, c));
    ++m[x], h = h && x >= p, p = x;
  }
  let C = !0;
  for (let w = 0; w < c; ++w) {
  ...
  if (C && h) {
    ...
    const w = m[c - 1], x = ue(t, w * d), y = ue(s, w), v = new Array(c).fill(0);
    for (let I = 0; I < a; ++I) {
...
function $x(n, e, t, r, s) {
  const o = P(r), i = e[0], a = s.length, c = [];
  let l = 1, u = -1;
  for (let w = 0; w < a; ++w) {
    const x = s[w];
    if (x === -1) {
      if (u !== -1)
        throw new Error(ja(u, w));
      u = w, c.push(1);
    } else {
      if (x < 0)
        throw new Error(Ka(w, x));
      l *= x, c.push(x);
    }
  }
  if (u !== -1) {
    ...
    if (l * w !== o)
      throw new Error(Qa(r, c));
    c[u] = w;
  }
  if (P(c) !== o)
    throw new Error(Za(r, c));
  const h = r.length, p = [];
  if (h > 0) {
    p[h - 1] = 1;
    for (let w = h - 2; w >= 0; --w)
 ...
 * =============================================================================
 */
function vx(n, e, t, r, s, o = !1, i = 0) {
  const a = r.length, c = [e[0], n.length / e[0]], l = c[1], d = a > 0 ? s[a - 1] + 1 : 0;
  if (d < 0)
    throw new Error(Is());
  const h = e.slice();
  h[0] = d;
  const p = h.reduce((v, I) => v * I, 1), m = ue(t, p);
  if (a === 0)
  ...
  for (; ; ) {
    ...
    if (y < 0 || y >= d)
      throw new Error(ec(y, d));
    y > x && m.fill(i, x * l, y * l);
    for (let I = C; I < w; ++I) {
      const T = r[I];
      if (T < 0 || T >= c[0])
        throw new Error(tc(I, r[I], c[0]));
      for (let A = 0; A < l; A++)
        m[y * l + A] += n[T * l + A];
    }
    if (o)
...
class Rx {
  ...
  createNGrams(e, t, r, s, o, i) {
    for (let a = 0; a < o; ++a) {
      ...
      const m = l + u + d - 1;
      p += m * this.separator.length, r[s + a] = new Uint8Array(p);
      const C = r[s + a];
      let w = 0;
  ...
  compute(e, t) {
    ...
    for (let c = 0; c < o; ++c) {
      ...
      if (this.nGramWidths.forEach((d) => {
        const h = t[c + 1] - t[c], p = this.getNumNGrams(h, d);
        this.createNGrams(e, l, a, u, p, d), u += p;
...
function Tx(n, e, t, r, s, o, i, a) {
  return new Rx(t, r, s, o, i, a).compute(n, e);
}
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
...
function kx(n, e, t) {
  ...
  const c = ue("int32", o * 2), l = new Array(o), u = [r, i];
  let d = 0;
  for (let h = 0; h < r; ++h)
    for (let p = 0; p < a[h]; ++p)
      c[d * 2] = h, c[d * 2 + 1] = p, l[d] = s[d], ++d;
  return [c, l, u];
}
/**
 * @license
 ...
 */
function Ax(n, e) {
  const t = ue("int32", n.length);
  for (let r = 0; r < n.length; ++r)
    t[r] = Eh(n[r]).modulo(e).getLowBitsUnsigned();
  return t;
}
/**
 * @license
...
function mc(n, e, t = 0, r = n.length - 1) {
  for (; r > t; ) {
    if (r - t > 600) {
      const a = r - t + 1, c = e - t + 1, l = Math.log(a), u = 0.5 * Math.exp(2 * l / 3), d = 0.5 * Math.sqrt(l * u * (a - u) / a) * Math.sign(c - a / 2), h = Math.max(t, Math.floor(e - c * u / a + d)), p = Math.min(r, Math.floor(e + (a - c) * u / a + d));
      mc(n, e, h, p);
    }
    const s = n[e];
    let o = t, i = r;
...
function Ox(n, e, t, r, s) {
  ...
  for (let d = 0; d < i; d++) {
    ...
    p.forEach((y, v) => m[v] = { value: y, index: v }), r < m.length && (mc(m, r), m = m.slice(0, r)), s && m.sort(Wn);
...
function Px(n, e, t, r) {
  ...
  for (let m = s + 1; m < t.length; m++)
    o[2] *= t[m];
  const i = /* @__PURE__ */ new Map(), a = new Int32Array(t[s]), c = new br(o, r, n), l = [], u = o[0] === 1 && o[2] === 1;
  for (let m = 0; m < t[s]; m++) {
    let C;
    if (u)
      C = n[m].toString();
...
const _x = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  simpleAbsImpl: Og,
  sliceImpl: bx,
  sparseFillEmptyRowsImpl: yx,
  sparseReshapeImpl: $x,
  sparseSegmentReductionImpl: vx,
  sqrtImpl: Ix,
  staticRegexReplaceImpl: Sx,
  stridedSliceImpl: Ex,
  stringNGramsImpl: Tx,
  stringSplitImpl: kx,
  stringToHashBucketFastImpl: Ax,
  subImpl: Fx,
  tileImpl: Dx,
  topKImpl: Ox,
  transposeImpl: ox,
 ...
 * =============================================================================
 */
const { addImpl: Bx, bincountImpl: gc, bincountReduceImpl: Lx, bitwiseAndImpl: Mx, castImpl: Ux, ceilImpl: Vx, concatImpl: Wx, equalImpl: Gx, expImpl: zx, expm1Impl: Hx, floorImpl: Xx, gatherNdImpl: qx, gatherV2Impl: jx, greaterImpl: Kx, greaterEqualImpl: Yx, lessImpl: Qx, lessEqualImpl: Zx, linSpaceImpl: Jx, logImpl: e0, maxImpl: t0, maximumImpl: n0, minimumImpl: r0, multiplyImpl: s0, negImpl: o0, notEqualImpl: i0, prodImpl: a0, raggedGatherImpl: c0, raggedRangeImpl: l0, raggedTensorToTensorImpl: u0, rangeImpl: d0, rsqrtImpl: h0, scatterImpl: f0, sigmoidImpl: p0, simpleAbsImpl: xc, sliceImpl: m0, sparseFillEmptyRowsImpl: g0, sparseReshapeImpl: x0, sparseSegmentReductionImpl: wc, sqrtImpl: w0, staticRegexReplaceImpl: C0, stridedSliceImpl: b0, stringNGramsImpl: y0, stringSplitImpl: $0, stringToHashBucketFastImpl: v0, subImpl: I0, tileImpl: S0, topKImpl: E0, transposeImpl: eo, uniqueImpl: R0 } = _x;
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
...
class N0 {
  constructor(e) {
    if (this.variableNames = ["A"], this.packedInputs = !1, this.packedOutput = !0, this.outputShape = e, this.rank = e.length, this.enableShapeUniforms = we(this.outputShape.length), this.rank === 0)
      this.userCode = `
        void main() {
      ...
      const t = ye("rc", this.rank), r = j(this.rank), s = this.getOutOfBoundsCondition(t), o = this.getSetup(t), i = this.getOutput(t);
      this.userCode = `
        void main() {
...
class bc {
  constructor(e, t) {
    this.variableNames = ["A"], this.packedInputs = !0, this.packedOutput = !0, this.customUniforms = [{ name: "inputShape", type: "ivec3" }], this.outputShape = e, this.enableShapeUniforms = we(this.outputShape.length);
    let r = "";
    for (let s = 0; s < 4; s++) {
      let o = "thisRC = rc;";
...
function k0(n, e) {
  return `
    ivec3 inputCoordsFromReshapedOutCoords(int index) {
      ${e ? Sm(["r", "c", "d"], "inputShape") : Zt(["r", "c", "d"], n)}
      return ivec3(r, c, d);
    }
  `;
}
...
class A0 {
  ...
  acquireTexture(e, t, r) {
    ...
    let a;
    return s === fe.PACKED_2X2_FLOAT32 ? a = this.gpgpu.createPackedMatrixTexture(e[0], e[1]) : s === fe.PACKED_2X2_FLOAT16 ? a = this.gpgpu.createFloat16PackedMatrixTexture(e[0], e[1]) : s === fe.UNPACKED_FLOAT32 ? a = this.gpgpu.createFloat32MatrixTexture(e[0], e[1]) : s === fe.UNPACKED_FLOAT16 ? a = this.gpgpu.createFloat16MatrixTexture(e[0], e[1]) : s === fe.PACKED_4X1_UNSIGNED_BYTE && (a = this.gpgpu.createUnsignedBytesMatrixTexture(e[0], e[1])), this.usedTextures[o].push(a), this.numUsedTextures++, this._numBytesAllocated += i, this.log(), a;
  }
  releaseTexture(e, t, r, s) {
    if (this.freeTextures == null)
      return;
    const o = Yo(r, s), i = Qo(t, o, s);
    i in this.freeTextures || (this.freeTextures[i] = []);
    const a = Ko(t, o, this.gpgpu.gl, this.gpgpu.textureConfig, s), c = E().get("WEBGL_DELETE_TEXTURE_THRESHOLD");
...
function D0(n, e) {
  switch (n) {
    case fe.PACKED_2X2_FLOAT32:
      return hc(e);
    case fe.PACKED_2X2_FLOAT16:
      return fc(e);
    case fe.UNPACKED_FLOAT32:
      return lc(e);
    case fe.UNPACKED_FLOAT16:
      return uc(e);
    case fe.PACKED_4X1_UNSIGNED_BYTE:
      return dc(e);
    default:
...
function O0(n) {
  return E().getBool("WEBGL_RENDER_FLOAT32_ENABLED") ? n ? fe.PACKED_2X2_FLOAT32 : fe.UNPACKED_FLOAT32 : n ? fe.PACKED_2X2_FLOAT16 : fe.UNPACKED_FLOAT16;
}
function Yo(n, e) {
  if (n === Oe.UPLOAD)
    return fe.PACKED_2X2_FLOAT32;
  if (n === Oe.RENDER || n == null)
    return O0(e);
  if (n === Oe.DOWNLOAD || n === Oe.PIXELS)
    return fe.PACKED_4X1_UNSIGNED_BYTE;
...
class ct {
  constructor(e, t) {
    this.variableNames = ["A"], this.outputShape = e, this.enableShapeUniforms = we(this.outputShape.length), this.userCode = `
...
const qe = "if (isnan(x)) return x;", P0 = "return x;", Zo = "return abs(x);", _0 = "return (x >= 0.0) ? x : (exp(x) - 1.0);", B0 = qe + `
  return (x < 0.0) ? 0.0 : x;
`, L0 = qe + `
  return (x < 0.0) ? 0.0 : min(6.0, x);
`, vt = "return x;", M0 = "return 1.0 / (1.0 + exp(-1.0 * x));";
/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`, G0 = `
  ...
  return result;
`, z0 = "return 1.0 / (1.0 + exp(-1.0 * x));";
class St {
  constructor(e, t) {
    this.variableNames = ["A"], this.packedInputs = !0, this.packedOutput = !0, this.outputShape = e, this.enableShapeUniforms = we(this.outputShape.length), this.userCode = `
...
class H0 {
  constructor(e) {
    this.variableNames = ["A"], this.packedInputs = !0, this.packedOutput = !1, this.outputShape = e, this.enableShapeUniforms = we(this.outputShape.length);
    const t = e.length, r = ye("rc", t), s = j(t), o = T0(t, r), i = r.slice(-2), a = t <= 1 ? "rc" : `vec2(${i.join(",")})`;
    this.userCode = `
      void main() {
 ...
 * =============================================================================
 */
const X0 = Zf, q0 = 1e-7, j0 = 1e-4, hr = {};
function K0(n) {
  return n in hr || (hr[n] = {}), hr[n];
}
const Y0 = E().getNumber("CPU_HANDOFF_SIZE_THRESHOLD"), Q0 = 600;
function Z0() {
  return E().global.screen == null ? 1024 : E().global.screen.height * E().global.screen.width * window.devicePixelRatio * Q0 / 1024 / 1024;
}
class Lr extends xi {
  nextDataId() {
    return Lr.nextDataId++;
  }
  constructor(e) {
    ...
    if (e != null) {
      ...
      t = new ts(r), this.binaryCache = K0(E().getNumber("WEBGL_VERSION")), this.gpgpuCreatedLocally = !0;
    }
    this.gpgpu = t, this.canvas = this.gpgpu.gl.canvas, this.textureManager = new A0(this.gpgpu), this.numMBBeforeWarning = Z0(), this.texData = new il(this, $t());
  }
  numDataIds() {
  ...
  writeTexture(e, t, r, s, o, i) {
    ...
    const l = ur(t), u = new zo(l, !1, i), d = this.runWebGLProgram(u, [a], r, [[s, o]]);
  ...
  write(e, t, r) {
    ...
    return this.texData.set(s, { shape: t, dtype: r, values: e, usage: Oe.UPLOAD, refCount: 1 }), s;
  }
  ...
  move(e, t, r, s, o) {
    if (E().getBool("DEBUG") && this.checkNumericalProblems(t), s === "complex64")
      throw new Error("Cannot write to a complex64 dtype. Please use tf.complex(real, imag).");
    this.texData.set(e, { shape: r, dtype: s, values: t, usage: Oe.UPLOAD, refCount: o });
  }
  ...
  readSync(e) {
    ...
    if (i != null) {
      ...
      const p = this.runWebGLProgram(h, [{ dataId: e, shape: a, dtype: s }], s), m = this.readSync(p.dataId);
    ...
    return l && (this.downloadWaitMs += je() - u), this.convertAndCacheOnCPU(e, d);
  }
  async read(e) {
    ...
    if (i !== "complex64" && E().get("WEBGL_BUFFER_SUPPORTED")) {
      ...
      l = this.gpgpu.createBufferFromTexture(m.texture.texture, ...ar(s));
    }
    ...
    return this.pendingRead.delete(e), p.forEach((m) => m(h)), this.pendingDisposal.has(e) && (this.pendingDisposal.delete(e), this.disposeData(e) && $t().removeDataId(e, this), this.pendingDeletes--), h;
  }
  /**
  ...
  readToGPU(e, t = {}) {
    ...
    if (i != null) {
      let p;
      c ? p = new St(o, vt) : p = new ct(o, vt);
      const m = this.runWebGLProgram(p, [{ dataId: e, shape: o, dtype: a }], a), C = this.readToGPU(m, t);
  ...
  bufferSync(e) {
    ...
    if (e.dtype === "string")
      try {
        ...
        return ge(e.shape, e.dtype, r);
      } catch {
        throw new Error("Failed to decode encoded string bytes into utf-8");
      }
    return ge(e.shape, e.dtype, t);
  }
  ...
  getValuesFromTexture(e) {
    const { shape: t, dtype: r, isPacked: s } = this.texData.get(e), o = P(t);
    if (E().getBool("WEBGL_DOWNLOAD_FLOAT_ENABLED")) {
      const h = this.decode(e), p = this.texData.get(h.dataId), m = this.gpgpu.downloadMatrixFromPackedTexture(p.texture.texture, ...ar(t)).subarray(0, o);
      return this.disposeIntermediateTensorInfo(h), m;
    }
    const i = E().getBool("WEBGL_PACK") && s === !0, a = i ? ur(t) : t, c = i ? new pg(a) : new fg(a), l = this.runWebGLProgram(c, [{ shape: a, dtype: r, dataId: e }], "float32"), u = this.texData.get(l.dataId), d = this.gpgpu.downloadByteEncodedFloatMatrixFromOutputTexture(u.texture.texture, u.texShape[0], u.texShape[1]).subarray(0, o);
  ...
  time(e) {
    ...
    return (async () => {
      if (E().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE") > 0) {
        ...
        a.kernelMs = al(c), a.getExtraProfileInfo = () => c.map((l, u) => ({ name: i[u], ms: l })).map((l) => `${l.name}: ${l.ms}`).join(", ");
      } else
        a.kernelMs = {
  ...
  startTimer() {
    return E().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE") > 0 ? this.gpgpu.beginQuery() : { startMs: je(), endMs: null };
  }
  endTimer(e) {
    return E().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE") > 0 ? (this.gpgpu.endQuery(), e) : (e.endMs = je(), e);
  }
   ...
   */
  shouldExecuteOnCPU(e, t = Y0) {
    return E().getBool("WEBGL_CPU_FORWARD") && e.every((r) => this.texData.get(r.dataId).texture == null && P(r.shape) < t);
  }
  getGPGPUContext() {
    return this.gpgpu;
  }
  ...
  abs(e) {
    if (this.shouldExecuteOnCPU([e]) && e.dtype !== "complex64") {
      const s = xc(this.texData.get(e.dataId).values);
      return this.makeOutput(e.shape, e.dtype, s);
    }
    if (E().getBool("WEBGL_PACK_UNARY_OPERATIONS"))
      return this.packedUnaryOp(e, Zo, e.dtype);
    const t = new ct(e.shape, Zo), r = this.compileAndRun(t, [e]);
    return $t().makeTensorFromTensorInfo(r);
  }
  makeTensorInfo(e, t, r) {
    let s;
    if (t === "string" && r != null && r.length > 0 && Nr(r[0])) {
  ...
  unpackTensor(e) {
    const t = new H0(e.shape);
    return this.runWebGLProgram(t, [e], e.dtype);
  }
  packTensor(e) {
    const t = new N0(e.shape);
  ...
  packedReshape(e, t) {
    const r = [
      ...
      yn(t),
      ...$n(t)
    ], i = new bc(o, r), a = !0, c = [r], l = this.runWebGLProgram(i, [s], e.dtype, c, a);
    return { dataId: l.dataId, shape: t, dtype: l.dtype };
  }
  decode(e, t) {
    const r = this.texData.get(e), { isPacked: s, shape: o, dtype: i } = r;
    if (t != null) {
      const h = P(o), p = t[0] * t[1] * 4;
      _(h <= p, () => "customTexShape is too small. Row * Column * 4 should be equal or larger than the size of the tensor data.");
    }
    const a = ur(o);
    let c;
    s ? c = new hg(a) : c = new dg(a);
    const l = !0, u = [t ?? ar(a)], d = this.runWebGLProgram(c, [{ shape: a, dtype: i, dataId: e }], i, u, l, t);
  ...
  runWebGLProgram(e, t, r, s, o = !1, i) {
    ...
    if (e.packedOutput && (c.isPacked = !0), e.outPackingScheme === Hn.DENSE) {
      const x = i ?? ar(e.outputShape);
      c.texShape = x.map((y) => y * 2);
    }
    if (e.outTexUsage != null && (c.usage = e.outTexUsage), P(a.shape) === 0)
    ...
    const l = [], u = t.map((x) => {
      ...
      if (y.texture == null) {
        if (!e.packedInputs && P(x.shape) <= E().getNumber("WEBGL_SIZE_UPLOAD_UNIFORM"))
          return {
            shape: x.shape,
            texData: null,
            isUniform: !0,
      ...
      else if (y.isPacked && !Ir(y.shape, x.shape)) {
        const v = x, I = x.shape;
    ...
    const d = { shape: a.shape, texData: c, isUniform: !1 }, h = ug(e, u, d), p = this.getAndSaveBinary(h, () => cg(this.gpgpu, e, u, d)), m = this.activeTimers != null;
    let C;
    m && (C = this.startTimer()), E().get("ENGINE_COMPILE_ONLY") || lg(this.gpgpu, p, u, d, s), l.forEach((x) => this.disposeIntermediateTensorInfo(x)), m && (C = this.endTimer(C), this.activeTimers.push({ name: e.constructor.name, query: this.getQueryTime(C) }));
  ...
  floatPrecision() {
    return this.floatPrecisionValue == null && (this.floatPrecisionValue = re(() => {
  ...
  /** Returns the smallest representable number.  */
  epsilon() {
    return this.floatPrecision() === 32 ? q0 : j0;
  }
  uploadToGPU(e) {
    ...
    l && (u = je());
    let d = t.texShape;
    if (d == null && (d = gm(r, c), t.texShape = d), o != null) {
      const h = ur(r);
      let p, m = d[1], C = d[0];
      const w = o instanceof Uint8Array || o instanceof Uint8ClampedArray;
      (c || !w) && ([m, C] = Rn(d[0], d[1])), c ? p = new gg(h, w) : p = new zo(h, w);
      const x = w ? [C, m] : d, y = this.makeTensorInfo(x, s), v = this.texData.get(y.dataId);
      w ? v.usage = Oe.PIXELS : v.usage = Oe.UPLOAD, v.texShape = x, this.gpgpu.uploadDenseMatrixToTexture(this.getTexture(y.dataId), m, C, o);
      const I = [[C, m]], A = this.runWebGLProgram(p, [y], s, I, !0), F = this.texData.get(A.dataId);
      t.texShape = F.texShape, t.isPacked = F.isPacked, t.usage = F.usage, E().get("ENGINE_COMPILE_ONLY") ? this.disposeData(A.dataId) : (t.texture = F.texture, t.values = null, this.texData.delete(A.dataId)), this.disposeIntermediateTensorInfo(y), l && (this.uploadWaitMs += je() - u);
    } else {
  ...
  convertAndCacheOnCPU(e, t) {
    ...
    return t != null && (r.values = J0(t, s)), r.values;
  }
  ...
  async checkCompletionAsync_(e) {
    return this.gpgpu.gl.getProgramParameter(e.webGLProgram, this.gpgpu.parallelCompilationExtension.COMPLETION_STATUS_KHR) ? this.checkCompletion_(e) : (await Bp(), this.checkCompletionAsync_(e));
  }
  checkCompletion_(e) {
    if (this.gpgpu.gl.getProgramParameter(e.webGLProgram, this.gpgpu.gl.LINK_STATUS) === !1)
      throw console.log(this.gpgpu.gl.getProgramInfoLog(e.webGLProgram)), this.gpgpu.gl.getShaderParameter(e.fragmentShader, this.gpgpu.gl.COMPILE_STATUS) === !1 ? (rc(e.source, this.gpgpu.gl.getShaderInfoLog(e.fragmentShader)), new Error("Failed to compile fragment shader.")) : new Error("Failed to link vertex and fragment shaders.");
    return !0;
  }
  getUniformLocations() {
    for (const e of Object.values(this.binaryCache)) {
      this.gpgpu.buildVao(e.webGLProgram);
      const { variablesLocations: t, customUniformLocations: r, infLoc: s, nanLoc: o, outShapeLocation: i, outShapeStridesLocation: a, outTexShapeLocation: c } = cc(this.gpgpu, e.program, e.webGLProgram);
...
class Xt {
  constructor(e, t, r) {
    this.variableNames = ["A", "B"], this.outputShape = $e(t, r), this.enableShapeUniforms = we(this.outputShape.length), this.userCode = `
...
class Fn {
  constructor(e, t, r, s = !1) {
    this.variableNames = ["A", "B"], this.supportsBroadcasting = !0, this.packedInputs = !0, this.packedOutput = !0, this.outputShape = $e(t, r);
    const o = this.outputShape.length;
    this.enableShapeUniforms = we(o);
    let i = "";
    if (s)
 ...
 */
function Nt(n) {
  const { inputs: e, backend: t } = n, { real: r, imag: s } = e, o = t.makeTensorInfo(r.shape, "complex64"), i = t.texData.get(o.dataId), a = Fe({ inputs: { x: r }, backend: t }), c = Fe({ inputs: { x: s }, backend: t });
 ...
 * =============================================================================
 */
const yc = "return (a < 0.) ? b * a : a;", $c = `
  vec4 aLessThanZero = vec4(lessThan(a, vec4(0.)));
  return (aLessThanZero * (b * a)) + ((vec4(1.0) - aLessThanZero) * a);
`;
function nw(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s } = e, { alpha: o } = r, i = t.makeTensorInfo([], "float32", vn(o, "float32")), a = E().getBool("WEBGL_PACK_BINARY_OPERATIONS") ? new Fn($c, s.shape, i.shape) : new Xt(yc, s.shape, i.shape), c = t.runWebGLProgram(a, [s, i], "float32");
 ...
 * =============================================================================
 */
const vc = "return (a < 0.) ? b * a : a;", Ic = `
  vec4 aLessThanZero = vec4(lessThan(a, vec4(0.)));
  return (aLessThanZero * (b * a)) + ((vec4(1.0) - aLessThanZero) * a);
`;
function sw(n) {
  const { inputs: e, backend: t } = n, { x: r, alpha: s } = e, o = E().getBool("WEBGL_PACK_BINARY_OPERATIONS") ? new Fn(Ic, r.shape, s.shape) : new Xt(vc, r.shape, s.shape);
...
function xe({ opSnippet: n, packedOpSnippet: e, checkOutOfBounds: t = !1, supportsComplex: r = !1, cpuKernelImpl: s, dtype: o }) {
  return ({ inputs: i, backend: a }) => {
    ...
    let p;
    return h ? p = new Fn(e, c.shape, l.shape, t) : p = new Xt(n, c.shape, l.shape), u.runWebGLProgram(p, [c, l], d);
  };
}
function Xn(n, e = !1) {
  if (n === "linear")
...
class Sc {
  constructor(e, t, r, s = !1, o = !1, i = !1, a = null, c = !1, l = !1) {
    this.variableNames = ["matrixA", "matrixB"], this.packedInputs = !0, this.packedOutput = !0, this.outputShape = r, this.enableShapeUniforms = we(this.outputShape.length);
    const u = s ? e[1] : e[2], d = Math.ceil(u / 2), h = s ? "i * 2, rc.y" : "rc.y, i * 2", p = o ? "rc.z, i * 2" : "i * 2, rc.z", m = s ? ["a.xxyy", "a.zzww"] : ["a.xxzz", "a.yyww"], C = o ? ["b.xzxz", "b.ywyw"] : ["b.xyxy", "b.zwzw"];
    let w = "", x = "";
...
class ei {
  constructor(e, t, r) {
    this.variableNames = ["AReal", "AImag", "BReal", "BImag"], this.outputShape = $e(t, r), this.userCode = `
...
function no(n) {
  ...
  if (r.dtype === "complex64") {
    const a = t.texData.get(r.dataId), c = t.texData.get(s.dataId), l = new ei(Jo.REAL, r.shape, s.shape), u = new ei(Jo.IMAG, r.shape, s.shape), d = [
      {
    ...
    ], h = t.runWebGLProgram(l, d, "float32"), p = t.runWebGLProgram(u, d, "float32"), m = Nt({ inputs: { real: h, imag: p }, backend: t });
    return t.disposeIntermediateTensorInfo(h), t.disposeIntermediateTensorInfo(p), m;
  }
  if (t.shouldExecuteOnCPU([r, s])) {
    const a = t.texData.get(r.dataId), c = t.texData.get(s.dataId), [l, u] = s0(r.shape, s.shape, a.values, c.values, o), d = t.makeTensorInfo(u, o), h = t.texData.get(d.dataId);
    return h.values = l, d;
  }
  let i;
  return E().getBool("WEBGL_PACK_BINARY_OPERATIONS") ? i = new Fn(ti, r.shape, s.shape) : i = new Xt(ti, r.shape, s.shape), t.runWebGLProgram(i, [r, s], o);
}
const iw = {
  kernelName: Oi,
  backendName: "webgl",
...
function aw(n, e, t) {
  const r = [
    ...
    yn(e),
    ...$n(e)
  ], i = new bc(o, r), a = !0, c = [r], l = t.runWebGLProgram(i, [s], n.dtype, c, a);
 ...
 */
function D(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s } = e, { shape: o } = r, i = t, a = P(s.shape), c = cl(o, a), l = P(c);
  _(a === l, () => `The new shape (${c}) has ${l} elements and the old shape (${s.shape}) has ${a} elements. The new shape and old shape must have the same number of elements.`);
  const u = i.texData.get(s.dataId);
  return u.isPacked && !Ir(s.shape, c) && !(u.texture !== null && Ir(u.shape, c)) ? aw(s, c, i) : (i.incRef(s.dataId), { dataId: s.dataId, shape: c, dtype: s.dtype });
}
const cw = {
  kernelName: _i,
  backendName: "webgl",
...
class ni {
  constructor(e, t) {
    ...
    if (t != null) {
      const d = 1 / t;
      l = `sumValue += dot(values * ${Ci(d) ? d.toPrecision(2) : d}, ones);`;
    }
    let u = "";
    o % r > 0 && (u = `
        if (inIdx < 0 || inIdx >= ${o}) {
...
function uw(n) {
  ...
  for (; e.length === 0 || e[e.length - 1].outSize !== 1; ) {
    const t = e.length ? e[e.length - 1].outSize : n[1], r = _r(t);
    e.push({
      inSize: t,
      windowSize: r,
...
function tn(n, e, t, r) {
  ...
  for (let i = 0; i < s.length; i++) {
    ...
    let u, d;
    t === "mean" ? u = i === 0 ? new ni({ windowSize: c, inSize: a, batchSize: n.shape[0], outSize: l }, a) : new ni({ windowSize: c, inSize: a, batchSize: n.shape[0], outSize: l }) : u = new lw({ windowSize: c, inSize: a, batchSize: n.shape[0], outSize: l }, t), d = o, o = r.runWebGLProgram(u, [o], e), d.dataId !== n.dataId && r.disposeIntermediateTensorInfo(d);
  }
  return o;
}
/**
...
class fw {
  constructor(e, t) {
    ...
    const s = j(this.rank), o = Cc("rc", this.rank), i = new Array(this.rank);
 ...
 */
function Mr(n, e, t) {
  const r = E().getBool("WEBGL_PACK_ARRAY_OPERATIONS") ? new fw(n.shape, e) : new dw(n.shape, e);
...
function pw(n, e, t, r) {
  ...
  let u = n;
  l && (u = Mr(n, c, r), a = Xe(a.length, o)), tt("sum", a, o);
  const [d, h] = ht(u.shape, a);
  let p = d;
  t && (p = gt(d, i));
  const m = P(h), w = P(n.shape) / m, x = D({ inputs: { x: u }, attrs: { shape: [w, m] }, backend: r }), y = Bs(n.dtype), v = tn(x, y, "sum", r), I = D({ inputs: { x: v }, attrs: { shape: p }, backend: r });
...
function ve(n) {
  ...
  if (i.shouldExecuteOnCPU([s])) {
    const d = i.texData.get(s.dataId).values, h = eo(d, s.shape, s.dtype, o, c);
    l = i.makeTensorInfo(c, s.dtype);
    const p = i.texData.get(l.dataId);
    p.values = h;
  } else
    l = Mr(s, o, i);
  return l;
 ...
 */
const Ec = 1e3;
function Er({ a: n, b: e, transposeA: t, transposeB: r, backend: s, bias: o = null, preluActivationWeights: i = null, leakyreluAlpha: a = 0, activation: c = null }) {
  const l = n.shape.length, u = e.shape.length, d = t ? n.shape[l - 2] : n.shape[l - 1], h = r ? e.shape[u - 1] : e.shape[u - 2], p = t ? n.shape[l - 1] : n.shape[l - 2], m = r ? e.shape[u - 2] : e.shape[u - 1], C = n.shape.slice(0, -2), w = e.shape.slice(0, -2), x = P(C), y = P(w), I = $e(n.shape.slice(0, -2), e.shape.slice(0, -2)).concat([p, m]);
  _(d === h, () => `Error in matMul: inner shapes (${d}) and (${h}) of Tensors with shapes ${n.shape} and ${e.shape} and transposeA=${t} and transposeB=${r} must match.`);
  const T = t ? [x, d, p] : [x, p, d], A = r ? [y, m, h] : [y, h, m], F = D({ inputs: { x: n }, backend: s, attrs: { shape: T } }), k = D({ inputs: { x: e }, backend: s, attrs: { shape: A } }), M = [F, k], U = Math.max(x, y), G = t ? F.shape[1] : F.shape[2], X = o != null, Ce = i != null, oe = c === "leakyrelu", ae = c != null ? Xn(c, !0) : null, Te = X || Ce || oe || ae != null;
  let Ne;
  if ((p === 1 || m === 1) && G > Ec && Te === !1) {
    let nt = F, Ct = k;
    t && (nt = ve({ inputs: { x: F }, backend: s, attrs: { perm: [0, 2, 1] } }), M.push(nt)), r && (Ct = ve({ inputs: { x: k }, backend: s, attrs: { perm: [0, 2, 1] } }), M.push(Ct));
    const bt = m !== 1, nn = m === 1;
    let Pn = nt;
    bt && (Pn = D({
      inputs: { x: nt },
    ...
    const _n = no({ inputs: { a: Pn, b: de }, backend: s });
    Ne = Ur({ inputs: { x: _n }, backend: s, attrs: { axis: ie, keepDims: !0 } }), M.push(_n);
  } else {
    const nt = dt(n.dtype, e.dtype), Ct = new Sc(T, A, [U, p, m], t, r, X, ae, Ce, oe), bt = [F, k];
    if (o != null && bt.push(o), Ce && bt.push(i), oe) {
      const nn = s.makeTensorInfo([], "float32", vn(a, "float32"));
      bt.push(nn), M.push(nn);
    }
    Ne = s.runWebGLProgram(Ct, bt, nt);
  }
  const ce = D({ inputs: { x: Ne }, backend: s, attrs: { shape: I } });
  M.push(Ne);
  for (const nt of M)
 ...
 * =============================================================================
 */
const ri = "return abs(x);";
function Cw(n) {
  const { inputs: e, backend: t } = n, { x: r } = e;
  if (t.shouldExecuteOnCPU([r]) && r.dtype !== "complex64") {
    const o = t.texData.get(r.dataId), i = xc(o.values);
    return t.makeTensorInfo(r.shape, r.dtype, i);
  }
  let s;
  return E().getBool("WEBGL_PACK_UNARY_OPERATIONS") ? s = new St(r.shape, ri) : s = new ct(r.shape, ri), t.runWebGLProgram(s, [r], r.dtype);
}
const bw = {
  kernelName: Ri,
  backendName: "webgl",
...
const Iw = qe + `
  if (x < 1.0) return NAN;
return log(x + sqrt(x * x - 1.0));`, Sw = H({ opSnippet: Iw }), Ew = {
  kernelName: Rl,
  backendName: "webgl",
  kernelFunc: Sw
};
...
function gr(n) {
  ...
  if (r.length === 1)
    return Fe({ inputs: { x: r[0] }, backend: t });
  if (r.length > E().get("WEBGL_MAX_TEXTURES_IN_SHADER")) {
    const c = Math.floor(r.length / 2), l = gr({ inputs: r.slice(0, c), backend: t }), u = gr({ inputs: r.slice(c), backend: t });
    return gr({ inputs: [l, u], backend: t });
  }
  const s = r.map((c) => c.dtype).reduce((c, l) => dt(c, l)), o = r.map((c) => c.shape), a = E().getBool("WEBGL_PACK") ? new kw(r[0].shape, o) : new Nw(r[0].shape, o);
...
function Fw(n) {
  ...
  const u = He(l, a);
  let d = s;
  u != null && (d = ve({ inputs: { x: s }, backend: t, attrs: { perm: u } }), l = Xe(l.length, a)), tt("all", l, a);
  const [h, p] = ht(d.shape, l), m = P(p), C = D({ inputs: { x: d }, backend: t, attrs: { shape: [-1, m] } }), w = tn(C, C.dtype, "all", t);
  let x;
  if (i) {
    const y = gt(h, c);
...
function Ow(n) {
  ...
  const u = He(l, a);
  let d = s;
  u != null && (d = ve({ inputs: { x: s }, backend: t, attrs: { perm: u } }), l = Xe(l.length, a)), tt("any", l, a);
  const [h, p] = ht(d.shape, l), m = P(p), C = D({ inputs: { x: d }, backend: t, attrs: { shape: [-1, m] } }), w = tn(C, C.dtype, "any", t);
  let x;
  if (i) {
    const y = gt(h, c);
    x = D({ inputs: { x: w }, backend: t, attrs: { shape: y } });
...
class Bw {
  constructor(e, t, r, s) {
    this.variableNames = ["A"], this.packedInputs = !0, this.packedOutput = !0, _(e.length > 2, () => `Packed arg${r.charAt(0).toUpperCase() + r.slice(1)} supports only inputs with rank above 2.`);
    ...
    const a = this.outputShape, c = a.length, l = j(c), u = ye("coords", c);
    let d, h;
    if (i === 1) {
      h = c + 1;
      const k = j(h);
      ...
      h = c, d = `
        ...
        ${l} sourceLocB = coords;
        --${u[c - 2]};`;
    const p = ["x", "y", "z", "w", "u", "v"].slice(0, h), m = "." + p[h - 1], C = p.map((k) => "int " + k), w = ye("sourceLocR", h - 1).concat("inIdx.r"), x = ye("sourceLocG", h - 1).concat("inIdx.g"), y = ye("sourceLocB", h - 1).concat("inIdx.b"), v = ye("sourceLocA", h - 1).concat("inIdx.a"), I = r === "max" ? "greaterThan" : "lessThan", T = s ? "" : `
 ...
 * =============================================================================
 */
function Rc(n, e, t, r = null) {
  let s = e.shape[0], o = e.shape[1];
  r != null && (s = r.shape[0], o = r.shape[1]);
  const i = _r(o), a = { windowSize: i, inSize: o, batchSize: s, outSize: Math.ceil(o / i) }, c = new _w(a, t, r == null), l = [e];
  r != null && l.push(r);
...
function Tc(n, e, t, r = null) {
  const s = r != null ? r.shape : e.shape, o = s[s.length - 1], i = _r(o), a = new Bw(s, i, t, r == null), c = r == null ? [e] : [e, r], l = n.runWebGLProgram(a, c, "int32");
...
function Nc(n, e, t, r) {
  ...
  if (tt("arg" + r.charAt(0).toUpperCase() + r.slice(1), s, e.shape.length), !E().getBool("WEBGL_PACK_REDUCE") || e.shape.length <= 2) {
    ...
    const [l, u] = ht(c.shape, s), d = P(u), h = D({ inputs: { x: c }, backend: n, attrs: { shape: [-1, d] } });
    o.push(h);
    const p = Rc(n, h, r);
    o.push(p);
    const m = D({ inputs: { x: p }, backend: n, attrs: { shape: l } });
...
function Lw(n) {
  ...
  let c = s;
  const l = [];
  a != null && (c = ve({ inputs: { x: s }, backend: t, attrs: { perm: a } }), l.push(c), i = Xe(i.length, c.shape.length)), tt("argMax", [i[0]], c.shape.length);
  const u = Nc(t, c, i[0], "max");
...
function Uw(n) {
  ...
  let c = s;
  const l = [];
  a != null && (c = ve({ inputs: { x: s }, backend: t, attrs: { perm: a } }), l.push(c), i = Xe(i.length, c.shape.length)), tt("argMin", [i[0]], c.shape.length);
  const u = Nc(t, c, i[0], "min");
  return l.forEach((d) => t.disposeIntermediateTensorInfo(d)), u;
}
const Vw = {
  kernelName: Fl,
 ...
 * =============================================================================
 */
const Hw = qe + "return log(x + sqrt(x * x + 1.0));", Xw = H({ opSnippet: Hw }), qw = {
  kernelName: Ol,
  backendName: "webgl",
  kernelFunc: Xw
};
...
`, Zw = `
  ...
  ` + en + `
  return result;
`, Jw = xe({ opSnippet: Qw, packedOpSnippet: Zw }), eC = {
  kernelName: Bl,
  backendName: "webgl",
  kernelFunc: Jw
};
...
return (log(1.0 + x) - log(1.0 - x)) / 2.0;`, nC = H({ opSnippet: tC }), rC = {
  kernelName: _l,
  backendName: "webgl",
  kernelFunc: nC
};
...
class qn {
  constructor(e, t, r, s = !1, o = !1) {
    ...
    const i = e.filterWidth, a = e.strideHeight, c = e.strideWidth, l = e.dilationHeight, u = e.dilationWidth, d = e.effectiveFilterHeight, h = e.effectiveFilterWidth, p = e.padInfo.top, m = e.padInfo.left;
...
class ro {
  constructor(e, t, r, s = !1, o = !1) {
    if (this.variableNames = ["x"], t === "avg" && r)
      throw new Error("Cannot compute positions for average pool.");
    const i = e.filterWidth, a = e.strideDepth, c = e.strideHeight, l = e.strideWidth, u = e.dilationDepth, d = e.dilationHeight, h = e.dilationWidth, p = e.effectiveFilterDepth, m = e.effectiveFilterHeight, C = e.effectiveFilterWidth, w = e.padInfo.front, x = e.padInfo.top, y = e.padInfo.left;
    this.outputShape = e.outShape;
    const v = t === "avg";
    let I = "0.0";
    if (v || (I = "-1.0 / 1e-20"), r) {
    ...
    const F = Math.floor(i / 4) * 4, k = i % 4, M = `
      if (${v}) {
        avgValue += dot(values, ones);
      } else {
...
function sC(n) {
  ...
  _(Sn(i, l), () => `Error in avgPool: Either strides or dilations must be 1. Got strides ${i} and dilations '${l}'`);
  const u = In(s.shape, o, i, l, a, c);
  if (u.filterWidth === 1 && u.filterHeight === 1 && me(u.inShape, u.outShape))
    return Fe({ inputs: { x: s }, backend: t });
 ...
 */
function iC(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s } = e, { filterSize: o, strides: i, pad: a, dimRoundingMode: c, dataFormat: l } = r, u = [1, 1, 1], d = Qn(s.shape, o, i, u, a, c, l), h = new ro(d, "avg", !1);
 ...
 */
function uC(n) {
  const { inputs: e, backend: t, attrs: r } = n, { dy: s, input: o } = e, i = o, { filterSize: a, strides: c, pad: l, dimRoundingMode: u } = r, d = [1, 1, 1], h = Qn(i.shape, a, c, d, l, u), p = new lC(h);
  return t.runWebGLProgram(p, [s], i.dtype);
}
const dC = {
  kernelName: Vl,
  backendName: "webgl",
...
function hC(n) {
  ...
  er([s, o], "avgPoolGrad");
  const { filterSize: a, strides: c, pad: l } = r, u = In(i.shape, a, c, 1, l), d = new cC(u);
...
function pC(n) {
  ...
  return Er({ a: s, b: o, transposeA: i, transposeB: a, backend: t });
}
const mC = {
  kernelName: Wl,
  backendName: "webgl",
...
class gC {
  constructor(e, t, r, s, o, i) {
    this.outputShape = [], this.variableNames = ["x", "mean", "variance"], $e(e, t), $e(e, r);
    let a = "0.0";
    s != null && ($e(e, s), this.variableNames.push("offset"), a = "getOffsetAtOutCoords()");
    let c = "1.0";
    o != null && ($e(e, o), this.variableNames.push("scale"), c = "getScaleAtOutCoords()"), this.outputShape = e, this.userCode = `
      void main() {
...
class xC {
  constructor(e, t, r, s, o, i) {
    this.packedInputs = !0, this.packedOutput = !0, this.variableNames = ["x", "mean", "variance"], $e(e, t), $e(e, r);
    let a = "vec4(0.0)";
    s != null && ($e(e, s), this.variableNames.push("offset"), a = "getOffsetAtOutCoords()");
    let c = "vec4(1.0)";
    o != null && ($e(e, o), this.variableNames.push("scale"), c = "getScaleAtOutCoords()"), this.outputShape = e, this.userCode = `
 ...
 * =============================================================================
 */
const wC = ({ inputs: n, backend: e, attrs: t }) => {
  const { x: r, mean: s, variance: o, offset: i, scale: a } = n;
  _(s.shape.length === o.shape.length, () => "Batch normalization gradient requires mean and variance to have equal ranks."), _(i == null || s.shape.length === i.shape.length, () => "Batch normalization gradient requires mean and offset to have equal ranks."), _(a == null || s.shape.length === a.shape.length, () => "Batch normalization gradient requires mean and scale to have equal ranks.");
  ...
  const h = E().getBool("WEBGL_PACK_NORMALIZATION") ? new xC(r.shape, s.shape, o.shape, u, d, c) : new gC(r.shape, s.shape, o.shape, u, d, c);
...
class bC {
  constructor(e) {
    ...
    const r = yC(this.rank);
    let s;
    const o = e.map((i, a) => `sourceLoc.${Es[a]} = start[${a}] + coords.${Es[a]};`);
    s = `
        ${t} sourceLoc;
...
const Es = ["x", "y", "z", "w", "u", "v"];
function yC(n) {
  if (n === 1)
    return "sourceLoc";
  if (n <= 6)
    return Es.slice(0, n).map((e) => "sourceLoc." + e).join(",");
...
class $C {
  constructor(e) {
    ...
    const t = j(this.rank), r = ye("coords", this.rank), s = ye("sourceLoc", this.rank), o = this.rank === 1 ? "sourceLoc" : `vec2(${s.slice(-2).join()})`, i = `getChannel(getSource(${s.join()}), ${o})`, a = `
      result.x = ${i};
...
function On(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s } = e, { begin: o, size: i } = r, [a, c] = Dp(s, o, i);
  if (Ap(s, a, c), P(c) === 0)
    return t.makeTensorInfo(c, s.dtype, []);
  if (t.shouldExecuteOnCPU([s]) || s.dtype === "string") {
    const d = t.texData.get(s.dataId), h = m0(d.values, a, c, s.shape, s.dtype);
    return t.makeTensorInfo(c, s.dtype, h);
  }
  const { isPacked: l } = t.texData.get(s.dataId), u = ya(s.shape, a, c);
  if (l || !u) {
    const d = E().getBool("WEBGL_PACK_ARRAY_OPERATIONS") ? new $C(c) : new bC(c), h = [a];
    return t.runWebGLProgram(d, [s], s.dtype, h);
  }
  return t.uploadToGPU(s.dataId), vC(s, a, c, t);
}
const IC = {
  kernelName: Pd,
  backendName: "webgl",
...
const SC = (n) => {
  ...
  _(s.shape.length <= 4, () => "batchToSpaceND for rank > 4 with a WebGL backend not implemented yet");
  const a = o.reduce((y, v) => y * v), c = qs(s.shape, o, a), l = js(c.length, o.length), u = Ks(s.shape, o, a), d = Na(i, o.length), h = ka(u, i, o.length), p = [], m = D({ inputs: { x: s }, backend: t, attrs: { shape: c } }), C = ve({ inputs: { x: m }, backend: t, attrs: { perm: l } }), w = D({
    inputs: { x: C },
    backend: t,
    attrs: { shape: u }
  }), x = On({
  ...
  return p.push(m), p.push(C), p.push(w), p.forEach((y) => t.disposeIntermediateTensorInfo(y)), x;
}, EC = {
  kernelName: Gl,
  backendName: "webgl",
  kernelFunc: SC
 ...
 */
function RC(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s, weights: o } = e, { size: i } = r, a = t.readSync(s.dataId), c = t.readSync(o.dataId), l = gc(a, c, o.dtype, o.shape, i);
...
function AC(n) {
  ...
  if (t.shouldExecuteOnCPU([r, s]) || i === 1) {
    const c = t.texData.get(r.dataId).values, l = t.texData.get(s.dataId).values, [u, d] = Mx(r.shape, s.shape, c, l, r.dtype), h = t.makeTensorInfo(d, r.dtype), p = t.texData.get(h.dataId);
    return p.values = u, h;
  }
  let a;
  return o ? a = new Fn(NC, r.shape, s.shape, !1) : a = new Xt(kC, r.shape, s.shape), t.runWebGLProgram(a, [r, s], r.dtype);
}
const FC = {
  kernelName: Hl,
  backendName: "webgl",
 ...
 */
function DC(n) {
  const { inputs: e, backend: t } = n, { s0: r, s1: s } = e, o = t.readSync(r.dataId), i = t.readSync(s.dataId), a = $e(Array.from(o), Array.from(i));
 ...
 * =============================================================================
 */
const PC = "return float(a != b);", kc = xe({ opSnippet: PC, cpuKernelImpl: i0, dtype: "bool" }), _C = {
  kernelName: od,
  backendName: "webgl",
  kernelFunc: kc
};
...
function nr(n) {
  ...
  return Fe({ inputs: { x: s.complexTensorInfos.real }, backend: t });
}
const BC = {
  kernelName: Cd,
  backendName: "webgl",
 ...
 * =============================================================================
 */
const LC = "return float(int(x));";
function MC(n, e) {
  const t = new ct(n.shape, LC), r = e.runWebGLProgram(t, [n], "int32");
...
function Rs(n) {
  ...
  if (o === "complex64") {
    if (s.dtype === "complex64")
      return Fe({ inputs: { x: s }, backend: t });
    const i = ys(s.shape), a = Rs({ inputs: { x: s }, backend: t, attrs: { dtype: "float32" } }), c = Nt({ inputs: { real: a, imag: i }, backend: t });
    return i.dispose(), t.disposeIntermediateTensorInfo(a), c;
  }
  if (s.dtype === "complex64") {
    const i = nr({ inputs: { input: s }, backend: t }), a = Rs({ inputs: { x: i }, backend: t, attrs: { dtype: o } });
    return t.disposeIntermediateTensorInfo(i), a;
  }
  if (!dl(s.dtype, o)) {
    const i = Fe({ inputs: { x: s }, backend: t });
    return { dataId: i.dataId, shape: i.shape, dtype: o };
  }
  if (t.shouldExecuteOnCPU([s])) {
    const i = t.texData.get(s.dataId).values, [a, c, l] = Ux(i, s.shape, s.dtype, o);
    return t.makeTensorInfo(a, c, l);
  }
  if (o === "int32")
    return MC(s, t);
  if (o === "bool") {
    const i = t.makeTensorInfo([], "bool", Ut("bool", 1)), c = kc({ inputs: { a: s, b: i }, backend: t });
    return t.disposeIntermediateTensorInfo(i), c;
  }
 ...
 * =============================================================================
 */
const oi = "return ceil(x);", VC = H({ opSnippet: oi, packedOpSnippet: oi, cpuKernelImpl: Vx }), WC = {
  kernelName: ql,
  backendName: "webgl",
  kernelFunc: VC
};
...
function HC(n) {
  ...
  let a;
  E().getBool("WEBGL_PACK_CLIP") ? a = new zC(s.shape) : a = new GC(s.shape);
  const c = [[o], [i]];
...
function jC(n) {
  const { inputs: e, backend: t } = n, { x: r } = e, s = t.texData.get(r.dataId), o = new qC(r.shape), i = [
    ii(r, s.complexTensorInfos.real),
    ii(r, s.complexTensorInfos.imag)
  ];
...
class QC {
  constructor(e, t) {
    ...
    const r = this.outputShape, s = r.length, o = j(s), i = ye("coords", s), a = ["x", "y", "z", "w", "u", "v"].slice(0, s);
    ...
    const p = c.length, m = c[c.length - 1];
    h += `
        return getChannel(
          getT${p}(${fr(a, l, m)}),
          vec2(${fr(u, l, m)}));`, this.userCode = `
...
function Vr(n) {
  const { inputs: e, backend: t } = n, { input: r } = e, s = t.texData.get(r.dataId);
  return Fe({ inputs: { x: s.complexTensorInfos.imag }, backend: t });
}
const ZC = {
  kernelName: Au,
  backendName: "webgl",
...
function Gn(n, e, t) {
  const r = n[0].dtype;
  if (r === "complex64") {
    const p = n.map((y) => nr({ inputs: { input: y }, backend: t })), m = n.map((y) => Vr({ inputs: { input: y }, backend: t })), C = Gn(p, e, t), w = Gn(m, e, t), x = Nt({ inputs: { real: C, imag: w }, backend: t });
    return p.forEach((y) => t.disposeIntermediateTensorInfo(y)), m.forEach((y) => t.disposeIntermediateTensorInfo(y)), t.disposeIntermediateTensorInfo(C), t.disposeIntermediateTensorInfo(w), x;
  }
  let s = t.shouldExecuteOnCPU(n);
  if (r === "string" && (s = !0), s) {
    const p = n.map((I) => {
      const A = [-1, P(I.shape.slice(e))];
      return D({ inputs: { x: I }, backend: t, attrs: { shape: A } });
    }), m = p.map((I) => ({ vals: t.readSync(I.dataId), shape: I.shape })), C = Ht(
      p.map((I) => I.shape),
      1
      /* axis */
    ), w = p[0].shape[0] === 1, x = Wx(m, C, r, w), y = Ht(n.map((I) => I.shape), e), v = t.makeTensorInfo(y, r, x);
    return p.forEach((I) => t.disposeIntermediateTensorInfo(I)), v;
  }
  const o = n.filter((p) => P(p.shape) > 0), i = E().getBool("WEBGL_PACK_ARRAY_OPERATIONS") && o[0].shape.length > 1;
  if (o.length === 1) {
    const p = i ? new ct(n[0].shape, vt) : new St(n[0].shape, vt);
    return t.runWebGLProgram(p, n, r);
  }
  ...
  if (i) {
    const p = new QC(o.map((m) => m.shape), e);
    return t.runWebGLProgram(p, o, r);
  }
  const { tensors2D: c, outShape: l } = JC(o, e, t), u = new YC(c.map((p) => p.shape)), d = t.runWebGLProgram(u, c, r);
  c.forEach((p) => t.disposeIntermediateTensorInfo(p));
...
function JC(n, e, t) {
  ...
  return { tensors2D: n.map((o) => D({
    inputs: { x: o },
    attrs: { shape: [-1, P(o.shape.slice(e))] },
    backend: t
  })), outShape: r };
}
/**
...
function Ac(n) {
  ...
  const c = e.filter((l) => P(l.shape) > 0);
  return c.length === 1 ? Fe({ inputs: { x: c[0] }, backend: t }) : Gn(c, o, t);
}
const e1 = {
  kernelName: Kl,
  backendName: "webgl",
...
class Fc {
  constructor(e, t = !1, r = null, s = !1, o = !1) {
    ...
    const i = e.padInfo.top, a = e.padInfo.left, c = e.strideHeight, l = e.strideWidth, u = e.dilationHeight, d = e.dilationWidth, h = e.filterHeight, p = e.filterWidth, m = Math.floor(e.inChannels / 4) * 4, C = e.inChannels % 4, w = e.dataFormat === "channelsLast", x = w ? 1 : 2, y = w ? 2 : 3, v = w ? 3 : 1;
    let I = "", T = "";
...
class t1 {
  constructor(e) {
    this.variableNames = ["x", "W"], this.outputShape = e.outShape;
    const t = e.padInfo.front, r = e.padInfo.top, s = e.padInfo.left, o = e.strideDepth, i = e.strideHeight, a = e.strideWidth, c = e.dilationDepth, l = e.dilationHeight, u = e.dilationWidth, d = e.filterDepth, h = e.filterHeight, p = e.filterWidth, m = Math.floor(e.inChannels / 4) * 4, C = e.inChannels % 4;
    this.userCode = `
...
class Dc {
  constructor(e, t = !1, r = null, s = !1, o = !1) {
    ...
    ], this.outputShape = e.outShape, this.enableShapeUniforms = we(this.outputShape.length);
...
function Oc({ x: n, filter: e, convInfo: t, backend: r, bias: s = null, preluActivationWeights: o = null, leakyreluAlpha: i = 0, activation: a = null }) {
  const c = n.shape, l = r.texData.get(n.dataId), u = t.inChannels, d = c[0] * c[1] * c[2], h = t.outChannels, p = t.dataFormat === "channelsLast", m = !1, C = !1;
  let w;
  const x = [];
  if (o != null) {
    const I = Rr(o.shape, p);
    I != null && (o = D({
      inputs: { x: o },
      backend: r,
      attrs: { shape: I }
  ...
  if (s != null) {
    const I = Rr(s.shape, p);
    I != null && (s = D({ inputs: { x: s }, backend: r, attrs: { shape: I } }), x.push(s));
  }
  if (!((d === 1 || h === 1) && u > Ec) && l.isPacked && p && l.texture != null && c[2] % 2 !== 0 && me(l.shape.slice(-3), c.slice(-3))) {
    const I = c[0] * c[1] * (c[2] + 1), T = {
      dataId: n.dataId,
      shape: [1, I, t.inChannels],
      dtype: n.dtype
    }, A = l.shape;
    l.shape = l.shape.slice(), l.shape[l.shape.length - 2]++, _(Ir(l.shape, T.shape), () => `packed reshape ${l.shape} to ${T.shape} isn't free`);
    const F = D({
      inputs: { x: e },
      backend: r,
    ...
    const k = Er({
      ...
      leakyreluAlpha: i
    }), M = r.texData.get(k.dataId);
    _(M.isPacked, () => "batchMatMul result is expected to be packed"), l.shape = A, M.shape = t.outShape, w = Fe({ inputs: { x: k }, backend: r }), w.shape = t.outShape, x.push(k);
  } else {
    const I = t.outHeight * t.outWidth, T = D({
      inputs: { x: n },
      backend: r,
      attrs: {
        shape: p ? [t.batchSize, I, t.inChannels] : [t.batchSize, t.inChannels, I]
      }
    }), A = D({
      inputs: { x: e },
      backend: r,
...
function Pc({ x: n, filter: e, convInfo: t, backend: r, bias: s = null, preluActivationWeights: o = null, leakyreluAlpha: i = 0, activation: a = null }) {
  const { filterWidth: c, filterHeight: l, inChannels: u, outWidth: d, outHeight: h, dataFormat: p } = t, m = p === "channelsLast", C = c * l * u, w = h * d, x = [t.batchSize, C, w], y = !0, v = !1, I = [];
  if (o != null) {
    const ce = Rr(o.shape, m);
    ce != null && (o = D({
      inputs: { x: o },
      backend: r,
      attrs: { shape: ce }
  ...
  if (s != null) {
    const ce = Rr(s.shape, m);
    ce != null && (s = D({ inputs: { x: s }, backend: r, attrs: { shape: ce } }), I.push(s));
  }
  const T = D({
    inputs: { x: e },
    backend: r,
    attrs: { shape: [1, C, P(e.shape) / C] }
  });
  I.push(T);
  const A = new n1(x, t), F = [
    n.shape,
    ...
    [t.outWidth]
  ], k = r.runWebGLProgram(A, [n], "float32", F), M = D({ inputs: { x: k }, backend: r, attrs: { shape: x } });
  I.push(k), I.push(M);
  const U = s != null, G = o != null, X = a === "leakyrelu", Ce = a ? Xn(a, !0) : null, oe = new Sc(m ? M.shape : T.shape, m ? T.shape : M.shape, m ? [t.batchSize, w, t.outChannels] : [t.batchSize, t.outChannels, w], y, v, U, Ce, G, X), ae = m ? [M, T] : [T, M];
  if (s && ae.push(s), G && ae.push(o), X) {
    const ce = r.makeTensorInfo([], "float32", vn(i, "float32"));
    ae.push(ce), I.push(ce);
  }
  const Te = r.runWebGLProgram(oe, ae, "float32"), Ne = D({ inputs: { x: Te }, backend: r, attrs: { shape: t.outShape } });
  I.push(Te);
  for (const ce of I)
    r.disposeIntermediateTensorInfo(ce);
  return Ne;
}
/**
 * @license
...
function r1(n) {
  ...
  if (h.filterHeight === 1 && h.filterWidth === 1 && h.dilationHeight === 1 && h.dilationWidth === 1 && h.strideHeight === 1 && h.strideWidth === 1 && (h.padInfo.type === "SAME" || h.padInfo.type === "VALID"))
    p = Oc({ x: s, filter: o, convInfo: h, backend: t });
    ...
    p = t.runWebGLProgram(C, [s, o], "float32", w);
  } else if (E().getBool("WEBGL_CONV_IM2COL"))
    p = Pc({ x: s, filter: o, convInfo: h, backend: t });
  else {
    const C = new Fc(h);
    p = t.runWebGLProgram(C, [s, o], "float32");
  }
  const m = D({ inputs: { x: p }, backend: t, attrs: { shape: h.outShape } });
 ...
 */
function l1(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s, dy: o } = e, { strides: i, pad: a, dataFormat: c, dimRoundingMode: l, filterShape: u } = r, d = En(c), h = et(s.shape, u, i, 1, a, l, !1, d), p = new o1(h);
  return t.runWebGLProgram(p, [s, o], "float32");
}
const u1 = {
  kernelName: Ql,
  backendName: "webgl",
...
class d1 {
  constructor(e) {
    ...
    ], this.outputShape = e.inShape, this.enableShapeUniforms = we(this.outputShape.length);
...
function h1(n) {
  ...
  if (E().getBool("WEBGL_PACK") && d === "channelsLast") {
    ...
    return t.runWebGLProgram(m, [s, o], "float32", p);
  } else {
    const p = new i1(h);
    return t.runWebGLProgram(p, [s, o], "float32");
  }
 ...
 */
function p1(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s, filter: o } = e, { strides: i, pad: a, dilations: c } = r, l = Zn(s.shape, o.shape, i, c, a), u = new t1(l);
 ...
 */
function g1(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s, dy: o } = e, { strides: i, pad: a, filterShape: c } = r, l = Zn(s.shape, c, i, 1, a), u = new a1(l);
  return t.runWebGLProgram(u, [s, o], "float32");
}
const x1 = {
  kernelName: eu,
 ...
 */
function w1(n) {
  const { inputs: e, backend: t, attrs: r } = n, { dy: s, filter: o } = e, { pad: i, strides: a, inputShape: c } = r, l = Zn(c, o.shape, a, 1, i), u = new c1(l);
  return t.runWebGLProgram(u, [s, o], "float32");
}
const C1 = {
  kernelName: tu,
...
`, y1 = `
  ...
  ${en}
  return result;
`, $1 = H({ opSnippet: b1, packedOpSnippet: y1 }), v1 = {
  kernelName: nu,
  backendName: "webgl",
  kernelFunc: $1
};
...
class R1 {
  constructor(e, t, r, s, o) {
    ...
    const p = s === "bilinear" ? 1 : 0, [m, C] = [`${a - 1}.0`, `${c - 1}.0`], [w, x, y] = d > 1 ? [
      `${(a - 1) / (d - 1)}`,
      "(y2-y1) * height_ratio",
 ...
 */
const T1 = (n) => {
  const { inputs: e, backend: t, attrs: r } = n, { image: s, boxes: o, boxInd: i } = e, { cropSize: a, method: c, extrapolationValue: l } = r, u = new R1(s.shape, o.shape, a, c, l);
...
class ai {
  constructor(e, t, r, s) {
    ...
    const o = this.outputShape.length, i = this.op === jn.Prod ? "1.0" : "0.0", a = r ? i : `getX(${ci(o, "coords", this.op)})`, c = this.outputShape[this.outputShape.length - 1];
    let l = "", u = "";
    r ? (l = s ? `end != ${c - 1}` : "end != 0", u = s ? "end + 1" : "end - 1") : (l = s ? `end + pow2 < ${c}` : "end >= pow2", u = s ? "end + pow2" : "end - pow2"), this.userCode = `
      void main() {
        ${j(o)} coords = getOutputCoords();
        int end = ${li(o, "coords", this.op)};
        float val = ${a};
        int pow2 = int(pow(2.0, index));
        if (${l}) {
          int idx = ${u};
          ${li(o, "coords", this.op)} = idx;
          val ${this.op}= getX(${ci(o, "coords", this.op)});
        }
        setOutput(val);
      }
    `;
 ...
 * =============================================================================
 */
function _c(n, e, t, r, s, o) {
  const i = e.shape.length, a = He([r], i);
  let c = e;
  a != null && (c = ve({ inputs: { x: e }, backend: t, attrs: { perm: a } }));
  const l = Xe(1, i)[0];
  if (l !== i - 1)
    throw new Error(`WebGL cumprod shader expects an inner-most axis=${e.shape.length - 1} but got axis=${r}`);
  const u = c.shape[l];
  let d = Fe({ inputs: { x: c }, backend: t });
  for (let h = 0; h <= Math.ceil(Math.log2(u)) - 1; h++) {
    const p = new ai(n, c.shape, !1, o), m = [[h]], C = d;
    d = t.runWebGLProgram(p, [d], d.dtype, m), t.disposeIntermediateTensorInfo(C);
  }
  if (s) {
    const h = new ai(n, c.shape, s, o), p = d;
    d = t.runWebGLProgram(h, [d], d.dtype), t.disposeIntermediateTensorInfo(p);
  }
  if (a != null) {
    const h = Gs(a), p = ve({ inputs: { x: d }, backend: t, attrs: { perm: h } });
    return t.disposeIntermediateTensorInfo(d), t.disposeIntermediateTensorInfo(c), p;
  }
  return d;
}
/**
...
function O1(n) {
  ...
  if (s.shape.length === 1) {
    const c = t.readSync(s.dataId), l = t.readSync(o.dataId), u = gc(c, l, o.dtype, o.shape, i);
    return t.makeTensorInfo([i], o.dtype, u);
  } else if (s.shape.length === 2) {
    const c = t.bufferSync(s), l = t.bufferSync(o), u = Lx(c, l, i, a);
 ...
 */
function B1(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s } = e, { blockSize: o, dataFormat: i } = r, a = s.shape[0], c = i === "NHWC" ? s.shape[1] : s.shape[2], l = i === "NHWC" ? s.shape[2] : s.shape[3], u = i === "NHWC" ? s.shape[3] : s.shape[1], d = c * o, h = l * o, p = u / (o * o), m = i === "NHWC" ? [a, d, h, p] : [a, p, d, h], C = new _1(m, o, i);
...
function M1(n) {
  ...
  let u = c;
  u == null && (u = [1, 1]), _(Sn(i, u), () => `Error in depthwiseConv2d: Either strides or dilations must be 1. Got strides ${i} and dilations '${u}'`);
  const d = et(
    s.shape,
    o.shape,
    i,
  ...
  let h;
  E().getBool("WEBGL_PACK_DEPTHWISECONV") && d.strideWidth <= 2 && d.outChannels / d.inChannels === 1 ? h = new Lc(d) : h = new Bc(d);
  const p = [
  ...
  return t.runWebGLProgram(h, [s, o], "float32", p);
}
const U1 = {
  kernelName: lu,
  backendName: "webgl",
 ...
 */
function j1(n) {
  const { inputs: e, backend: t } = n, { x: r } = e, s = [...r.shape, ...r.shape], o = P(r.shape), i = D({ inputs: { x: r }, backend: t, attrs: { shape: [o] } }), a = new q1(o), c = t.runWebGLProgram(a, [i], i.dtype), l = D({ inputs: { x: c }, backend: t, attrs: { shape: s } });
 ...
 */
function Q1(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s, filter: o } = e, { strides: i, pad: a, dilations: c } = r, l = ma(s.shape, o.shape, i, a, "NHWC", c);
  let u;
  const d = new Y1(l);
 ...
 */
function J1(n) {
  const { inputs: e, backend: t, attrs: r } = n, { equation: s } = r, o = e, { allDims: i, summedDims: a, idDims: c } = Ma(s, o.length);
  Va(i.length, c, o);
  const { path: l, steps: u } = Wa(a, c), d = u.length;
  let h = null, p = i.length;
  const m = [];
  for (let C = 0; C < d; ++C) {
    for (const w of u[C]) {
      const { permutationIndices: x, expandDims: y } = Ua(p, c[w]);
      let v;
      Ga(x) ? v = o[w] : (v = ve({ inputs: { x: o[w] }, backend: t, attrs: { perm: x } }), m.push(v));
      const I = v.shape.slice();
      for (let T = 0; T < y.length; ++T)
        I.splice(y[T], 0, 1);
      me(v.shape, I) || (v = D({ inputs: { x: v }, backend: t, attrs: { shape: I } }), m.push(v)), h === null ? h = v : (h = no({ inputs: { a: v, b: h }, backend: t }), m.push(h));
    }
    C < d - 1 && (l[C] >= 0 && (h = Ur({
      inputs: { x: h },
      backend: t,
...
const tb = "return (x >= 0.0) ? x : (exp(x) - 1.0);", nb = `
  ...
  return result;
`, rb = H({ opSnippet: tb, packedOpSnippet: nb }), sb = {
  kernelName: mu,
  backendName: "webgl",
  kernelFunc: rb
};
...
`, ab = (n) => {
  const { inputs: e, backend: t } = n, { dy: r, y: s } = e, o = E().getBool("WEBGL_PACK_BINARY_OPERATIONS") ? new Fn(ib, r.shape, s.shape) : new Xt(ob, r.shape, s.shape);
...
function Ts(n) {
  ...
  let c = s;
  return s < 0 && (_(-(i + 1) <= s, () => `Axis must be in the interval [${-(i + 1)}, ${i}]`), c = i + s + 1), a.splice(c, 0, 1), D({ inputs: { x: o }, backend: r, attrs: { shape: a } });
}
const Cb = {
  kernelName: bu,
  backendName: "webgl",
 ...
 * =============================================================================
 */
const ui = "return exp(x) - 1.0;", bb = H({ opSnippet: ui, packedOpSnippet: ui, cpuKernelImpl: Hx }), yb = {
  kernelName: yu,
  backendName: "webgl",
  kernelFunc: bb
};
 ...
 */
function Uc(n, e, t) {
  const r = t.texData.get(n.dataId), s = P(n.shape), o = n.shape[n.shape.length - 1], i = s / o, a = D({ inputs: { x: n }, backend: t, attrs: { shape: [i, o] } }), c = a.shape, l = new di("real", c, e), u = new di("imag", c, e), d = [
    {
...
function rr(n) {
  ...
  let { dtype: o } = t;
  if (o = o || Kn(s), o === "string") {
    const i = ue(o, P(r));
    return i.fill(s), e.makeTensorInfo(r, o, i);
  } else {
    const i = new Ib(r, s), a = [[s]];
...
const Rb = {
  ...
  kernelFunc: ({ inputs: n, backend: e }) => {
    const { image: t } = n, r = e, s = new Eb(t.shape);
 ...
 * =============================================================================
 */
const hi = "return floor(x);", Tb = H({ opSnippet: hi, packedOpSnippet: hi, cpuKernelImpl: Xx }), Nb = {
  kernelName: Iu,
  backendName: "webgl",
  kernelFunc: Tb
};
...
`, Ab = `
  ...
  return vec4(result);
`, Fb = xe({ opSnippet: kb, packedOpSnippet: Ab, dtype: "int32" }), Db = {
  kernelName: Fi,
  backendName: "webgl",
  kernelFunc: Fb
};
...
let an, ns = E().getBool("CANVAS2D_WILL_READ_FREQUENTLY_FOR_GPU");
function Bb(n) {
  ...
  if (a || i) {
    ...
    (an == null || C !== ns) && (ns = C, an = document.createElement("canvas").getContext("2d", { willReadFrequently: ns })), an.canvas.width = c, an.canvas.height = l, an.drawImage(s, 0, 0, c, l), s = an.canvas;
  }
  const h = t.makeTensorInfo(u, "int32");
  t.texData.get(h.dataId).usage = Oe.PIXELS, t.gpgpu.uploadPixelDataToTexture(t.getTexture(h.dataId), s);
  const p = E().getBool("WEBGL_PACK") ? new Pb(d) : new Ob(d), m = t.runWebGLProgram(p, [h], "int32");
 ...
 */
function Lb(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s, filter: o, bias: i, preluActivationWeights: a } = e, { strides: c, pad: l, dataFormat: u, dilations: d, dimRoundingMode: h, activation: p, leakyreluAlpha: m } = r, C = En(u), w = et(s.shape, o.shape, c, d, l, h, !1, C);
  let x;
  const y = [], v = i != null, I = a != null, T = p === "leakyrelu", A = () => {
    const k = [s, o], M = (U, G) => {
      if (G === "NCHW" && U.shape.length === 1 && U.shape[0] !== 1) {
        const X = D({
          inputs: { x: U },
          backend: t,
    ...
    if (v && k.push(M(i, u)), I && k.push(M(a, u)), T) {
      const U = t.makeTensorInfo([], "float32", vn(m, "float32"));
      k.push(U), y.push(U);
    }
    return k;
  };
  if (w.filterHeight === 1 && w.filterWidth === 1 && w.dilationHeight === 1 && w.dilationWidth === 1 && w.strideHeight === 1 && w.strideWidth === 1 && (w.padInfo.type === "SAME" || w.padInfo.type === "VALID"))
    ...
    const k = p ? Xn(p, !1) : null, M = new Fc(w, v, k, I, T), U = A();
    x = t.runWebGLProgram(M, U, "float32");
  }
 ...
 */
function Ub(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s, filter: o, bias: i, preluActivationWeights: a } = e, { strides: c, pad: l, dilations: u, dimRoundingMode: d, activation: h, leakyreluAlpha: p } = r, m = [];
  let C = u;
  C == null && (C = [1, 1]), _(Sn(c, C), () => `Error in depthwiseConv2d: Either strides or dilations must be 1. Got strides ${c} and dilations '${C}'`);
  const w = et(
    s.shape,
    o.shape,
    c,
    ...
    !0
    /* depthwise */
  ), x = E().getBool("WEBGL_PACK_DEPTHWISECONV") && w.strideWidth <= 2 && w.outChannels / w.inChannels === 1, y = h ? Xn(h, x) : null, v = [s, o], I = i != null, T = a != null, A = h === "leakyrelu";
  if (I && v.push(i), T && v.push(a), A) {
    const U = t.makeTensorInfo([], "float32", vn(p, "float32"));
    v.push(U), m.push(U);
  }
  let F;
  x ? F = new Lc(w, I, y, T, A) : F = new Bc(w, I, y, T, A);
  const k = [
    [w.padInfo.top, w.padInfo.left],
    [w.strideHeight, w.strideWidth],
    [w.dilationHeight, w.dilationWidth],
    [w.inHeight, w.inWidth]
  ], M = t.runWebGLProgram(F, v, "float32", k);
  return m.forEach((U) => t.disposeIntermediateTensorInfo(U)), M;
}
const Vb = {
  kernelName: gh,
  backendName: "webgl",
 ...
 */
function Gb(n) {
  const { inputs: e, backend: t } = n, { params: r, indices: s } = e, o = s.shape, i = o[o.length - 1], a = P(r.shape), [c, l, u, d] = ba(r, s), h = D({ inputs: { x: s }, backend: t, attrs: { shape: [l, i] } }), p = D({
    inputs: { x: r },
    backend: t,
    attrs: { shape: [P(r.shape) / u, u] }
  });
  if (t.shouldExecuteOnCPU([r, s]) || r.dtype === "string") {
    const x = t.readSync(s.dataId), y = t.bufferSync(r), v = qx(x, y, r.dtype, l, i, u, d, r.shape, a);
    return t.makeTensorInfo(c, r.dtype, v.values);
  }
  const m = new Wb(i, d, [l, u], r.shape), C = t.runWebGLProgram(m, [p, h], p.dtype), w = D({ inputs: { x: C }, backend: t, attrs: { shape: c } });
  return t.disposeIntermediateTensorInfo(h), t.disposeIntermediateTensorInfo(p), t.disposeIntermediateTensorInfo(C), w;
}
const zb = {
  kernelName: Ru,
  backendName: "webgl",
...
function Vc(n) {
  ...
  if (E().get("DEBUG")) {
    ...
    for (let I = 0; I < y.length; ++I) {
      const T = y[I];
      _(T <= v - 1 && T >= 0, () => `GatherV2: the index value ${T} is not in [0, ${v - 1}]`);
    }
  }
  const l = Wp(s, o, c, a), u = P(o.shape), d = [], h = D({
    inputs: { x: s },
    backend: t,
    attrs: {
      shape: [
  ...
  if (t.shouldExecuteOnCPU([s, o]) || s.dtype === "string") {
    const y = t.bufferSync(p), v = t.bufferSync(h), I = jx(v, y, m);
    return d.forEach((T) => t.disposeIntermediateTensorInfo(T)), t.makeTensorInfo(l.outputShape, I.dtype, I.values);
  }
  const C = new Hb(h.shape, m), w = t.runWebGLProgram(C, [h, p], h.dtype);
  d.push(w);
 ...
 * =============================================================================
 */
const sy = "return float(!isnan(x) && !isinf(x));", oy = H({ opSnippet: sy, dtype: "bool" }), iy = {
  kernelName: Fu,
  backendName: "webgl",
  kernelFunc: oy
};
 ...
 * =============================================================================
 */
const ay = "return float(isinf(x));", cy = H({ opSnippet: ay, dtype: "bool" }), ly = {
  kernelName: Du,
  backendName: "webgl",
  kernelFunc: cy
};
 ...
 * =============================================================================
 */
const uy = "return float(isnan(x));", dy = H({ opSnippet: uy, dtype: "bool" }), hy = {
  kernelName: Ou,
  backendName: "webgl",
  kernelFunc: dy
};
 ...
 */
function yy(n) {
  const { backend: e, attrs: t } = n, { start: r, stop: s, num: o } = t, i = Jx(r, s, o);
...
`, Iy = `
  ...
  return result;
`, Sy = H({ opSnippet: vy, packedOpSnippet: Iy, cpuKernelImpl: e0 }), Ey = {
  kernelName: Mu,
  backendName: "webgl",
  kernelFunc: Sy
};
 ...
 * =============================================================================
 */
const ky = "return float(a >= 1.0 && b >= 1.0);", Ay = `
  return vec4(
 ...
 * =============================================================================
 */
const Oy = "return float(!(x >= 1.0));", Py = H({ opSnippet: Oy }), _y = {
  kernelName: Wu,
  backendName: "webgl",
  kernelFunc: Py
};
 ...
 * =============================================================================
 */
const By = "return float(a >= 1.0 || b >= 1.0);", Ly = `
  return min(
    vec4(greaterThanEqual(a, vec4(1.0))) +
    vec4(greaterThanEqual(b, vec4(1.0))),
    vec4(1.0));
`, My = xe({ opSnippet: By, packedOpSnippet: Ly, dtype: "bool" }), Uy = {
  kernelName: Gu,
  backendName: "webgl",
  kernelFunc: My
};
 ...
 */
const Gy = (n) => {
  const { inputs: e, backend: t, attrs: r } = n, { x: s } = e, { depthRadius: o, bias: i, alpha: a, beta: c } = r, l = E().getBool("WEBGL_PACK_NORMALIZATION") ? new Wy(s.shape, o, i, a, c) : new Vy(s.shape, o, i, a, c);
 ...
 */
const Xy = (n) => {
  const { inputs: e, backend: t, attrs: r } = n, { x: s, y: o, dy: i } = e, { depthRadius: a, bias: c, alpha: l, beta: u } = r, d = new Hy(s.shape, a, c, l, u);
 ...
 */
function jy(n, e, t, r) {
  const s = P(e), i = P(n.shape) / s, a = D({ inputs: { x: n }, attrs: { shape: [i, s] }, backend: r }), c = tn(a, n.dtype, "max", r), l = D({ inputs: { x: c }, attrs: { shape: t }, backend: r });
...
function Wc(n) {
  ...
  if (d) {
    if (h) {
      const v = t.texData.get(p.dataId).values, I = new Array(a);
      for (let F = 0; F < I.length; F++)
        I[F] = s.shape[u[F]];
      const T = eo(v, s.shape, s.dtype, u, I);
      p = t.makeTensorInfo(I, s.dtype);
      const A = t.texData.get(p.dataId);
      A.values = T;
    } else
      p = Mr(s, u, t);
    l = Xe(l.length, a);
  ...
  tt("max", l, a);
  const [m, C] = ht(p.shape, l);
  let w = m;
  i && (w = gt(m, c));
  let x;
  if (h) {
    const v = t.texData.get(p.dataId).values, I = t0(v, P(C), w, s.dtype);
    x = t.makeTensorInfo(w, s.dtype);
    const T = t.texData.get(x.dataId);
    T.values = I;
  } else
    x = jy(p, C, w, t);
  return d && t.disposeIntermediateTensorInfo(p), x;
}
const Ky = {
  kernelName: Xu,
  backendName: "webgl",
...
function e$(n) {
  ...
  er(s, "maxPool");
  const { filterSize: o, strides: i, pad: a, dimRoundingMode: c } = r, l = 1;
  _(Sn(i, l), () => `Error in maxPool: Either strides or dilations must be 1. Got strides ${i} and dilations '${l}'`);
  const u = In(s.shape, o, i, l, a, c);
  if (u.filterWidth === 1 && u.filterHeight === 1 && me(u.inShape, u.outShape))
    return Fe({ inputs: { x: s }, backend: t });
 ...
 */
function n$(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s } = e, { filterSize: o, strides: i, pad: a, dataFormat: c, dimRoundingMode: l } = r, u = [1, 1, 1], d = Qn(s.shape, o, i, u, a, l, c), h = new ro(d, "max", !1);
...
class o$ {
  constructor(e) {
    this.variableNames = ["dy", "maxPos"], this.outputShape = e.inShape;
    const t = e.strideDepth, r = e.strideHeight, s = e.strideWidth, o = e.dilationDepth, i = e.dilationHeight, a = e.dilationWidth, c = e.effectiveFilterDepth, l = e.effectiveFilterHeight, u = e.effectiveFilterWidth, d = c - 1 - e.padInfo.front, h = l - 1 - e.padInfo.top, p = u - 1 - e.padInfo.left, m = c * l * u - 1;
    this.userCode = `
 ...
 */
function i$(n) {
  const { inputs: e, backend: t, attrs: r } = n, { dy: s, input: o } = e, i = o, { filterSize: a, strides: c, pad: l, dimRoundingMode: u } = r, d = [1, 1, 1], h = Qn(i.shape, a, c, d, l, u), p = new ro(
    h,
    "max",
    !0
    /* get positions */
  ), m = t.runWebGLProgram(p, [i], i.dtype), C = new o$(h), w = t.runWebGLProgram(C, [s, m], i.dtype);
...
function c$(n) {
  ...
  er([o, i], "maxPoolGrad");
  const { filterSize: c, strides: l, pad: u, dimRoundingMode: d } = r, h = In(a.shape, c, l, 1, u, d), p = !0, m = new qn(h, "max", p), C = t.runWebGLProgram(m, [a], a.dtype), w = new s$(h), x = t.runWebGLProgram(w, [s, C], a.dtype);
...
const d$ = {
  ...
  kernelFunc: ({ inputs: n, attrs: e, backend: t }) => {
    ...
    _(r.shape.length === 4, () => `Error in maxPool: input must be rank 4 but got rank ${r.shape.length}.`);
    const l = [1, 1];
    _(Sn(o, l), () => `Error in maxPool: Either strides or dilations must be 1. Got strides ${o} and dilations '${l}'`);
    const u = In(r.shape, s, o, l, i), [d, h] = u$(r, a, u, c);
    return [d, h];
  }
};
/**
 ...
 */
function h$(n, e, t, r) {
  const s = P(e), i = P(n.shape) / s, a = D({ inputs: { x: n }, attrs: { shape: [i, s] }, backend: r }), c = tn(a, "float32", "mean", r), l = D({ inputs: { x: c }, attrs: { shape: t }, backend: r });
  return r.disposeIntermediateTensorInfo(a), r.disposeIntermediateTensorInfo(c), l;
}
/**
 * @license
...
const f$ = {
  ...
  kernelFunc: ({ inputs: n, attrs: e, backend: t }) => {
    ...
    let l = c;
    const u = He(l, a), d = u != null, h = i.shouldExecuteOnCPU([r]), p = [];
    let m = r;
    if (d) {
      if (h) {
...
function p$(n) {
  ...
  const u = He(l, a);
  let d = s;
  u != null && (d = ve({ inputs: { x: s }, backend: t, attrs: { perm: u } }), l = Xe(l.length, s.shape.length)), tt("min", l, a);
  const [h, p] = ht(d.shape, l), m = P(p), C = D({ inputs: { x: d }, backend: t, attrs: { shape: [-1, m] } }), w = tn(C, C.dtype, "min", t);
  let x;
  if (i) {
    const y = gt(h, c);
    x = D({ inputs: { x: w }, backend: t, attrs: { shape: y } });
...
class b$ {
  constructor(e, t, r) {
    ...
    const s = e.length, o = j(s), i = t.map((u) => u[0]).join(","), a = t.map((u, d) => u[0] + e[d]).join(","), c = ["coords[0]", "coords[1]", "coords[2]", "coords[3]"].slice(0, s), l = r === "reflect" ? 0 : 1;
    if (s === 1) {
      this.userCode = `
        int start = ${i};
        int end = ${a};
...
class y$ {
  constructor(e, t, r) {
    ...
    const s = e.length, o = j(s), i = t.map((m) => m[0]).join(","), a = t.map((m, C) => m[0] + e[C]).join(","), c = ye("rc", s), l = ye("source", s), u = `${c[s - 1]} < ${this.outputShape[s - 1]}`, d = s === 1 ? "source" : `vec2(${l.slice(-2).join()})`, h = r === "reflect" ? 0 : 1;
    let p = "";
    if (s === 1) {
      const m = `
        ${o} source = rc;
 ...
 * =============================================================================
 */
const $$ = ({ inputs: n, backend: e, attrs: t }) => {
  const { x: r } = n, { paddings: s, mode: o } = t, i = E().getBool("WEBGL_PACK_ARRAY_OPERATIONS") ? new y$(r.shape, s, o) : new b$(r.shape, s, o);
...
return a / b;`, k$ = `
  ...
  return result;
`, Gc = xe({ opSnippet: N$, packedOpSnippet: k$, checkOutOfBounds: !0 }), A$ = {
  kernelName: ki,
  backendName: "webgl",
  kernelFunc: Gc
};
 ...
 */
function Hc(n) {
  const { inputs: e, backend: t, attrs: r } = n, { logits: s } = e, { dim: o } = r, i = Re([o], s.shape), a = Wc({
    inputs: { x: s },
    backend: t,
    attrs: { reductionIndices: i, keepDims: !1 }
  }), c = gt(a.shape, i), l = D({ inputs: { x: a }, backend: t, attrs: { shape: c } }), u = zc({ inputs: { a: s, b: l }, backend: t }), d = Mc({ inputs: { x: u }, backend: t }), h = Ur({ inputs: { x: d }, backend: t, attrs: { axis: i, keepDims: !1 } }), p = D({ inputs: { x: h }, backend: t, attrs: { shape: c } }), m = Gc({ inputs: { a: d, b: p }, backend: t });
  return t.disposeIntermediateTensorInfo(a), t.disposeIntermediateTensorInfo(l), t.disposeIntermediateTensorInfo(u), t.disposeIntermediateTensorInfo(d), t.disposeIntermediateTensorInfo(h), t.disposeIntermediateTensorInfo(p), m;
}
const D$ = {
  kernelName: zd,
  backendName: "webgl",
 ...
 */
function O$(n) {
  const { inputs: e, backend: t, attrs: r } = n, { logits: s } = e, { numSamples: o, seed: i, normalized: a } = r, c = a ? s : Hc({ inputs: { logits: s }, backend: t, attrs: { dim: s.shape.length - 1 } }), l = c.shape[0], u = c.shape[1], d = new T$(l, u, o), h = [[i]], p = t.runWebGLProgram(d, [c], "int32", h);
  return a || t.disposeIntermediateTensorInfo(c), p;
}
const P$ = {
  kernelName: rd,
  backendName: "webgl",
...
function L$(n) {
  ...
  if (t.shouldExecuteOnCPU([r])) {
    const o = t.texData.get(r.dataId), [i, a] = o0(o.values, r.shape, r.dtype);
    return t.makeTensorInfo(a, r.dtype, i);
  }
  let s;
  return E().getBool("WEBGL_PACK_UNARY_OPERATIONS") ? s = new St(r.shape, B$) : s = new ct(r.shape, _$), t.runWebGLProgram(s, [r], r.dtype);
}
const M$ = {
  kernelName: sd,
  backendName: "webgl",
...
function V$(n) {
  ...
  const { inputs: e, backend: t, attrs: r } = n, { boxes: s, scores: o } = e, { maxOutputSize: i, iouThreshold: a, scoreThreshold: c } = r, l = t.readSync(s.dataId), u = t.readSync(o.dataId), { selectedIndices: d } = U$(l, u, i, a, c);
...
function z$(n) {
  Qe("tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead");
  const { inputs: e, backend: t, attrs: r } = n, { boxes: s, scores: o } = e, { maxOutputSize: i, iouThreshold: a, scoreThreshold: c, padToMaxOutputSize: l } = r, u = t.readSync(s.dataId), d = t.readSync(o.dataId), { selectedIndices: h, validOutputs: p } = G$(u, d, i, a, c, l);
  return [
...
function q$(n) {
  Qe("tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead");
  const { inputs: e, backend: t, attrs: r } = n, { boxes: s, scores: o } = e, { maxOutputSize: i, iouThreshold: a, scoreThreshold: c, softNmsSigma: l } = r, u = t.readSync(s.dataId), d = t.readSync(o.dataId), h = i, p = a, m = c, C = l, { selectedIndices: w, selectedScores: x } = X$(u, d, h, p, m, C);
  return [
 ...
 */
const Y$ = (n) => {
  const { inputs: e, backend: t, attrs: r } = n, { indices: s } = e, { dtype: o, depth: i, onValue: a, offValue: c } = r, l = P(s.shape), u = new K$(l, i, a, c), d = D({ inputs: { x: s }, backend: t, attrs: { shape: [l] } }), h = t.runWebGLProgram(u, [d], o);
  t.disposeIntermediateTensorInfo(d);
  const p = [...s.shape, i], m = D({ inputs: { x: h }, backend: t, attrs: { shape: p } });
...
function Tr(n) {
  const { inputs: e, backend: t } = n, { x: r } = e;
  if (r.dtype === "complex64") {
    const s = nr({ inputs: { input: r }, backend: t }), o = Tr({ inputs: { x: s }, backend: t }), i = Vr({ inputs: { input: r }, backend: t }), a = Tr({ inputs: { x: i }, backend: t }), c = Nt({ inputs: { real: o, imag: a }, backend: t });
...
function Xc(n) {
  ...
  if (r.dtype === "complex64") {
    const s = nr({ inputs: { input: r }, backend: t }), o = Xc({ inputs: { x: s }, backend: t }), i = Vr({ inputs: { input: r }, backend: t }), a = Tr({ inputs: { x: i }, backend: t }), c = Nt({ inputs: { real: o, imag: a }, backend: t });
    return t.disposeIntermediateTensorInfo(s), t.disposeIntermediateTensorInfo(o), t.disposeIntermediateTensorInfo(i), t.disposeIntermediateTensorInfo(a), c;
  } else
    return rr({ attrs: { shape: r.shape, dtype: r.dtype, value: 1 }, backend: t });
}
const J$ = {
  kernelName: ld,
  backendName: "webgl",
...
function ev(n) {
  ...
  if (e.length === 1)
    return Ts({ inputs: { input: e[0] }, backend: t, attrs: { dim: s } });
  const o = e[0].shape, i = e[0].dtype;
  e.forEach((u) => {
    wi(o, u.shape, "All tensors passed to stack must have matching shapes"), _(i === u.dtype, () => "All tensors passed to stack must have matching dtypes");
  });
  const a = [], c = e.map((u) => {
    const d = Ts({ inputs: { input: u }, backend: t, attrs: { dim: s } });
    return a.push(d), d;
  }), l = Ac({ inputs: c, backend: t, attrs: { axis: s } });
...
class nv {
  constructor(e, t, r) {
    ...
    const s = e.length, o = j(s), i = t.map((l) => l[0]).join(","), a = t.map((l, u) => l[0] + e[u]).join(","), c = ["coords[0]", "coords[1]", "coords[2]", "coords[3]"].slice(0, s);
    if (s === 1) {
      this.userCode = `
        int start = ${i};
        int end = ${a};
...
class rv {
  constructor(e, t, r) {
    ...
    const s = e.length, o = j(s), i = t.map((C) => C[0]).join(","), a = t.map((C, w) => C[0] + e[w]).join(","), c = ye("rc", s), l = ye("source", s), u = `${c[s - 1]} < ${this.outputShape[s - 1]}`, d = s === 1 ? "source" : `vec2(${l.slice(-2).join()})`, h = [
      `${o} rc = outputLoc;`,
      `${c[s - 1]} += 1;
       if(${u}) {
      `,
      ...
      s === 1 ? "" : `  ${c[s - 1]} += 1;
         if(${u}) {`
    ], p = s === 1 ? "rc < start || rc >= end" : "any(lessThan(rc, start)) || any(greaterThanEqual(rc, end))";
    let m = "";
...
const qc = (n) => {
  ...
  const a = E().getBool("WEBGL_PACK_ARRAY_OPERATIONS") ? new rv(s.shape, o, i) : new nv(s.shape, o, i), c = [[i]];
  return t.runWebGLProgram(a, [s], s.dtype, c);
}, sv = {
  kernelName: hd,
  backendName: "webgl",
...
`, iv = `
  ...
  ` + en + `
  return result;
`, av = xe({ opSnippet: ov, packedOpSnippet: iv }), cv = {
  kernelName: Pi,
  backendName: "webgl",
  kernelFunc: av
};
...
function lv(n) {
  ...
  const d = He(u, a);
  let h = s;
  d != null && (h = ve({ inputs: { x: s }, backend: t, attrs: { perm: d } }), u = Xe(u.length, a), c.push(h)), tt("prod", u, a);
  let p;
  if (t.shouldExecuteOnCPU([h])) {
    const m = t.texData.get(h.dataId).values, { outVals: C, outShape: w, outDtype: x } = a0(h.shape, h.dtype, m, u);
    p = t.makeTensorInfo(w, x, C);
  } else {
    const [m, C] = ht(h.shape, u), w = P(C), x = D({ inputs: { x: h }, backend: t, attrs: { shape: [-1, w] } }), y = Bs(s.dtype), v = tn(x, y, "prod", t);
    p = D({ inputs: { x: v }, backend: t, attrs: { shape: m } }), c.push(x), c.push(v);
  }
  if (i) {
    c.push(p);
    const m = gt(p.shape, l);
    p = D({ inputs: { x: p }, backend: t, attrs: { shape: m } });
  }
  return c.forEach((m) => t.disposeIntermediateTensorInfo(m)), p;
}
const uv = {
  kernelName: pd,
  backendName: "webgl",
 ...
 */
function fv(n) {
  const { inputs: e, backend: t } = n, { starts: r, limits: s, deltas: o } = e, i = t.readSync(r.dataId), a = t.readSync(s.dataId), c = t.readSync(o.dataId), [l, u] = l0(i, r.shape, r.dtype, a, s.shape, c, o.shape), d = t.makeTensorInfo([l.length], "int32", l), h = t.makeTensorInfo([u.length], r.dtype, u);
  return [d, h];
}
const pv = {
  kernelName: gd,
 ...
 */
function mv(n) {
  const { inputs: e, backend: t, attrs: r } = n, { shape: s, values: o, defaultValue: i, rowPartitionTensors: a } = e, { rowPartitionTypes: c } = r, l = t.readSync(s.dataId), u = t.readSync(o.dataId), d = t.readSync(i.dataId), h = a.map((w) => t.readSync(w.dataId)), p = a.map((w) => w.shape), [m, C] = u0(l, s.shape, u, o.shape, o.dtype, d, i.shape, h, p, c);
 ...
 */
const jc = (n) => {
  const { backend: e, attrs: t } = n, { start: r, stop: s, step: o, dtype: i } = t, a = d0(r, s, o, i);
 ...
 * =============================================================================
 */
const wv = "return 1.0 / x;", Cv = H({ opSnippet: wv }), bv = {
  kernelName: bd,
  backendName: "webgl",
  kernelFunc: Cv
};
...
`, $v = `
  ...
  return result;
`, vv = H({ opSnippet: yv, packedOpSnippet: $v }), Iv = {
  kernelName: yd,
  backendName: "webgl",
  kernelFunc: vv
};
...
`, Ev = `
  ...
  return result;
`, Rv = H({ opSnippet: Sv, packedOpSnippet: Ev }), Tv = {
  kernelName: Ed,
  backendName: "webgl",
  kernelFunc: Rv
};
 ...
 */
function Av(n) {
  const { inputs: e, backend: t, attrs: r } = n, { images: s } = e, { alignCorners: o, halfPixelCenters: i, size: a } = r, [c, l] = a, u = E().getBool("WEBGL_PACK_IMAGE_OPERATIONS") ? new kv(s.shape, c, l, o, i) : new Nv(s.shape, c, l, o, i);
...
class Dv {
  constructor(e, t, r) {
    ...
    const [, s, o] = t, [, i, a] = e, c = [
      ...
      r && i > 1 ? i - 1 : i,
      r && a > 1 ? a - 1 : a
    ], u = c[0] / l[0], d = c[1] / l[1], h = 1 / u, p = 1 / d, m = Math.ceil(h) * 2 + 2, C = Math.ceil(p) * 2 + 2;
    this.userCode = `
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
 ...
 */
function Ov(n) {
  const { inputs: e, backend: t, attrs: r } = n, { images: s, dy: o } = e, { alignCorners: i } = r, a = new Dv(o.shape, s.shape, i);
 ...
 */
function Lv(n) {
  const { inputs: e, backend: t, attrs: r } = n, { images: s } = e, { alignCorners: o, halfPixelCenters: i, size: a } = r, [c, l] = a, u = E().getBool("WEBGL_PACK_IMAGE_OPERATIONS") ? new Bv(s.shape, c, l, o, i) : new _v(s.shape, c, l, o, i);
 ...
 */
function Vv(n) {
  const { inputs: e, backend: t, attrs: r } = n, { images: s, dy: o } = e, { alignCorners: i } = r, a = new Uv(o.shape, s.shape, i);
  return t.runWebGLProgram(a, [o], o.dtype);
}
const Wv = {
  kernelName: vd,
...
class Gv {
  constructor(e, t) {
    ...
    const s = (a) => t.indexOf(a) !== -1 && e[a] !== 1 ? `${e[a]} - coords[${a}] - 1` : `coords[${a}]`, o = e.map((a, c) => s(c)).join(","), i = j(r);
    this.userCode = `
      void main() {
...
class zv {
  constructor(e, t) {
    ...
    if (r > 4)
      throw new Error(`WebGL backend: Reverse of rank-${r} tensor is not yet supported`);
    this.outputShape = e;
    const s = ye("rc", r), o = `${s[r - 1]} + 1 < ${this.outputShape[r - 1]}`, i = `${s[r - 2]} + 1 < ${this.outputShape[r - 2]}`, a = j(r);
    r === 1 ? this.userCode = `
        void main(){
    ...
    function h(m) {
      const C = e.map((y, v) => p(v, m)), w = C.join(","), x = C.slice(-2).join(",");
...
function Hv(n) {
  ...
  if (i === 0)
    return Fe({ inputs: { x: s }, backend: t });
  const c = E().getBool("WEBGL_PACK_ARRAY_OPERATIONS") ? new zv(s.shape, a) : new Gv(s.shape, a);
  return t.runWebGLProgram(c, [s], s.dtype);
}
const Xv = {
  kernelName: Rd,
...
const jv = {
  ...
  backendName: "webgl",
  kernelFunc: ({ inputs: n, attrs: e, backend: t }) => {
    const { image: r } = n, { radians: s, fillValue: o, center: i } = e, a = t, c = new qv(r.shape, o), [l, u] = Ta(i, r.shape[1], r.shape[2]), d = [[l, u, Math.sin(s), Math.cos(s)]];
 ...
 * =============================================================================
 */
const Zv = "return inversesqrt(x);", Jv = H({ opSnippet: Zv, cpuKernelImpl: h0 }), eI = {
  kernelName: Nd,
  backendName: "webgl",
  kernelFunc: Jv
};
...
class so {
  constructor(e, t, r, s, o, i, a = !0, c = !1) {
    ...
    const l = j(o.length), u = j(i.length);
    let d = "";
    r === 1 ? d = "i" : r === 2 && (d = "i, j");
    const h = `getIndices(${d})`;
    let p = "";
    s === 1 ? p = "i" : s === 2 && (p = "i, coords[1]");
    const m = `getUpdates(${p})`;
    let C = "";
 ...
 */
function nI(n) {
  const { inputs: e, backend: t, attrs: r } = n, { indices: s, updates: o } = e, { shape: i } = r, { sliceRank: a, numUpdates: c, sliceSize: l, strides: u, outputSize: d } = Pr(o, s, i), h = [d / l, l];
  if (d === 0)
    return t.makeTensorInfo(i, s.dtype);
  const p = D({ inputs: { x: s }, backend: t, attrs: { shape: [c, a] } }), m = D({ inputs: { x: o }, backend: t, attrs: { shape: [c, l] } }), C = t.makeTensorInfo([], "float32", new Float32Array([0]));
  let w;
  E().getBool("WEBGL_PACK") ? w = new tI(c, a, p.shape.length, m.shape.length, u, h) : w = new so(c, a, p.shape.length, m.shape.length, u, h);
  const x = t.runWebGLProgram(w, [m, p, C], m.dtype), y = D({ inputs: { x }, backend: t, attrs: { shape: i } });
  return t.disposeIntermediateTensorInfo(p), t.disposeIntermediateTensorInfo(m), t.disposeIntermediateTensorInfo(x), t.disposeIntermediateTensorInfo(C), y;
}
const rI = {
  kernelName: kd,
  backendName: "webgl",
 ...
 */
function oI(n) {
  const { inputs: e, backend: t, attrs: r } = n, { sortedSequence: s, values: o } = e, { side: i } = r, a = new sI(s.shape[0], s.shape[1], o.shape[1], i), c = [[s.shape[1]]];
 ...
 */
function cI(n) {
  const { inputs: e, backend: t } = n, { condition: r, t: s, e: o } = e, i = new aI(r.shape.length, s.shape, s.shape.length);
...
`, yI = `
  ...
  ${en}
  return result;
`, $I = H({ opSnippet: bI, packedOpSnippet: yI }), vI = {
  kernelName: _d,
  backendName: "webgl",
  kernelFunc: $I
};
...
const kI = (n) => {
  ...
  _(s.shape.length <= 4, () => "spaceToBatchND for rank > 4 with a WebGL backend not implemented yet");
  ...
  }), d = qs(u.shape, o, a, !1), h = js(d.length, o.length, !1), p = Ks(u.shape, o, a, !1), m = D({ inputs: { x: u }, backend: t, attrs: { shape: d } }), C = ve({
    inputs: { x: m },
    backend: t,
    attrs: { perm: h }
  }), w = D({ inputs: { x: C }, backend: t, attrs: { shape: p } });
...
function FI(n) {
  ...
  if (i.shape.length !== 0)
    throw new Error(`Default value must be a scalar, saw:
        ${i.shape}`);
  const a = t.readSync(r.dataId), c = t.readSync(s.dataId), l = t.readSync(o.dataId), u = t.readSync(i.dataId)[0], [d, h, p, m, C] = g0(a, r.shape, r.dtype, c, s.dtype, l, u);
  return [
    t.makeTensorInfo(h, r.dtype, d),
    t.makeTensorInfo([h[0]], s.dtype, p),
...
function OI(n) {
  ...
  const i = Array.from(t.readSync(s.dataId)), a = t.readSync(r.dataId), c = Array.from(t.readSync(o.dataId)), [l, u, d] = x0(a, r.shape, r.dtype, i, c);
  return [
...
function _I(n) {
  ...
  if (o.shape.length !== 1)
    throw new Error(`Segment ids should be a vector but received shape
              ${o.shape}`);
  const i = t.readSync(r.dataId), a = t.readSync(s.dataId), c = t.readSync(o.dataId), [l, u] = wc(i, r.shape, r.dtype, a, c, !0);
...
function LI(n) {
  ...
  if (o.shape.length !== 1)
    throw new Error(`Segment ids should be a vector but received shape
             ${o.shape}`);
  const i = t.readSync(r.dataId), a = t.readSync(s.dataId), c = t.readSync(o.dataId), [l, u] = wc(i, r.shape, r.dtype, a, c);
  return t.makeTensorInfo(u, r.dtype, l);
}
const MI = {
  kernelName: jd,
 ...
 */
function UI(n) {
  const { inputs: e, backend: t, attrs: r } = n, { sparseIndices: s, sparseValues: o, defaultValue: i } = e, { outputShape: a } = r, { sliceRank: c, numUpdates: l, sliceSize: u, strides: d, outputSize: h } = Pr(o, s, a), p = !1;
  if (o.dtype === "string") {
    const x = t.bufferSync(s), y = t.bufferSync(o), v = xn(t.readSync(i.dataId)[0]), I = f0(x, y, a, h, u, l, c, d, v, p);
    return t.makeTensorInfo(a, I.dtype, I.values);
  }
  const m = new so(l, c, s.shape.length, o.shape.length, d, [h, 1], p), C = t.runWebGLProgram(m, [o, s, i], o.dtype), w = D({ inputs: { x: C }, backend: t, attrs: { shape: a } });
 ...
 */
function WI(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s } = e, { numOrSizeSplits: o, axis: i } = r, a = Re(i, s.shape)[0], c = za(s, o, a), l = s.shape.length, u = new Array(l).fill(0), d = s.shape.slice();
  return c.map((h) => {
    const p = [...d];
    p[a] = h;
    const m = On({ inputs: { x: s }, backend: t, attrs: { begin: u, size: p } });
    return u[a] += h, m;
  });
}
const GI = {
 ...
 * =============================================================================
 */
const pi = "return sqrt(x);", zI = H({ opSnippet: pi, packedOpSnippet: pi, cpuKernelImpl: w0 }), HI = {
  kernelName: Bi,
  backendName: "webgl",
  kernelFunc: zI
};
 ...
 * =============================================================================
 */
const XI = "return x * x;", qI = H({ opSnippet: XI }), jI = {
  kernelName: Qd,
  backendName: "webgl",
  kernelFunc: qI
};
 ...
 * =============================================================================
 */
const mi = "return (a - b) * (a - b);", KI = xe({ opSnippet: mi, packedOpSnippet: mi }), YI = {
  kernelName: Yd,
  backendName: "webgl",
  kernelFunc: KI
};
...
function QI(n) {
  ...
  const o = t.readSync(s.dataId), i = bn(o), a = C0(i, "string", r);
 ...
 * =============================================================================
 */
function JI({ inputs: n, attrs: e, backend: t }) {
  const { x: r } = n, s = qe + `
...
class tS {
  constructor(e, t, r) {
    ...
    const s = r.length, o = j(r.length), i = j(r.length);
    let a = "";
    if (s === 1)
 ...
 */
function nS(n) {
  const { inputs: e, backend: t, attrs: r } = n, { x: s } = e, { begin: o, end: i, strides: a, beginMask: c, endMask: l, ellipsisMask: u, newAxisMask: d, shrinkAxisMask: h } = r, { finalShapeSparse: p, finalShape: m, isIdentity: C, sliceDim0: w, isSimpleSlice: x, begin: y, end: v, strides: I } = Op(s.shape, o, i, a, c, l, u, d, h);
  let T;
  if (C)
    T = D({ inputs: { x: s }, backend: t, attrs: { shape: m } });
  else if (w || x) {
    _(s.shape.length >= 1, () => `Input must have rank at least 1, got: ${s.shape.length}`);
    const F = Fp(y, v, I), k = On({ inputs: { x: s }, backend: t, attrs: { begin: y, size: F } });
    T = D({ inputs: { x: k }, backend: t, attrs: { shape: m } }), t.disposeIntermediateTensorInfo(k);
  } else if (t.shouldExecuteOnCPU([s])) {
    const k = t.readSync(s.dataId), M = ge(s.shape, s.dtype, k), U = b0(p, M, I, y);
    T = t.makeTensorInfo(m, s.dtype, U.values);
  } else {
    const k = new tS(y, I, p);
 ...
 */
function sS(n) {
  const { inputs: e, backend: t, attrs: r } = n, { separator: s, nGramWidths: o, leftPad: i, rightPad: a, padWidth: c, preserveShortSequences: l } = r, { data: u, dataSplits: d } = e, h = t.readSync(u.dataId), p = t.readSync(d.dataId), [m, C] = y0(h, p, s, o, i, a, c, l);
  return [
...
function iS(n) {
  ...
  const a = t.readSync(o.dataId), c = t.readSync(i.dataId)[0], [l, u, d] = $0(a, c, s), h = u.length;
  return [
...
function cS(n) {
  ...
  const i = t.readSync(o.dataId), a = v0(i, s);
 ...
 * =============================================================================
 */
const uS = "return tan(x);", dS = H({ opSnippet: uS }), hS = {
  kernelName: rh,
  backendName: "webgl",
  kernelFunc: dS
};
 ...
 */
function gS(n) {
  const { inputs: e, backend: t, attrs: r } = n, { tensor: s, indices: o, updates: i } = e, { sliceRank: a, numUpdates: c, sliceSize: l, strides: u, outputSize: d } = Pr(i, o, s.shape), h = [d / l, l];
  if (d === 0)
    return t.makeTensorInfo(s.shape, o.dtype);
  const p = D({ inputs: { x: o }, backend: t, attrs: { shape: [c, a] } }), m = D({ inputs: { x: i }, backend: t, attrs: { shape: [c, l] } }), C = D({ inputs: { x: s }, backend: t, attrs: { shape: h } }), w = new so(c, a, p.shape.length, m.shape.length, u, h, !1, !0), x = t.runWebGLProgram(w, [m, p, C], C.dtype), y = D({ inputs: { x }, backend: t, attrs: { shape: s.shape } });
  return t.disposeIntermediateTensorInfo(p), t.disposeIntermediateTensorInfo(m), t.disposeIntermediateTensorInfo(C), t.disposeIntermediateTensorInfo(x), y;
}
const xS = {
  kernelName: Ad,
  backendName: "webgl",
...
function Kc(n) {
  ...
  if (s.dtype === "string" || s.shape.length > 5) {
    const c = t.readSync(s.dataId), l = s.dtype === "string" ? c.map((h) => xn(h)) : c, u = ge(s.shape, s.dtype, l), d = S0(u, o);
    return t.makeTensorInfo(d.shape, d.dtype, d.values);
  }
  const i = new wS(s.shape, o);
...
function vS(n) {
  ...
  if (t.shouldExecuteOnCPU([s]) || u < a || o > c) {
    const U = t.readSync(s.dataId), [G, X] = E0(U, l, s.dtype, o, i);
    return [
      t.makeTensorInfo(G.shape, G.dtype, G.values),
      t.makeTensorInfo(X.shape, X.dtype, X.values)
    ];
  }
  if (o === 0)
  ...
  if (u === 1)
    return [
      s,
      rr({ attrs: { shape: l, dtype: "int32", value: 0 }, backend: t })
    ];
  const d = t.texData.get(s.dataId), h = d !== null && d.isPacked, p = h ? t.unpackTensor(s) : s, C = P(l) / u, w = D({ inputs: { x: p }, attrs: { shape: [C, u] }, backend: t });
  h && kt(t, p);
  const x = gi(o), y = gi(u);
  let v = null;
  const I = () => v === null ? [w, w] : [w, v], T = (U, G, X) => {
    const Ce = I(), oe = new yS(X), Te = [[u], [v === null ? 1 : 0], [Number.NEGATIVE_INFINITY], [U], [G]], Ne = v;
    v = t.runWebGLProgram(oe, Ce, "int32", Te), kt(t, Ne);
  };
  for (let U = 1; U < x; U *= 2) {
    const G = U * 2;
    for (let X = U; X >= 1; X /= 2)
  ...
  for (let U = y; U > x; U /= 2) {
    const G = I(), X = new $S([C, U / 2]), oe = [[u], [v === null ? 1 : 0], [x]], ae = v;
    v = t.runWebGLProgram(X, G, "int32", oe), kt(t, ae);
    const Te = x / 2, Ne = Te * 2;
    for (let ce = Te; ce >= 1; ce /= 2)
      T(Ne, ce, v.shape);
  }
  let A = v;
  v = On({ inputs: { x: v }, backend: t, attrs: { begin: 0, size: [C, o] } }), kt(t, A);
  let F = Vc({ inputs: { x: w, indices: v }, backend: t, attrs: { axis: 1, batchDims: 1 } });
  kt(t, w);
  const k = l.slice(0, -1);
  k.push(o), A = v, v = D({ inputs: { x: v }, attrs: { shape: k }, backend: t }), kt(t, A);
  const M = F;
  return F = D({ inputs: { x: F }, attrs: { shape: k }, backend: t }), kt(t, M), [F, v];
}
const IS = {
  kernelName: oh,
  backendName: "webgl",
 ...
 */
function ES(n) {
  const { inputs: e, backend: t, attrs: r } = n, { image: s, transforms: o } = e, { interpolation: i, fillMode: a, fillValue: c, outputShape: l } = r, [u, d, h, p] = s.shape, [m, C] = l ?? [d, h], w = [
    u,
    m,
    C,
    p
  ], x = new SS(d, h, i, a, c, w);
...
function TS(n) {
  ...
  er(o, "unique"), console.warn("WARNING: ", "UI might be locked temporarily as data is being downloaded");
  const i = r.readSync(o.dataId), { outputValues: a, outputShape: c, indices: l } = R0(i, s, o.shape, o.dtype);
  return [
...
function kS(n) {
  ...
  for (let C = 0; C < m.length; C++) {
    h[o] = C;
    const w = On({ inputs: { x: i }, backend: t, attrs: { begin: h, size: p } }), x = D({ inputs: { x: w }, backend: t, attrs: { shape: l } });
    m[C] = x, d.push(w);
  }
...
function DS(n) {
  ...
  const u = He([l], a);
  let d = s;
  u != null && (d = ve({ inputs: { x: s }, backend: t, attrs: { perm: u } }), c.push(d), l = Xe(1, a)[0]);
  const h = Vp(d.shape, l, i), p = P([d.shape[l]]), m = D({ inputs: { x: d }, backend: t, attrs: { shape: [-1, p] } });
  c.push(m);
  const C = Bs(s.dtype), w = (I, T, A, F, k) => {
    const M = I.shape[0], U = I.shape[1], G = Up(U, k), X = { windowSize: G, inSize: U, batchSize: M, numSegments: k }, Ce = new FS(X, T), oe = t.compileAndRun(Ce, [I, A], F);
    if (c.push(oe), oe.shape[1] === k)
      return oe;
    const ae = jc({
      backend: t,
    ...
    return c.push(ae), c.push(Te), w(oe, T, Te, F, k);
  }, x = w(m, "unsortedSegmentSum", o, C, i), y = D({ inputs: { x }, backend: t, attrs: { shape: h } });
  let v = y;
  if (u != null) {
    c.push(y);
    const I = Gs(u);
    v = ve({ inputs: { x: v }, backend: t, attrs: { perm: I } });
  }
